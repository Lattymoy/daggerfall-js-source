...
export class OnlineSession {
  ...
  sendCast(data) {
    ...
    if (!d || d.to === this.id) return false;
    const ws = this._socketFor(d.to);
    if (!ws) return false;
