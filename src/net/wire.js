...
export const ROLL_RELAY_MIN = 101;   // MERGE: the arc's deploy is world101 - main's world99 (HCC-PARK) and world100 (DISC7) roll nothing
...
export const EMOTE_RELAY_MIN = 101;   // MERGE: world101, as ROLL_RELAY_MIN
...
export const CHAN_RELAY_MIN = 101;   // MERGE: world101 - main's world99 and world100 route no channel of the arc's
...
export const CARD_RELAY_MIN = 101;   // MERGE: world101, as CHAN_RELAY_MIN
