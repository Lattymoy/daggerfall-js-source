...
export function validPose(p) {
  ...
  const { x, y, z, yaw, pitch, mv, wd, an, as, am, sr, cn, cr, ce, ar, fk, rd, rv, dd } = p;
...
const rideOf = (rd, rv) => {
  ...
  return r ? { rd: r, rv: uint(rv, POSE_RIDE_SPRITES - 1) ?? 0 } : {};
};
