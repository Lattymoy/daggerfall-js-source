 ...
 * builds (input.js:70-76, the reason restWindow's own header flags its
 * toggle-close). Both resolve to one browser code here so a window
 * asks the table once and works under either host.
 */
