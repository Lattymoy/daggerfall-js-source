...
// 126/:1364-1366 and exterior.js:180/:1324-1326 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:3299, exterior.js:1380,
  // dungeonContext.js:2483 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6854), which dungeon.js:539 and worldModes.js:9383 both feed.
