...
// 126/:1364-1366 and exterior.js:146/:1213-1215 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2515, exterior.js:1274,
  // dungeonContext.js:2306 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6060), which dungeon.js:488 and worldModes.js:7775 both feed.
