...
// 126/:1364-1366 and exterior.js:171/:1296-1298 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:3220, exterior.js:1352,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6734), which dungeon.js:529 and worldModes.js:8804 both feed.
