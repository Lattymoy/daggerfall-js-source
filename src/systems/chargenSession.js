...
// 126/:1364-1366 and exterior.js:157/:1227-1229 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2639, exterior.js:1287,
  // dungeonContext.js:2371 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6555), which dungeon.js:513 and worldModes.js:8575 both feed.
