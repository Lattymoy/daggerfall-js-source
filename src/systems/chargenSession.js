...
// 126/:1364-1366 and exterior.js:157/:1233-1235 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2647, exterior.js:1289,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6623), which dungeon.js:524 and worldModes.js:8656 both feed.
