...
// 126/:1364-1366 and exterior.js:156/:1226-1228 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2638, exterior.js:1286,
  // dungeonContext.js:2370 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6554), which dungeon.js:500 and worldModes.js:8505 both feed.
