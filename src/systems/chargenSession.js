...
// 126/:1364-1366 and exterior.js:143/:1190-1192 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2231, exterior.js:1242,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6000), which dungeon.js:488 and worldModes.js:7614 both feed.
