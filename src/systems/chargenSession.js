...
// 126/:1364-1366 and exterior.js:168/:1246-1248 both import and run
...
export async function applyHeadlessChargen(playerEntity, classIndex, { fetchBytes, spellsByIndex = null } = {}) {
  ...
  // updateEquippedArmorValues (equip.js:263) early-returns for a
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2668, exterior.js:1302,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6733), which dungeon.js:524 and worldModes.js:8772 both feed.
