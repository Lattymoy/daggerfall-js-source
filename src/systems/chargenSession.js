...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:3450, exterior.js:1381,
  // dungeonContext.js:2513 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6885), which dungeon.js:540 and worldModes.js:9445 both feed.
