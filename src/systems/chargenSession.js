...
// 126/:1364-1366 and exterior.js:120/:1134-1136 both import and run
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // exterior.js through `townTalk.hover` (townTalk.js:1167-1178,
    // the route itself :1176), dungeonContext.js through `overlayHover`
    // (:5002), which dungeon.js:446 and worldModes.js:7260 both feed.
