...
// 126/:1364-1366 and exterior.js:158/:1236-1238 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2655, exterior.js:1292,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6682), which dungeon.js:524 and worldModes.js:8722 both feed.
