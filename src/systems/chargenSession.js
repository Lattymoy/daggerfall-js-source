...
// 126/:1364-1366 and exterior.js:170/:1300-1302 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:3213, exterior.js:1356,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6732), which dungeon.js:524 and worldModes.js:8806 both feed.
