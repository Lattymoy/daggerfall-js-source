...
// 126/:1364-1366 and exterior.js:167/:1244-1246 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2664, exterior.js:1300,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6718), which dungeon.js:524 and worldModes.js:8769 both feed.
