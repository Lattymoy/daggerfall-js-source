...
// 126/:1364-1366 and exterior.js:159/:1236-1238 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2659, exterior.js:1292,
  // dungeonContext.js:2446 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6727), which dungeon.js:529 and worldModes.js:8756 both feed.
