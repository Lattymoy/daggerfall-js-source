...
// 126/:1364-1366 and exterior.js:158/:1234-1236 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2655, exterior.js:1290,
  // dungeonContext.js:2436 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6708), which dungeon.js:524 and worldModes.js:8751 both feed.
