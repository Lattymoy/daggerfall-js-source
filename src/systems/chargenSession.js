...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2229, exterior.js:1242,
  // dungeonContext.js:2282 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:5992), which dungeon.js:488 and worldModes.js:7614 both feed.
