...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2647, exterior.js:1288,
  // dungeonContext.js:2420 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6648), which dungeon.js:524 and worldModes.js:8661 both feed.
