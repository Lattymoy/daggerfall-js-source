...
// 126/:1364-1366 and exterior.js:156/:1224-1226 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2633, exterior.js:1284,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6491), which dungeon.js:493 and worldModes.js:8250 both feed.
