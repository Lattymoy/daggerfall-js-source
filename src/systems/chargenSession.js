...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:3905, exterior.js:1386,
  // dungeonContext.js:2529 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6998), which dungeon.js:543 and worldModes.js:9562 both feed.
