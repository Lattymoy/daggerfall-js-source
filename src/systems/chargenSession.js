...
// 126/:1364-1366 and exterior.js:166/:1243-1245 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2663, exterior.js:1299,
  // dungeonContext.js:2441 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6714), which dungeon.js:524 and worldModes.js:8767 both feed.
