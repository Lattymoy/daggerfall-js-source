...
// 126/:1364-1366 and exterior.js:154/:1222-1224 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2631, exterior.js:1282,
  // dungeonContext.js:2367 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6471), which dungeon.js:493 and worldModes.js:8230 both feed.
