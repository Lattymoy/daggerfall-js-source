...
// 126/:1364-1366 and exterior.js:156/:1231-1233 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2610, exterior.js:1292,
  // dungeonContext.js:2434 - so the question is asked once, in the
 ...
 * and the hosts read that flag at routing time (townTalk.js:440,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // exterior.js through `townTalk.hover` (townTalk.js:1240-1251,
    // the route itself :1249), dungeonContext.js through `overlayHover`
    // (:6554), which dungeon.js:500 and worldModes.js:8565 both feed.
