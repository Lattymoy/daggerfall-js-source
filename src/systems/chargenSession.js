...
// 126/:1364-1366 and exterior.js:179/:1315-1317 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:3234, exterior.js:1371,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6732), which dungeon.js:528 and worldModes.js:8857 both feed.
