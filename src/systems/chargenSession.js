...
// 126/:1364-1366 and exterior.js:137/:1159-1161 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2197, exterior.js:1211,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:5935), which dungeon.js:488 and worldModes.js:7616 both feed.
