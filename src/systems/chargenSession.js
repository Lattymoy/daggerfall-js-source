...
// 126/:1364-1366 and exterior.js:144/:1191-1193 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2386, exterior.js:1243,
  // dungeonContext.js:2290 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6014), which dungeon.js:488 and worldModes.js:7686 both feed.
