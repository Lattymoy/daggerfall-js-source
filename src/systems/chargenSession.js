...
// 126/:1364-1366 and exterior.js:151/:1220-1222 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2585, exterior.js:1280,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6285), which dungeon.js:487 and worldModes.js:7866 both feed.
