...
// 126/:1364-1366 and exterior.js:141/:1166-1168 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2201, exterior.js:1218,
  // dungeonContext.js:2279 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:5972), which dungeon.js:488 and worldModes.js:7611 both feed.
