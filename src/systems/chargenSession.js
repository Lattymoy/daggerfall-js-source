...
// 126/:1364-1366 and exterior.js:168/:1251-1253 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2672, exterior.js:1307,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6732), which dungeon.js:524 and worldModes.js:8782 both feed.
