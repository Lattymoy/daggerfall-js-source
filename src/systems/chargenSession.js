...
// 126/:1364-1366 and exterior.js:168/:1249-1251 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2669, exterior.js:1305,
  // dungeonContext.js:2458 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6746), which dungeon.js:524 and worldModes.js:8816 both feed.
