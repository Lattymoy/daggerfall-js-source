...
// 126/:1364-1366 and exterior.js:180/:1311-1313 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:3241, exterior.js:1367,
  // dungeonContext.js:2449 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6734), which dungeon.js:533 and worldModes.js:8855 both feed.
