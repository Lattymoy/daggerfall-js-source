...
// 126/:1364-1366 and exterior.js:180/:1314-1316 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:3242, exterior.js:1370,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6760), which dungeon.js:528 and worldModes.js:8900 both feed.
