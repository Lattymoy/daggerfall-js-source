...
// 126/:1364-1366 and exterior.js:145/:1205-1207 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2475, exterior.js:1266,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6049), which dungeon.js:488 and worldModes.js:7728 both feed.
