...
// 126/:1364-1366 and exterior.js:158/:1233-1235 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2651, exterior.js:1289,
  // dungeonContext.js:2414 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6660), which dungeon.js:524 and worldModes.js:8693 both feed.
