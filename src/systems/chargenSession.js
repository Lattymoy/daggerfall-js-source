...
// 126/:1364-1366 and exterior.js:136/:1158-1160 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2185, exterior.js:1210,
  // dungeonContext.js:2271 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:5935), which dungeon.js:488 and worldModes.js:7600 both feed.
