...
// 126/:1364-1366 and exterior.js:158/:1235-1237 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2658, exterior.js:1291,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6727), which dungeon.js:524 and worldModes.js:8756 both feed.
