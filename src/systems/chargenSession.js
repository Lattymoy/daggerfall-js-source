...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:3277, exterior.js:1380,
  // dungeonContext.js:2482 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6828), which dungeon.js:539 and worldModes.js:8936 both feed.
