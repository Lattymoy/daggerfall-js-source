...
// 126/:1364-1366 and exterior.js:152/:1220-1222 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2629, exterior.js:1280,
  // dungeonContext.js:2366 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6435), which dungeon.js:492 and worldModes.js:8163 both feed.
