...
// 126/:1364-1366 and exterior.js:180/:1328-1330 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:3537, exterior.js:1384,
  // dungeonContext.js:2486 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6808), which dungeon.js:542 and worldModes.js:8950 both feed.
