...
// 126/:1364-1366 and exterior.js:145/:1203-1205 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2390, exterior.js:1264,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6020), which dungeon.js:488 and worldModes.js:7711 both feed.
