...
// 126/:1364-1366 and exterior.js:149/:1216-1218 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2518, exterior.js:1277,
  // dungeonContext.js:2311 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6106), which dungeon.js:489 and worldModes.js:7804 both feed.
