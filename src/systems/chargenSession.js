...
// 126/:1364-1366 and exterior.js:181/:1325-1327 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:3288, exterior.js:1381,
  // dungeonContext.js:2487 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6897), which dungeon.js:540 and worldModes.js:9037 both feed.
