...
// 126/:1364-1366 and exterior.js:148/:1215-1217 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2517, exterior.js:1276,
  // dungeonContext.js:2309 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6076), which dungeon.js:488 and worldModes.js:7793 both feed.
