...
// 126/:1364-1366 and exterior.js:147/:1214-1216 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2516, exterior.js:1275,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6063), which dungeon.js:489 and worldModes.js:7776 both feed.
