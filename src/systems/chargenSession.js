...
// 126/:1364-1366 and exterior.js:139/:1164-1166 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2195, exterior.js:1216,
  // dungeonContext.js:2274 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:5967), which dungeon.js:488 and worldModes.js:7600 both feed.
