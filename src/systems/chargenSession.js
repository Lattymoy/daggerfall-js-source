...
// 126/:1364-1366 and exterior.js:151/:1227-1229 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2590, exterior.js:1287,
  // dungeonContext.js:2431 - so the question is asked once, in the
 ...
 * and the hosts read that flag at routing time (townTalk.js:386,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // exterior.js through `townTalk.hover` (townTalk.js:1216-1227,
    // the route itself :1225), dungeonContext.js through `overlayHover`
    // (:6356), which dungeon.js:487 and worldModes.js:7944 both feed.
