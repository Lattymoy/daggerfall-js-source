...
// 126/:1364-1366 and exterior.js:182/:1330-1332 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:3898, exterior.js:1386,
  // dungeonContext.js:2528 - so the question is asked once, in the
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6994), which dungeon.js:543 and worldModes.js:9509 both feed.
