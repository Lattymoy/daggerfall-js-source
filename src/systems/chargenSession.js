...
// 126/:1364-1366 and exterior.js:169/:1247-1249 both import and run
...
export function createChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  // through this function - world.js:2674, exterior.js:1303,
...
function classicChargenWindow(flow, { onDone, onCancel, hudScale = 2 } = {}) {
  ...
  return {
    ...
    // (:6732), which dungeon.js:529 and worldModes.js:8779 both feed.
