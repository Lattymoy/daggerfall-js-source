...
import { invert4 } from '../player/tapRay.js';   // AUDIT 68 S15-invert4-duplicate: the port's one 4x4 inverse
...
/** Full 4x4 inverse (column-major), or null for a singular matrix - in
 *  DOUBLES, the pick's precision. AUDIT 68 S15-invert4-duplicate: the
 *  cofactors are tapRay's `invert4`; this file had its own copy. */
export const invertMat4 = (m) => invert4(m, new Float64Array(16));
