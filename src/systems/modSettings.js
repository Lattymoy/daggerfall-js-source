...
export const MOD_SETTINGS = Object.freeze({
  ...
  'handheld-torches': Object.freeze({
    ...
    keys: Object.freeze({
      ...
      // switch on THIS pane, off by default): A DEPARTURE ON THIS PANE, AND
      ...
      'Handling.LanternsAtWaist': Object.freeze({ default: false, description: 'If enabled, lanterns hang at your waist instead of being held: they never need a free hand, are never stowed, and light you from the hip. Torches and candles are still held. (This port’s own switch - the mod has none.)' }),
