...
export class LevelUpScreen {
  ...
  input(action) {
    ...
    // (scenes/townTalk.js's keyed arm and ui/input.js:524-525) - and
    // overlayAction can never answer 'minus', because its typed-
    // character branch (ui/input.js:326) owns the hyphen. The bare
 ...
 *  the overlayAction names (ui/input.js:340-341) and the raw e.code a
