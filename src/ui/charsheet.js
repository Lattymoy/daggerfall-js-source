...
export class LevelUpScreen {
  ...
  input(action) {
    ...
    // (scenes/townTalk.js's keyed arm and ui/input.js:441-442) - and
    // overlayAction can never answer 'minus', because its typed-
    // character branch (ui/input.js:243) owns the hyphen. The bare
 ...
 *  the overlayAction names (ui/input.js:257-258) and the raw e.code a
