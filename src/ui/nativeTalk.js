...
export class NativeTalkWindow {
   ...
   *  (treeCategories drops them, townTalk.js:761) - and SelectIndex
  ...
  press(name, right = false) {
    switch (name) {
      ...
      // hooks supplied at scenes/townTalk.js:705-707 and Work's OKAY
   ...
   *  `click(vx, vy, right, middle)` - townTalk.js:1203,
   *  worldModes.js:8553, dungeonContext.js:6397 - so the clock that
