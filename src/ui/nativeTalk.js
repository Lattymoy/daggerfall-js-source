...
export class NativeTalkWindow {
   ...
   *  (treeCategories drops them, townTalk.js:715) - and SelectIndex
  ...
  press(name, right = false) {
    switch (name) {
      ...
      // hooks supplied at scenes/townTalk.js:659-661 and Work's OKAY
   ...
   *  worldModes.js:7462, dungeonContext.js:5805 - so the clock that
