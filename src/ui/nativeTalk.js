...
export class NativeTalkWindow {
   ...
   *  (treeCategories drops them, townTalk.js:773) - and SelectIndex
  ...
  press(name, right = false) {
    switch (name) {
      ...
      // hooks supplied at scenes/townTalk.js:717-719 and Work's OKAY
   ...
   *  `click(vx, vy, right, middle)` - townTalk.js:1234,
   *  worldModes.js:8767, dungeonContext.js:6572 - so the clock that
