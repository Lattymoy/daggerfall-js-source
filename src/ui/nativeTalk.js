...
export class NativeTalkWindow {
   ...
   *  (treeCategories drops them, townTalk.js:771) - and SelectIndex
  ...
  press(name, right = false) {
    switch (name) {
      ...
      // hooks supplied at scenes/townTalk.js:715-717 and Work's OKAY
   ...
   *  worldModes.js:8615, dungeonContext.js:6466 - so the clock that
