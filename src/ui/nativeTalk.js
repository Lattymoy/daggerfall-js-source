...
export class NativeTalkWindow {
   ...
   *  (treeCategories drops them, townTalk.js:716) - and SelectIndex
  ...
  press(name, right = false) {
    switch (name) {
      ...
      // hooks supplied at scenes/townTalk.js:660-662 and Work's OKAY
   ...
   *  worldModes.js:7716, dungeonContext.js:6173 - so the clock that
