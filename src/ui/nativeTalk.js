...
export class NativeTalkWindow {
   ...
   *  (treeCategories drops them, townTalk.js:778) - and SelectIndex
  ...
  press(name, right = false) {
    switch (name) {
      ...
      // hooks supplied at scenes/townTalk.js:722-724 and Work's OKAY
   ...
   *  `click(vx, vy, right, middle)` - townTalk.js:1220,
   *  worldModes.js:9140, dungeonContext.js:6593 - so the clock that
