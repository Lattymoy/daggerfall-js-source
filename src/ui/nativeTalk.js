...
export class NativeTalkWindow {
   ...
   *  (treeCategories drops them, townTalk.js:785) - and SelectIndex
  ...
  press(name, right = false) {
    switch (name) {
      ...
      // hooks supplied at scenes/townTalk.js:729-731 and Work's OKAY
   ...
   *  `click(vx, vy, right, middle)` - townTalk.js:1227,
   *  worldModes.js:9164, dungeonContext.js:6594 - so the clock that
