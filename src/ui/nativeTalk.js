...
export class NativeTalkWindow {
   ...
   *  (treeCategories drops them, townTalk.js:754) - and SelectIndex
  ...
  press(name, right = false) {
    switch (name) {
      ...
      // hooks supplied at scenes/townTalk.js:698-700 and Work's OKAY
   ...
   *  worldModes.js:8335, dungeonContext.js:6361 - so the clock that
