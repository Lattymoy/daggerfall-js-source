...
export const CREDITS = Object.freeze({
  ...
  mods: Object.freeze([
    ...
    Object.freeze({
      ...
      terms: 'Ported 1:1 from the shipped bundle, read off its compiled script method by method; the mod\u2019s own 3035 sprites vendored, re-encoded as indexed PNG and lossless for every drawn pixel - see vendor/eye-of-the-beholder/README.md for the permission record and the measurement.',
