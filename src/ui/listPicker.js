...
export class ListPickerWindow {
  ...
  click(vx, vy, font = null, now = null) {
    ...
    if (inRect(PICKER_RECTS.list, vx, vy)) {
      ...
      // (townTalk.js:1123, worldModes.js:7089, dungeonContext.js:4867 - all three re-resolved BY CONTENT and pinned in test/citedrift.test.js by the ROAD-H tail review: they were stale together and a mechanical +1 had kept the dungeon's that way),
