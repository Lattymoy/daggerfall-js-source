...
export class ListPickerWindow {
  ...
  click(vx, vy, font = null) {   // AUDIT 65 UI-1: THREE slots - the 4th took the bare mounts' `middle` as its clock
    ...
    if (inRect(PICKER_RECTS.list, vx, vy)) {
      ...
      // (townTalk.js:1132, worldModes.js:7275, dungeonContext.js:5537 - all three re-resolved BY CONTENT and pinned in test/citedrift.test.js by the ROAD-H tail review: they were stale together and a mechanical +1 had kept the dungeon's that way),
