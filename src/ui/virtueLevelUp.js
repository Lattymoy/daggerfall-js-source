 ...
 *  prints them as three-letter heads (charsheet.js:180). This screen
...
export class VirtueLevelUpScreen {
  ...
  // The same action vocabulary LevelUpScreen answers (charsheet.js:128),
  ...
  // branch can produce (ui/input.js:436 - the typed-character branch,
