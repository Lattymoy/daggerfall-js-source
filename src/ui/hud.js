...
import { drawHudLarge } from './hudLarge.js';   // U43: the classic bottom bar - an ALTERNATIVE HUD, see below
...
/** U43: the rect the large HUD last drew itself into, so a host's
...
export function drawHud(renderer, canvas, art, vitals, heading01, dt = 0,
  ...
  if (!art) return;
  // U43 - THE LARGE HUD IS AN ALTERNATIVE, NOT AN ADDITION.
