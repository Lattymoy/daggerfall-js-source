...
export function drawHud(renderer, canvas, art, vitals, heading01, dt = 0,
  { font = null, cursorActive = false, windowCoversHud = null, detected = null, playerXZ = null, largeHud = null, hover = null,
    readied = null, weapon = null, weaponSheathed = true, quickUse = null, quickSwap = null, quickOffHand = null } = {}) {   // PX30b: for the enhanced HUD's hand plaques; AUDIT 28 W2: the arrow counter's gate; AUDIT 64 F35: the host's previousWindow answer; QS3: the diamond's sheathe state and its two phone taps
