...
function stow(item) {
  ...
  // (nativeInventory.js:883) and this one did not, so dragging a
  ...
  // the classic window's own call (nativeInventory.js:889). Without them
...
function take(item) {
  ...
  // window plays (nativeInventory.js:909) and this one never did - the ONLY
