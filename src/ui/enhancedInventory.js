...
function stow(item) {
  ...
  // (nativeInventory.js:797) and this one did not, so dragging a
  ...
  // the classic window's own call (nativeInventory.js:799). Without them
...
function take(item) {
  ...
  // window plays (nativeInventory.js:865) and this one never did - the ONLY
