...
// marks the copy `custom`, which is exactly the flag save.js:177
...
export class SpellbookWindow {
   ...
   *  and it is marked `custom` so save.js:177 stores the whole record
   ...
   *  `click(vx, vy, right, middle)` - `scenes/townTalk.js:1218`,
   *  `scenes/worldModes.js:8688`, `scenes/dungeonContext.js:6536` - so
