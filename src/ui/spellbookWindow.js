...
// marks the copy `custom`, which is exactly the flag save.js:181
...
export class SpellbookWindow {
   ...
   *  and it is marked `custom` so save.js:181 stores the whole record
   ...
   *  `scenes/worldModes.js:7464`, `scenes/dungeonContext.js:5782` - so
