...
// marks the copy `custom`, which is exactly the flag save.js:330
...
export class SpellbookWindow {
   ...
   *  and it is marked `custom` so save.js:330 stores the whole record
   ...
   *  `scenes/worldModes.js:8818`, `scenes/dungeonContext.js:6572` - so
