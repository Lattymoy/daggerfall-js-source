...
// marks the copy `custom`, which is exactly the flag save.js:178
...
export class SpellbookWindow {
   ...
   *  and it is marked `custom` so save.js:178 stores the whole record
   ...
   *  `click(vx, vy, right, middle)` - `scenes/townTalk.js:1234`,
   *  `scenes/worldModes.js:8736`, `scenes/dungeonContext.js:6561` - so
