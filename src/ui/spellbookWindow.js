...
// marks the copy `custom`, which is exactly the flag save.js:166
...
export class SpellbookWindow {
   ...
   *  and it is marked `custom` so save.js:166 stores the whole record
   ...
   *  `scenes/worldModes.js:7476`, `scenes/dungeonContext.js:5870` - so
