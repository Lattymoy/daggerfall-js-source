...
// marks the copy `custom`, which is exactly the flag save.js:342
...
export class SpellbookWindow {
   ...
   *  and it is marked `custom` so save.js:342 stores the whole record
   ...
   *  `scenes/worldModes.js:9095`, `scenes/dungeonContext.js:6683` - so
