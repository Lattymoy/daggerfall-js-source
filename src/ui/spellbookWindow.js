...
// marks the copy `custom`, which is exactly the flag save.js:344
...
export class SpellbookWindow {
   ...
   *  and it is marked `custom` so save.js:344 stores the whole record
   ...
   *  `scenes/worldModes.js:9473`, `scenes/dungeonContext.js:6831` - so
