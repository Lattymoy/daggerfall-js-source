...
// marks the copy `custom`, which is exactly the flag save.js:180
...
export class SpellbookWindow {
   ...
   *  and it is marked `custom` so save.js:180 stores the whole record
   ...
   *  `scenes/worldModes.js:8767`, `scenes/dungeonContext.js:6572` - so
