...
// marks the copy `custom`, which is exactly the flag save.js:167
...
export class SpellbookWindow {
   ...
   *  and it is marked `custom` so save.js:167 stores the whole record
   ...
   *  `scenes/worldModes.js:7478`, `scenes/dungeonContext.js:5805` - so
