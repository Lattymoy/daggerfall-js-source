...
// marks the copy `custom`, which is exactly the flag save.js:337
...
export class SpellbookWindow {
   ...
   *  and it is marked `custom` so save.js:337 stores the whole record
   ...
   *  `scenes/worldModes.js:8908`, `scenes/dungeonContext.js:6627` - so
