...
export class PauseOptionsWindow {
  ...
  constructor(hooks) {
    ...
    // host here opens on the key DOWN (world.js:5174, exterior.js:2399,
  ...
  keyup(code) {
    ...
    this._closeWith();
    // MAC1 J, the classic twin (ui/pauseDoor.js:165-182): the close runs
...
export function openClassicPauseFlow(show, hooks = {}) {
  ...
  const saveWindowHooks = (extra) => ({
    ...
    // (ui/pauseDoor.js:177 fires for 'save' and 'load', not 'exit').
