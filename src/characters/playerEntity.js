...
// through systems/chargenSession.js - dungeonContext.js:2103,
// world.js:2653, exterior.js:1295 and applyHeadlessChargen for the
// test room (AUDIT 23).
//
...
export const playerEntity = {
  ...
  fatigue: 3200,    // (Str 50 + End 0) x 64 over the stand-in stats above - maxFatigue's own arithmetic (statMods.js:140), no dropped term; applyCharacter re-derives it from the rolled stats (S15)
