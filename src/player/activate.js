...
/** DISC17-E (Discord: "Cant enter Mannimarcos room ... even if i bash it
...
function nearestActivatableHit(eye, dir, targets, collider) {
  ...
  let firstHit;            // DISC17-E: the one surface DFU's ray meets, cast lazily
  for (const target of targets) {
    ...
    if (d === 0 && boxContains(target.aabb, eye)) {
      ...
      // DISC17-E: CASTLE1's law for a box merely ENTERED. A mesh
