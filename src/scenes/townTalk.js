...
export function createTownTalk({ renderer, canvas, fetchBytes, playerEntity, regionIndex, onCrime = null, topics = null, palette = null, rolls = Math.random, talkEngine = null }) {
  ...
  return {
    keydown, tryActivate, frame, ensureLoaded, nextMode, setMode, showOverlay, setTopics, pointerdown, wheel, hover,   // U43: setMode is the large HUD's mode panel, whose cycle is not nextMode's
