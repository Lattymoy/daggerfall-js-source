...
// AUDIT 39 (#21): a GETTER, not startLoc's number. LowerRepForCrime
  ...
  // and dungeonContext.js:2348 mounts the same one, gated on
  ...
  function worldQuickSave(saveName = QUICK_SAVE_NAME) {
    ...
    // composer, dungeonContext.js:5921), so exterior mode and a
  ...
  // worldModes answers it in BOTH modes (worldModes.js:7654-7717 -
