...
// AUDIT 39 (#21): a GETTER, not startLoc's number. LowerRepForCrime
  ...
  // that context through modes.dungeonCtx - so worldModes.js:4744
  ...
  function worldQuickSave(saveName = QUICK_SAVE_NAME) {
    ...
    // composer, dungeonContext.js:5965), so exterior mode and a
  ...
  // worldModes answers it in BOTH modes (worldModes.js:7699-7762 -
