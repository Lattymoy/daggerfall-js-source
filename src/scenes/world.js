...
import { raceActivation } from '../player/activationRace.js';   // HARD2: one home for "the nearest thing under the one ray takes the click"   // G3: corpse loot; QG1: the foe-click door; TI1: the lock-on pick
