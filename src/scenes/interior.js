...
export async function bootInterior(canvas, renderer, params, status) {
  ...
  addEventListener('keydown', (e) => {
    ...
    // (ui/input.js:646-647) is "every host that registers a keydown
    // calls this FIRST", and it is NOT conditional on the host having
    // a destination for the key. First, because every arm below
    // returns before its own preventDefault - worldModes.js:8216 sits
  ...
  function frame(now) {
    ...
    // driver. dungeon.js:770 and worldModes.js:6202/:6230 gate the same
