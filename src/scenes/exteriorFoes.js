...
import { rollLootRarity, corpseSource } from '../systems/lootRarity.js';   // LR1: the item ladder over the corpse's list
  ...
  async function spawnFoe(mobileType, pos, { gender: forcedGender = null, yaw = null, questBehaviour = null, allied = false, feetGiven = false, replacing = false, puppet = null, seq = null, level = null } = {}) {
    ...
    try {
      ...
      if (puppet) entity.items = [];
        ...
        rollLootRarity(entity.items, corpseSource(basics, entity.level), { rolls, luck: liveStat(playerEntity, 'luck') });   // LR1: at the SOURCE's tier, off the same stream
      }
