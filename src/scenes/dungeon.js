...
import { requestLook, makeLookGate, bindCursorToggle } from '../player/pointerLock.js';   // U43: PlayerMouseLook.cursorActive
...
import { routeLargeHudClick } from '../ui/hudLarge.js';   // U43: the bar's eleven panels
...
export async function bootDungeon(canvas, renderer, params, status) {
  ...
  canvas.addEventListener('pointerdown', (e) => {
    ...
    // U43: the large HUD's eleven panels, BEFORE the relock - a click
