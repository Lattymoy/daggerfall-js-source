...
export async function bootExterior(canvas, renderer, params, status) {
   ...
   *  it (world.js:3610-3814) and is its own slice; this pool does not
   *  wait on it. */
   ...
   *  (effects.js:885/:899) - world.js:4164 hoisted its copy for exactly
  ...
  const magic = createPlayerMagic({
    ...
    // two engine-owning hosts wire the identical pair (world.js:4112-4113,
  ...
  const questWorld = {
    ...
    // other. world.js:8679 is the same line.
     ...
     *  %rn/%rt's producer - world.js:8578-8591. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:8494-8497's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:8467's line
     ...
     *  Bridge-only, no host state - world.js:8475's call verbatim. */
     ...
     *  Everything else is world.js:8579's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:9239's line.
    ...
    // encounter half is world.js:9331's line and the watch half is this
  ...
  // same order as world.js:9545/:9550, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:9529's
  // line for this host.
   ...
   *  encounter mount above, and world.js:4344-4360 is the shape.
   ...
   *  second ctx here is the shape FS1 was written about. */
  {
     ...
     *  world.js:4291-4292 does it. ROAD-G TAIL: a WATCHMAN transforms
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:14272-14512 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound, { swing })) {
          ...
          // BEFORE civilians - world.js:14622's order, and the order
