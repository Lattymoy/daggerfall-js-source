...
import { requestLook, makeLookGate, bindCursorToggle } from '../player/pointerLock.js';   // U43: bindCursorToggle is PlayerMouseLook.cursorActive
...
import { getInteractionMode } from '../player/interactionMode.js';   // U43: the mode panel's cycle reads it
...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  // U43 - THE ONE DOOR PER DESTINATION. The keydown ladder below and
  ...
  addEventListener('keydown', (e) => {
    ...
    // U43: the ladder below and the large HUD's panels are the SAME
  ...
  canvas.addEventListener('pointerdown', (e) => {
    ...
    // U43: the large HUD's panels, BEFORE the relock - a click on the
