...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const questWorld = {
    ...
    // other. world.js:6974 is the same line.
     ...
     *  %rn/%rt's producer - world.js:6873-6886. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:6789-6792's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:6762's line
     ...
     *  Bridge-only, no host state - world.js:6770's call verbatim. */
     ...
     *  Everything else is world.js:6874's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:7527's line.
    ...
    // encounter half is world.js:7607's line and the watch half is this
  ...
  // same order as world.js:7828/:7833, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:7812's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:8674).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:10216-10337 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:10431's order, and the order
