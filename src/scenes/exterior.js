...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  function onExhaustedExterior() {
    ...
    try {
      const out = exhaustionOutcome({
        ...
        enemiesNearby: areEnemiesNearby([...(cityGuards?.guards ?? []), ...(exteriorFoes?.foes ?? [])]),   // ROAD-G G2: BOTH street pools, world.js:1325's line
  ...
  // pool the mode machine holds, which is world.js:1730's line.
   ...
   *  the other two exterior hosts mount - world.js:1770 over the street
   ...
   *  it (world.js:1816-1900) and is its own slice; this pool does not
   *  wait on it. */
   ...
   *  (effects.js:828/:842) - world.js:1946 hoisted its copy for exactly
  ...
  const magic = createPlayerMagic({
    ...
    // two engine-owning hosts wire the identical pair (world.js:2033-2034,
  ...
  const questWorld = {
    ...
    // other. world.js:4834 is the same line.
     ...
     *  %rn/%rt's producer - world.js:4836-4849. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:4752-4755's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:4725's line
     ...
     *  Bridge-only, no host state - world.js:4733's call verbatim. */
     ...
     *  Everything else is world.js:4837's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:5409's line.
    ...
    // encounter half is world.js:5340's line and the watch half is this
   ...
   *  second ctx here is the shape FS1 was written about. */
  {
     ...
     *  encounter mount above, and world.js:2279-2295 is the shape.
     ...
     *  world.js:2221-2222 does it. A WATCHMAN is still left standing:
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:6921-6972 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:7030's order, and the order
