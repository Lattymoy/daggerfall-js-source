...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  //     continue;`, world.js:1872) and stands them in batches of their
  ...
  // pool the mode machine holds, which is world.js:3400's line.
  ...
  const cityGuards = createCityGuards({
    ...
    // own note describes. Written in world.js:3735's shape, so one pin
   ...
   *  the other two exterior hosts mount - world.js:3461 over the street
   ...
   *  it (world.js:3733-3937) and is its own slice; this pool does not
   *  wait on it. */
   ...
   *  (effects.js:885/:899) - world.js:4297 hoisted its copy for exactly
  ...
  const magic = createPlayerMagic({
    ...
    // two engine-owning hosts wire the identical pair (world.js:4245-4246,
  ...
  const questWorld = {
    ...
    // other. world.js:8830 is the same line.
     ...
     *  %rn/%rt's producer - world.js:8726-8739. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:8642-8645's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:8615's line
     ...
     *  Bridge-only, no host state - world.js:8623's call verbatim. */
     ...
     *  Everything else is world.js:8727's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:9390's line.
    ...
    // encounter half is world.js:9486's line and the watch half is this
  ...
  // same order as world.js:9700/:9705, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:9684's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:12732).
   ...
   *  encounter mount above, and world.js:4477-4493 is the shape.
   ...
   *  second ctx here is the shape FS1 was written about. */
  {
     ...
     *  world.js:4424-4425 does it. ROAD-G TAIL: a WATCHMAN transforms
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:14552-14792 is the shape.
    arrows.update(dt, {
