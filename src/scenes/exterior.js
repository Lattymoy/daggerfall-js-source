...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const questWorld = {
    ...
    // other. world.js:5894 is the same line.
     ...
     *  %rn/%rt's producer - world.js:5793-5806. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:5709-5712's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:5682's line
     ...
     *  Bridge-only, no host state - world.js:5690's call verbatim. */
     ...
     *  Everything else is world.js:5794's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:6447's line.
    ...
    // encounter half is world.js:6527's line and the watch half is this
  ...
  // same order as world.js:6748/:6753, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:6732's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:7462).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:8818-8938 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:9007's order, and the order
