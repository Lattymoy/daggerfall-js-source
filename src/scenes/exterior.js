...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const questWorld = {
    ...
    // other. world.js:9510 is the same line.
     ...
     *  %rn/%rt's producer - world.js:9406-9419. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:9322-9325's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:9295's line
     ...
     *  Bridge-only, no host state - world.js:9303's call verbatim. */
     ...
     *  Everything else is world.js:9407's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:10070's line.
    ...
    // encounter half is world.js:10166's line and the watch half is this
  ...
  // same order as world.js:10380/:10385, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:10364's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:13759).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:15691-15942 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound, { swing })) {
          ...
          // BEFORE civilians - world.js:16061's order, and the order
