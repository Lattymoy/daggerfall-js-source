...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const questWorld = {
    ...
    // other. world.js:5482 is the same line.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:5373's line
     ...
     *  Bridge-only, no host state - world.js:5381's call verbatim. */
     ...
     *  Everything else is world.js:5485's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:6138's line.
    ...
    // encounter half is world.js:6060's line and the watch half is this
  ...
  // here, so the sink is handed down at this moment - world.js:6422's
  // line for this host.
