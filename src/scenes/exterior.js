...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  // pool the mode machine holds, which is world.js:2199's line.
  ...
  const cityGuards = createCityGuards({
    ...
    // own note describes. Written in world.js:2298's shape, so one pin
   ...
   *  the other two exterior hosts mount - world.js:2239 over the street
   ...
   *  it (world.js:2296-2378) and is its own slice; this pool does not
   *  wait on it. */
  ...
  const outdoorRestDeps = createRestDeps(playerEntity, {
    ...
    advanceMinutes: (n) => { playerTicker.advance(n); runEncounterTick(walkMode ? player.pos : cam.pos); },   // ROAD-G TAIL: the catch-up loop rides the rest's minutes, as world.js:3206 has it
   ...
   *  (effects.js:881/:895) - world.js:2631 hoisted its copy for exactly
  ...
  const magic = createPlayerMagic({
    ...
    // two engine-owning hosts wire the identical pair (world.js:2544-2545,
  ...
  const questWorld = {
    ...
    // other. world.js:5912 is the same line.
     ...
     *  %rn/%rt's producer - world.js:5811-5824. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:5727-5730's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:5700's line
     ...
     *  Bridge-only, no host state - world.js:5708's call verbatim. */
     ...
     *  Everything else is world.js:5812's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:6465's line.
    ...
    // encounter half is world.js:6545's line and the watch half is this
  ...
  // same order as world.js:6766/:6771, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:6750's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:7531).
   ...
   *  second ctx here is the shape FS1 was written about. */
  {
     ...
     *  encounter mount above, and world.js:2813-2829 is the shape.
     ...
     *  world.js:2752-2753 does it. ROAD-G TAIL: a WATCHMAN transforms
