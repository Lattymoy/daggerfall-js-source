...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const questWorld = {
    ...
    // other. world.js:7028 is the same line.
     ...
     *  %rn/%rt's producer - world.js:6927-6940. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:6843-6846's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:6816's line
     ...
     *  Bridge-only, no host state - world.js:6824's call verbatim. */
     ...
     *  Everything else is world.js:6928's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:7581's line.
    ...
    // encounter half is world.js:7661's line and the watch half is this
  ...
  // same order as world.js:7882/:7887, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:7866's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:8733).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:10276-10397 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:10491's order, and the order
