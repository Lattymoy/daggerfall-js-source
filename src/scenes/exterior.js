...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  //     continue;`, world.js:1844) and stands them in batches of their
  ...
  // pool the mode machine holds, which is world.js:3372's line.
  ...
  const cityGuards = createCityGuards({
    ...
    // own note describes. Written in world.js:3707's shape, so one pin
   ...
   *  the other two exterior hosts mount - world.js:3433 over the street
   ...
   *  it (world.js:3705-3909) and is its own slice; this pool does not
   *  wait on it. */
   ...
   *  (effects.js:885/:899) - world.js:4259 hoisted its copy for exactly
  ...
  const magic = createPlayerMagic({
    ...
    // two engine-owning hosts wire the identical pair (world.js:4207-4208,
  ...
  const questWorld = {
     ...
     *  %rn/%rt's producer - world.js:8730-8743. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:8646-8649's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:8619's line
     ...
     *  Bridge-only, no host state - world.js:8627's call verbatim. */
     ...
     *  Everything else is world.js:8731's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // encounter half is world.js:9483's line and the watch half is this
  ...
  // same order as world.js:9697/:9702, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:9681's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:12707).
   ...
   *  encounter mount above, and world.js:4439-4455 is the shape.
   ...
   *  second ctx here is the shape FS1 was written about. */
  {
     ...
     *  world.js:4386-4387 does it. ROAD-G TAIL: a WATCHMAN transforms
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:14507-14747 is the shape.
    arrows.update(dt, {
