...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const questWorld = {
    ...
    // other. world.js:8582 is the same line.
     ...
     *  %rn/%rt's producer - world.js:8481-8494. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:8397-8400's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:8370's line
     ...
     *  Bridge-only, no host state - world.js:8378's call verbatim. */
     ...
     *  Everything else is world.js:8482's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:9141's line.
    ...
    // encounter half is world.js:9232's line and the watch half is this
  ...
  // same order as world.js:9447/:9452, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:9431's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:12004).
   ...
   *  second ctx here is the shape FS1 was written about. */
  {
     ...
     *  encounter mount above, and world.js:4330-4346 is the shape.
     ...
     *  world.js:4260-4261 does it. ROAD-G TAIL: a WATCHMAN transforms
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:13787-14026 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:14136's order, and the order
