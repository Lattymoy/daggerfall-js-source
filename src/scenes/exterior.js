...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const questWorld = {
    ...
    // other. world.js:7741 is the same line.
     ...
     *  %rn/%rt's producer - world.js:7640-7653. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:7556-7559's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:7529's line
     ...
     *  Bridge-only, no host state - world.js:7537's call verbatim. */
     ...
     *  Everything else is world.js:7641's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:8300's line.
    ...
    // encounter half is world.js:8391's line and the watch half is this
  ...
  // same order as world.js:8606/:8611, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:8590's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:10774).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:12454-12680 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:12790's order, and the order
