...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const questWorld = {
    ...
    // other. world.js:8621 is the same line.
     ...
     *  %rn/%rt's producer - world.js:8520-8533. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:8436-8439's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:8409's line
     ...
     *  Bridge-only, no host state - world.js:8417's call verbatim. */
     ...
     *  Everything else is world.js:8521's arm term for term: the cast
  ...
  // same order as world.js:9486/:9491, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:9470's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:12051).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:13845-14084 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound, { swing })) {
          ...
          // BEFORE civilians - world.js:14194's order, and the order
