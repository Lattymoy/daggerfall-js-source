...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const makeJournalWindow = (mode) => {
    ...
    // gate could never run. dungeonContext.js:1386-1391 is the shape:
  ...
  const questWorld = {
    ...
    // other. world.js:7311 is the same line.
     ...
     *  %rn/%rt's producer - world.js:7210-7223. */
     ...
     *  Everything else is world.js:7211's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:7874's line.
    ...
    // encounter half is world.js:7954's line and the watch half is this
  ...
  // same order as world.js:8175/:8180, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:8159's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:9081).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:10677-10852 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:10949's order, and the order
