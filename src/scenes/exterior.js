...
export async function bootExterior(canvas, renderer, params, status) {
   ...
   *  (effects.js:881/:895) - world.js:2744 hoisted its copy for exactly
  ...
  const magic = createPlayerMagic({
    ...
    // two engine-owning hosts wire the identical pair (world.js:2657-2658,
  ...
  const questWorld = {
    ...
    // other. world.js:6265 is the same line.
     ...
     *  %rn/%rt's producer - world.js:6164-6177. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:6080-6083's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:6053's line
     ...
     *  Bridge-only, no host state - world.js:6061's call verbatim. */
     ...
     *  Everything else is world.js:6165's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:6818's line.
    ...
    // encounter half is world.js:6898's line and the watch half is this
  ...
  // same order as world.js:7119/:7124, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:7103's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:7930).
   ...
   *  second ctx here is the shape FS1 was written about. */
  {
     ...
     *  encounter mount above, and world.js:2926-2942 is the shape.
     ...
     *  world.js:2865-2866 does it. ROAD-G TAIL: a WATCHMAN transforms
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:9329-9449 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:9518's order, and the order
