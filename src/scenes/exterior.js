...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const questWorld = {
    ...
    // other. world.js:8694 is the same line.
     ...
     *  %rn/%rt's producer - world.js:8590-8603. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:8506-8509's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:8479's line
     ...
     *  Bridge-only, no host state - world.js:8487's call verbatim. */
     ...
     *  Everything else is world.js:8591's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:9254's line.
    ...
    // encounter half is world.js:9350's line and the watch half is this
  ...
  // same order as world.js:9564/:9569, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:9548's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:12549).
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound, { swing })) {
          ...
          // BEFORE civilians - world.js:14701's order, and the order
