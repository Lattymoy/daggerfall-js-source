...
export async function bootExterior(canvas, renderer, params, status) {
   ...
   *  (effects.js:885/:899) - world.js:4302 hoisted its copy for exactly
  ...
  const questWorld = {
    ...
    // other. world.js:8897 is the same line.
     ...
     *  %rn/%rt's producer - world.js:8796-8809. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:8712-8715's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:8685's line
     ...
     *  Bridge-only, no host state - world.js:8693's call verbatim. */
     ...
     *  Everything else is world.js:8797's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:9457's line.
    ...
    // encounter half is world.js:9549's line and the watch half is this
  ...
  // same order as world.js:9763/:9768, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:9747's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:12773).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:14578-14818 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound, { swing })) {
          ...
          // BEFORE civilians - world.js:14932's order, and the order
