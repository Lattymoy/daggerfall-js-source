...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const questWorld = {
    ...
    // other. world.js:5599 is the same line.
     ...
     *  %rn/%rt's producer - world.js:5601-5614. */
     ...
     *  mode-aware (worldModes:1258), so this is world.js:5490's line
     ...
     *  Bridge-only, no host state - world.js:5498's call verbatim. */
     ...
     *  Everything else is world.js:5602's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:6255's line.
    ...
    // encounter half is world.js:6177's line and the watch half is this
  ...
  // same order as world.js:6556/:6557, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:6540's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:6933).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:8232-8351 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:8420's order, and the order
