...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const questWorld = {
    ...
    // other. world.js:7262 is the same line.
     ...
     *  %rn/%rt's producer - world.js:7161-7174. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:7077-7080's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:7050's line
     ...
     *  Bridge-only, no host state - world.js:7058's call verbatim. */
     ...
     *  Everything else is world.js:7162's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:7816's line.
    ...
    // encounter half is world.js:7896's line and the watch half is this
  ...
  // same order as world.js:8117/:8122, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:8101's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:9023).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:10606-10780 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:10876's order, and the order
