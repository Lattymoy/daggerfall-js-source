...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const questWorld = {
    ...
    // other. world.js:7030 is the same line.
     ...
     *  %rn/%rt's producer - world.js:6929-6942. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:6845-6848's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:6818's line
     ...
     *  Bridge-only, no host state - world.js:6826's call verbatim. */
     ...
     *  Everything else is world.js:6930's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:7583's line.
    ...
    // encounter half is world.js:7663's line and the watch half is this
  ...
  // same order as world.js:7884/:7889, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:7868's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:8750).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:10293-10414 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:10508's order, and the order
