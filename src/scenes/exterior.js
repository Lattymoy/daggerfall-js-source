...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const questWorld = {
    ...
    // other. world.js:7735 is the same line.
     ...
     *  %rn/%rt's producer - world.js:7634-7647. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:7550-7553's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:7523's line
     ...
     *  Bridge-only, no host state - world.js:7531's call verbatim. */
     ...
     *  Everything else is world.js:7635's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:8294's line.
    ...
    // encounter half is world.js:8385's line and the watch half is this
  ...
  // same order as world.js:8600/:8605, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:8584's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:10550).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:12229-12429 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:12536's order, and the order
