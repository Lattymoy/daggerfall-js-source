...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const questWorld = {
    ...
    // other. world.js:8832 is the same line.
     ...
     *  %rn/%rt's producer - world.js:8731-8744. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:8647-8650's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:8620's line
     ...
     *  Bridge-only, no host state - world.js:8628's call verbatim. */
     ...
     *  Everything else is world.js:8732's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:9392's line.
    ...
    // encounter half is world.js:9484's line and the watch half is this
  ...
  // same order as world.js:9698/:9703, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:9682's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:12711).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:14511-14751 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound, { swing })) {
          ...
          // BEFORE civilians - world.js:14865's order, and the order
