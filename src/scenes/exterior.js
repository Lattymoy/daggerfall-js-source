...
export async function bootExterior(canvas, renderer, params, status) {
   ...
   *  (effects.js:881/:895) - world.js:3169 hoisted its copy for exactly
  ...
  const questWorld = {
    ...
    // other. world.js:7168 is the same line.
     ...
     *  %rn/%rt's producer - world.js:7067-7080. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:6983-6986's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:6956's line
     ...
     *  Bridge-only, no host state - world.js:6964's call verbatim. */
     ...
     *  Everything else is world.js:7068's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:7721's line.
    ...
    // encounter half is world.js:7801's line and the watch half is this
  ...
  // same order as world.js:8022/:8027, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:8006's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:8903).
   ...
   *  second ctx here is the shape FS1 was written about. */
  {
     ...
     *  encounter mount above, and world.js:3351-3367 is the shape.
     ...
     *  world.js:3281-3282 does it. ROAD-G TAIL: a WATCHMAN transforms
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:10473-10647 is the shape.
    arrows.update(dt, {
