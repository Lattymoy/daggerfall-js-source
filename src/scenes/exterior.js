...
export async function bootExterior(canvas, renderer, params, status) {
   ...
   *  (effects.js:880/:894) - world.js:4117 hoisted its copy for exactly
  ...
  const questWorld = {
    ...
    // other. world.js:8544 is the same line.
     ...
     *  %rn/%rt's producer - world.js:8443-8456. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:8359-8362's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:8332's line
     ...
     *  Bridge-only, no host state - world.js:8340's call verbatim. */
     ...
     *  Everything else is world.js:8444's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:9104's line.
    ...
    // encounter half is world.js:9195's line and the watch half is this
  ...
  // same order as world.js:9409/:9414, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:9393's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:11886).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:13670-13909 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:14019's order, and the order
