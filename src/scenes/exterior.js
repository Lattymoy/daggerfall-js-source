...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  //     continue;`, world.js:813) and stands them in batches of their
  ...
  function onExhaustedExterior() {
    ...
    try {
      const out = exhaustionOutcome({
        ...
        enemiesNearby: areEnemiesNearby([...(cityGuards?.guards ?? []), ...(exteriorFoes?.foes ?? [])]),   // ROAD-G G2: BOTH street pools, world.js:1371's line
  ...
  // pool the mode machine holds, which is world.js:1776's line.
   ...
   *  the other two exterior hosts mount - world.js:1816 over the street
   ...
   *  it (world.js:1862-1946) and is its own slice; this pool does not
   *  wait on it. */
   ...
   *  (effects.js:828/:842) - world.js:1992 hoisted its copy for exactly
  ...
  const magic = createPlayerMagic({
    ...
    // two engine-owning hosts wire the identical pair (world.js:2079-2080,
  ...
  const questWorld = {
    ...
    // other. world.js:4880 is the same line.
     ...
     *  %rn/%rt's producer - world.js:4882-4895. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:4798-4801's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:4771's line
     ...
     *  Bridge-only, no host state - world.js:4779's call verbatim. */
     ...
     *  Everything else is world.js:4883's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:5455's line.
    ...
    // encounter half is world.js:5386's line and the watch half is this
   ...
   *  second ctx here is the shape FS1 was written about. */
  {
     ...
     *  encounter mount above, and world.js:2325-2341 is the shape.
     ...
     *  world.js:2267-2268 does it. A WATCHMAN is still left standing:
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:6980-7031 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:7089's order, and the order
