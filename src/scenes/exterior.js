...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const questWorld = {
    ...
    // other. world.js:5764 is the same line.
     ...
     *  %rn/%rt's producer - world.js:5663-5676. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:5579-5582's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:5552's line
     ...
     *  Bridge-only, no host state - world.js:5560's call verbatim. */
     ...
     *  Everything else is world.js:5664's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:6317's line.
    ...
    // encounter half is world.js:6397's line and the watch half is this
  ...
  // same order as world.js:6618/:6623, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:6602's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:7041).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:8362-8482 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:8551's order, and the order
