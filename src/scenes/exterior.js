...
import { spellRecordOfIndex } from '../systems/loot.js';   // QG1: CastSpellDo's classic-record read (the G4 registry) - world.js:227's import
...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  //     continue;`, world.js:2342) and stands them in batches of their
  ...
  function onExhaustedExterior() {
    ...
    try {
      const out = exhaustionOutcome({
        ...
        enemiesNearby: areEnemiesNearby([...(cityGuards?.guards ?? []), ...(exteriorFoes?.foes ?? [])]),   // ROAD-G G2: BOTH street pools, world.js:3291's line
  ...
  // pool the mode machine holds, which is world.js:3900's line.
  ...
  const cityGuards = createCityGuards({
    ...
    // own note describes. Written in world.js:4235's shape, so one pin
   ...
   *  the other two exterior hosts mount - world.js:3961 over the street
   ...
   *  it (world.js:4233-4443) and is its own slice; this pool does not
   *  wait on it. */
   ...
   *  (effects.js:892/:906) - world.js:4803 hoisted its copy for exactly
  ...
  const magic = createPlayerMagic({
    ...
    // two engine-owning hosts wire the identical pair (world.js:4751-4752,
  ...
  const questWorld = {
    ...
    // other. world.js:9518 is the same line.
     ...
     *  %rn/%rt's producer - world.js:9414-9427. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:9330-9333's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:9303's line
     ...
     *  Bridge-only, no host state - world.js:9311's call verbatim. */
     ...
     *  Everything else is world.js:9415's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:10078's line.
    ...
    // encounter half is world.js:10174's line and the watch half is this
  ...
  // same order as world.js:10388/:10393, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:10372's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:13778).
   ...
   *  encounter mount above, and world.js:4983-4999 is the shape.
   ...
   *  second ctx here is the shape FS1 was written about. */
  {
     ...
     *  world.js:4930-4931 does it. ROAD-G TAIL: a WATCHMAN transforms
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:15711-15962 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound, { swing })) {
          ...
          // BEFORE civilians - world.js:16081's order, and the order
