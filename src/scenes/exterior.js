...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const questWorld = {
    ...
    // other. world.js:5541 is the same line.
     ...
     *  %rn/%rt's producer - world.js:5543-5556. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:5459-5462's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:5432's line
     ...
     *  Bridge-only, no host state - world.js:5440's call verbatim. */
     ...
     *  Everything else is world.js:5544's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:6197's line.
    ...
    // encounter half is world.js:6119's line and the watch half is this
  ...
  // same order as world.js:6497/:6502, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:6481's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:6595).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:7885-8004 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:8073's order, and the order
