...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  const questWorld = {
    ...
    // other. world.js:6348 is the same line.
     ...
     *  %rn/%rt's producer - world.js:6247-6260. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:6163-6166's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:6136's line
     ...
     *  Bridge-only, no host state - world.js:6144's call verbatim. */
     ...
     *  Everything else is world.js:6248's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:6901's line.
    ...
    // encounter half is world.js:6981's line and the watch half is this
  ...
  // same order as world.js:7202/:7207, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:7186's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:7981).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:9460-9580 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:9652's order, and the order
