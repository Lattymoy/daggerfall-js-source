...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  //     continue;`, world.js:1049) and stands them in batches of their
  ...
  const questWorld = {
    ...
    // other. world.js:5584 is the same line.
     ...
     *  %rn/%rt's producer - world.js:5586-5599. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:5502-5505's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:5475's line
     ...
     *  Bridge-only, no host state - world.js:5483's call verbatim. */
     ...
     *  Everything else is world.js:5587's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:6240's line.
    ...
    // encounter half is world.js:6162's line and the watch half is this
  ...
  // same order as world.js:6540/:6544, for the same reason: the
  ...
  // here, so the sink is handed down at this moment - world.js:6524's
  // line for this host.
  ...
  var modes = createWorldModes({
    ...
    buildingDirectory: () => ({
      ...
      // two inputs the world host uses (world.js:6884).
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:8183-8302 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:8371's order, and the order
