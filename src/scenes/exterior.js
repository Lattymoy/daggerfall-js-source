...
export async function bootExterior(canvas, renderer, params, status) {
  ...
  function onExhaustedExterior() {
    ...
    try {
      const out = exhaustionOutcome({
        ...
        enemiesNearby: areEnemiesNearby([...(cityGuards?.guards ?? []), ...(exteriorFoes?.foes ?? [])]),   // ROAD-G G2: BOTH street pools, world.js:1376's line
  ...
  // pool the mode machine holds, which is world.js:1781's line.
   ...
   *  the other two exterior hosts mount - world.js:1821 over the street
   ...
   *  it (world.js:1867-1951) and is its own slice; this pool does not
   *  wait on it. */
   ...
   *  (effects.js:828/:842) - world.js:1997 hoisted its copy for exactly
  ...
  const magic = createPlayerMagic({
    ...
    // two engine-owning hosts wire the identical pair (world.js:2084-2085,
  ...
  const questWorld = {
    ...
    // other. world.js:4885 is the same line.
     ...
     *  %rn/%rt's producer - world.js:4887-4900. */
    ...
    // QG1: CastSpellDo's two world reads, world.js:4803-4806's pair.
     ...
     *  mode-aware (worldModes:1258), so this is world.js:4776's line
     ...
     *  Bridge-only, no host state - world.js:4784's call verbatim. */
     ...
     *  Everything else is world.js:4888's arm term for term: the cast
  ...
  questBridge = createQuestBridge({
    ...
    // closure S40 gave this host, and world.js:5460's line.
    ...
    // encounter half is world.js:5391's line and the watch half is this
   ...
   *  second ctx here is the shape FS1 was written about. */
  {
     ...
     *  encounter mount above, and world.js:2330-2346 is the shape.
     ...
     *  world.js:2272-2273 does it. A WATCHMAN is still left standing:
  ...
  function frame(now) {
    ...
    // through the player for ever. world.js:7002-7053 is the shape.
    arrows.update(dt, {
    ...
    if (walkMode && !tpMode) {
      ...
      for (const ev of weaponRig.frame(dt, { paralyzed })) {
        ...
        if (!cityGuards.resolvePlayerHit(weaponRig.playerWeapon, eye, fwd, player.pos, makeInView(proj, view, multiply), guardHitSound)) {
          ...
          // BEFORE civilians - world.js:7111's order, and the order
