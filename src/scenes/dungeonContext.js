...
export async function buildDungeonContext(deps, dfLocation, blocks, climateBaseType, opts = {}) {
  ...
  // host's own townTalk sink (world.js:10376 / exterior.js:3692), set
   ...
   *  mountSpellWindow DUNGEON ARM (worldModes.js:1243,
        ...
        if (m.fromPlayer) {
          ...
          for (const f of foes) {
            ...
            if (missileHitsFoe(m.pos, f)) {   // ROAD-H tail: DaggerfallMissile.cs:339's SphereCast meets the foe's CAPSULE (REVIEW 2026-09-05 had its centre as a point)
              ...
              // playerArrowHitFoe is the one copy world.js:16700,
              // exterior.js:5264 and worldModes.js:7933 already ran;
