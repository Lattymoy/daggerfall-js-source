...
export async function buildDungeonContext(deps, dfLocation, blocks, climateBaseType, opts = {}) {
  ...
  // host's own townTalk sink (world.js:9387 / exterior.js:3657), set
   ...
   *  mountSpellWindow DUNGEON ARM (worldModes.js:1168,
  ...
  async function ensureArrowModel(m) {
    ...
    // (dungeon.js:1067 against :1096; worldModes.js:7086 against :7110).   // QS6: both pairs' SECOND half was stale before this slice - they named neither `drawFoes` call, and a positional bump would have moved a wrong number by the right offset; re-resolved by content
        ...
        if (m.fromPlayer) {
          for (const f of foes) {
            ...
            if (missileHitsFoe(m.pos, f)) {   // ROAD-H tail: DaggerfallMissile.cs:339's SphereCast meets the foe's CAPSULE (REVIEW 2026-09-05 had its centre as a point)
              ...
              // playerArrowHitFoe is the one copy world.js:14407,
              // exterior.js:5222 and worldModes.js:7287 already ran;
