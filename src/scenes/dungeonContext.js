...
export async function buildDungeonContext(deps, dfLocation, blocks, climateBaseType, opts = {}) {
  ...
  async function ensureArrowModel(m) {
    ...
    // (dungeon.js:365 against :391; worldModes.js:999 against :1007).
        ...
        if (m.fromPlayer) {
          for (const f of foes) {
            ...
            if (Math.hypot(fx, fy, fz) <= MISSILE_COLLIDER_RADIUS + 0.45) {
              ...
              // playerArrowHitFoe is the one copy world.js:6430,
              // exterior.js:3526 and worldModes.js:4627 already ran;
