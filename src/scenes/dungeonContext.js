...
export async function buildDungeonContext(deps, dfLocation, blocks, climateBaseType, opts = {}) {
  ...
  // host's own townTalk sink (world.js:9679 / exterior.js:3686), set
   ...
   *  mountSpellWindow DUNGEON ARM (worldModes.js:1236,
  ...
  async function ensureArrowModel(m) {
    ...
    // (dungeon.js:1082 against :1112; worldModes.js:7169 against :7193).   // QS6: both pairs' SECOND half was stale before this slice - they named neither `drawFoes` call, and a positional bump would have moved a wrong number by the right offset; re-resolved by content
        ...
        if (m.fromPlayer) {
          for (const f of foes) {
            ...
            if (missileHitsFoe(m.pos, f)) {   // ROAD-H tail: DaggerfallMissile.cs:339's SphereCast meets the foe's CAPSULE (REVIEW 2026-09-05 had its centre as a point)
              ...
              // playerArrowHitFoe is the one copy world.js:15323,
              // exterior.js:5258 and worldModes.js:7816 already ran;
