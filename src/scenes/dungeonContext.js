...
export async function buildDungeonContext(deps, dfLocation, blocks, climateBaseType, opts = {}) {
  ...
  async function ensureArrowModel(m) {
    ...
    // (dungeon.js:764 against :795; worldModes.js:5062 against :5071).
        ...
        if (m.fromPlayer) {
          for (const f of foes) {
            ...
            if (Math.hypot(fx, fy, fz) <= MISSILE_COLLIDER_RADIUS + 0.45) {
              ...
              // playerArrowHitFoe is the one copy world.js:6480,
              // exterior.js:3704 and worldModes.js:4635 already ran;
