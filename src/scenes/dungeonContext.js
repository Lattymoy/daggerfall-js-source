...
export async function buildDungeonContext(deps, dfLocation, blocks, climateBaseType, opts = {}) {
  ...
  async function ensureArrowModel(m) {
    ...
    // (dungeon.js:766 against :797; worldModes.js:5066 against :5075).
        ...
        if (m.fromPlayer) {
          for (const f of foes) {
            ...
            if (Math.hypot(fx, fy, fz) <= MISSILE_COLLIDER_RADIUS + 0.45) {
              ...
              // playerArrowHitFoe is the one copy world.js:6494,
              // exterior.js:3717 and worldModes.js:4635 already ran;
