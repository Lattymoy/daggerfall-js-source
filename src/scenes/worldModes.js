    ...
    interiorArrows.update(dt, {
      ...
      onPlayerHit: (m) => {
        ...
        if (dmg > 0) {
          ...
          // a blow (world.js:8362's own wave-46 note); the interior
...
// AUDIT 39 (#132): the flag the other three hosts pass and
  ...
  return {
     ...
     *  worldQuickLoad calls forceExitToExterior FIRST (world.js:5669)
     ...
     *  HARD2c: this used to spell them out, and named `world.js:5814`
