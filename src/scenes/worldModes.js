...
export function createWorldModes(host) {
   ...
   * record these hosts mint spells it `name` (exterior.js:3673 hands
    ...
    interiorArrows.update(dt, {
      ...
      onPlayerHit: (m) => {
        ...
        if (dmg > 0) {
          ...
          // a blow (world.js:9094's own wave-46 note); the interior
...
// AUDIT 39 (#132): the flag the other three hosts pass and
  ...
  addEventListener('mousedown', (e) => {
    ...
    // host bag (`exterior.js:3735`, `world.js`'s twin), and the OUTER
  ...
  return {
     ...
     *  unconditionally (world.js:6277). So an F9 pressed in a shop
     ...
     *  worldQuickLoad calls forceExitToExterior FIRST (world.js:6370)
     ...
     *  HARD2c: this used to spell them out, and named `world.js:6530`
