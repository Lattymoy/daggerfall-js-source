...
export function createWorldModes(host) {
   ...
   * record these hosts mint spells it `name` (exterior.js:3705 hands
    ...
    try {
      const ctx = await buildDungeonContext(
        ...
        dfLocation, blocks, dfLocation.climate.climateType, {
          ...
          // the key falls to routeKey -> ui/input.js:745 -> the
...
// AUDIT 39 (#132): the flag the other three hosts pass and
  ...
  addEventListener('mousedown', (e) => {
    ...
    // host bag (`exterior.js:3767`, `world.js`'s twin), and the OUTER
  ...
  const interiorKeyCtx = {
    ...
    // (ui/input.js:574), so the frame poll stays its only keyboard door.
