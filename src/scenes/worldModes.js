...
export function createWorldModes(host) {
   ...
   *  READ the effect list every frame (exteriorFoes.js:885-889 and
    ...
    interiorArrows.update(dt, {
      ...
      onPlayerHit: (m) => {
        ...
        if (dmg > 0) {
          ...
          // a blow (world.js:9077's own wave-46 note); the interior
...
// AUDIT 39 (#132): the flag the other three hosts pass and
  ...
  return {
     ...
     *  unconditionally (world.js:6263). So an F9 pressed in a shop
     ...
     *  worldQuickLoad calls forceExitToExterior FIRST (world.js:6356)
     ...
     *  HARD2c: this used to spell them out, and named `world.js:6516`
