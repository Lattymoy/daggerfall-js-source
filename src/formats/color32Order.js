...
// (renderer.js:2172), and BB_VS samples the quad's TOP at v=1, i.e. the
// LAST row (renderer.js:333-357). In Daggerfall Unity there is nothing
 ...
 * (renderer.js:2182, :2745). A decoded PNG's `{ width, height, data }`
