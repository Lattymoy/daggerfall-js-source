...
// (renderer.js:1995), and BB_VS samples the quad's TOP at v=1, i.e. the
// LAST row (renderer.js:306-331). In Daggerfall Unity there is nothing
 ...
 * (renderer.js:2005, :2553). A decoded PNG's `{ width, height, data }`
