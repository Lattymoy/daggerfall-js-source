...
// (renderer.js:2389), and BB_VS samples the quad's TOP at v=1, i.e. the
// LAST row (renderer.js:387-411). In Daggerfall Unity there is nothing
 ...
 * (renderer.js:2399, :2962). A decoded PNG's `{ width, height, data }`
