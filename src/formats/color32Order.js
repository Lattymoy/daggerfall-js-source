...
// (renderer.js:2684), and BB_VS samples the quad's TOP at v=1, i.e. the
// LAST row (renderer.js:382-406). In Daggerfall Unity there is nothing
 ...
 * (renderer.js:2694, :3491). A decoded PNG's `{ width, height, data }`
