...
// (renderer.js:3696), and BB_VS samples the quad's TOP at v=1, i.e. the
// LAST row (renderer.js:369-393). In Daggerfall Unity there is nothing
 ...
 * (renderer.js:3706, :4479). A decoded PNG's `{ width, height, data }`
