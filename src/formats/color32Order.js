...
// (renderer.js:2129), and BB_VS samples the quad's TOP at v=1, i.e. the
// LAST row (renderer.js:308-332). In Daggerfall Unity there is nothing
 ...
 * (renderer.js:2139, :2697). A decoded PNG's `{ width, height, data }`
