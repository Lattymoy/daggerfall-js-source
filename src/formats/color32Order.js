...
// (renderer.js:1739), and BB_VS samples the quad's TOP at v=1, i.e. the
// LAST row (renderer.js:277-282). In Daggerfall Unity there is nothing
 ...
 * (renderer.js:1749, :2329). A decoded PNG's `{ width, height, data }`
