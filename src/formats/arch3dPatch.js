// ARCH3D.BSA runtime patch table.
// 1:1 extraction of Daggerfall Unity's Arch3dPatch.cs (MIT, Daggerfall
// Workshop / Ferital). Fixes some models, especially incorrect UV
// coordinates, by overwriting bytes in the loaded ARCH3D.BSA buffer before
// parsing. Mechanically extracted from the C# source; model comments kept.
// Each entry: [byteOffset, [newBytes...]].

export const ARCH3D_PATCH = [
  // Model 262 (Weapon store exterior wall on the right side of the door (e.g. The Count's Arsenal, Newtale, Bhoriane)
  [14515830, [0, 252]],
