...
// (render/renderer.js:858) binds an offscreen target with its OWN depth
 ...
 * drawCharacter issues drawArrays (renderer.js:798). The MW readers hand
 ...
 * (renderer.js:796), so the winding costs nothing else.
 */
...
export function createFpArm() {
  ...
  const api = {
     ...
     * WORLD's lens, which is mirrorProjectionX (dungeon.js:653 et al.),
