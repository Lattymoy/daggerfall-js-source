...
// (render/renderer.js:773) binds an offscreen target with its OWN depth
 ...
 * drawCharacter issues drawArrays (renderer.js:724). The MW readers hand
 ...
 * (renderer.js:722), so the winding costs nothing else.
 */
...
export function createFpArm() {
  ...
  const api = {
     ...
     * WORLD's lens, which is mirrorProjectionX (dungeon.js:549 et al.),
