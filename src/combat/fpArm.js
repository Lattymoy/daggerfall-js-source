...
// (render/renderer.js:856) binds an offscreen target with its OWN depth
 ...
 * drawCharacter issues drawArrays (renderer.js:796). The MW readers hand
 ...
 * (renderer.js:794), so the winding costs nothing else.
 */
...
export function createFpArm() {
  ...
  const api = {
     ...
     * yaw 0 (motor.js:657) - a LEFT-handed convention the mirror turns
