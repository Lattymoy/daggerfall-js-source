...
// (render/renderer.js:1180) binds an offscreen target with its OWN depth
 ...
 * drawCharacter issues drawArrays (renderer.js:1120). The MW readers hand
 ...
 * (renderer.js:1118), so the winding costs nothing else.
 */
