...
// (render/renderer.js:1131) binds an offscreen target with its OWN depth
 ...
 * drawCharacter issues drawArrays (renderer.js:1071). The MW readers hand
 ...
 * (renderer.js:1069), so the winding costs nothing else.
 */
