 ...
 * drawCharacter issues drawArrays (renderer.js:808). The MW readers hand
 ...
 * (renderer.js:806), so the winding costs nothing else.
 */
...
export function createFpArm() {
  ...
  const api = {
     ...
     * WORLD's lens, which is mirrorProjectionX (dungeon.js:659 et al.),
