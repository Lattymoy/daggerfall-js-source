...
// (render/renderer.js:1179) binds an offscreen target with its OWN depth
 ...
 * drawCharacter issues drawArrays (renderer.js:1119). The MW readers hand
 ...
 * (renderer.js:1117), so the winding costs nothing else.
 */
