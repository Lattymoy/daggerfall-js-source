...
// (render/renderer.js:1124) binds an offscreen target with its OWN depth
 ...
 * drawCharacter issues drawArrays (renderer.js:1064). The MW readers hand
 ...
 * (renderer.js:1062), so the winding costs nothing else.
 */
...
export function createFpArm() {
  ...
  const api = {
     ...
     * WORLD's lens, which is mirrorProjectionX (dungeon.js:665 et al.),
