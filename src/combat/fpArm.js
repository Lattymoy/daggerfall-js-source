...
// (render/renderer.js:1217) binds an offscreen target with its OWN depth
 ...
 * drawCharacter issues drawArrays (renderer.js:1149). The MW readers hand
 ...
 * (renderer.js:1147), so the winding costs nothing else.
 */
