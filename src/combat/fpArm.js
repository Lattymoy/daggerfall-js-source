...
// (render/renderer.js:770) binds an offscreen target with its OWN depth
 ...
 * drawCharacter issues drawArrays (renderer.js:721). The MW readers hand
 ...
 * (renderer.js:719), so the winding costs nothing else.
 */
...
export function createFpArm() {
  ...
  const api = {
     ...
     * WORLD's lens, which is mirrorProjectionX (dungeon.js:530 et al.),
