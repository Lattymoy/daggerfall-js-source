...
// (render/renderer.js:786) binds an offscreen target with its OWN depth
 ...
 * drawCharacter issues drawArrays (renderer.js:737). The MW readers hand
 ...
 * (renderer.js:735), so the winding costs nothing else.
 */
...
export function createFpArm() {
  ...
  const api = {
     ...
     * WORLD's lens, which is mirrorProjectionX (dungeon.js:573 et al.),
