...
// (render/renderer.js:787) binds an offscreen target with its OWN depth
 ...
 * drawCharacter issues drawArrays (renderer.js:738). The MW readers hand
 ...
 * (renderer.js:736), so the winding costs nothing else.
 */
...
export function createFpArm() {
  ...
  const api = {
     ...
     * WORLD's lens, which is mirrorProjectionX (dungeon.js:589 et al.),
