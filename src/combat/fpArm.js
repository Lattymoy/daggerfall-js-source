...
// (render/renderer.js:1221) binds an offscreen target with its OWN depth
 ...
 * drawCharacter issues drawArrays (renderer.js:1134). The MW readers hand
 ...
 * (renderer.js:1132), so the winding costs nothing else.
 */
