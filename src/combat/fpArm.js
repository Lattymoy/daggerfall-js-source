...
// (render/renderer.js:1123) binds an offscreen target with its OWN depth
 ...
 * drawCharacter issues drawArrays (renderer.js:1063). The MW readers hand
 ...
 * (renderer.js:1061), so the winding costs nothing else.
 */
