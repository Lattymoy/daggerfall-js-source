...
// (render/renderer.js:805) binds an offscreen target with its OWN depth
 ...
 * drawCharacter issues drawArrays (renderer.js:756). The MW readers hand
 ...
 * (renderer.js:754), so the winding costs nothing else.
 */
...
export function createFpArm() {
  ...
  const api = {
     ...
     * WORLD's lens, which is mirrorProjectionX (dungeon.js:596 et al.),
     * and the port's world convention puts the player's RIGHT at +X at
     * yaw 0 (motor.js:642) - a LEFT-handed convention the mirror turns
