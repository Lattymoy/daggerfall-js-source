...
// (render/renderer.js:1159) binds an offscreen target with its OWN depth
 ...
 * drawCharacter issues drawArrays (renderer.js:1099). The MW readers hand
 ...
 * (renderer.js:1097), so the winding costs nothing else.
 */
...
export function createFpArm() {
  ...
  const api = {
     ...
     * WORLD's lens, which is mirrorProjectionX (dungeon.js:663 et al.),
