...
// (render/renderer.js:1168) binds an offscreen target with its OWN depth
 ...
 * drawCharacter issues drawArrays (renderer.js:1108). The MW readers hand
 ...
 * (renderer.js:1106), so the winding costs nothing else.
 */
