...
export const entityMaxEncumbrance = (entity) => {
  ...
  const mult = entityWeightMult(entity);   // IncreasedWeightAllowance's channel plus the port's (RF1)
 ...
 *  .GetWeight (inventory.js:329), so the kg->classic multiply and the
