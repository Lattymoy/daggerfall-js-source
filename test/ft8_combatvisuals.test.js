...
test('FT8/FT12: the Enhanced category emptied into the home and then left the settings rail; its test door is the Test Room\'s', () => {
  ...
  assert.deepEqual(featureCounts(FEATURES).enhanced, 17);   // FT4-FT8's seven, LR1's loot rarity, WIND3's three, WEATHER2b's field, EL1's lighting, QS's diamond, MAC-I's first-person lighting, CAMP1's camps & packs, SURV2's survival arc
});
