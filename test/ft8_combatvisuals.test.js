...
test('FT8/FT12: the Enhanced category emptied into the home and then left the settings rail; its test door is the Test Room\'s', () => {
  ...
  assert.deepEqual(featureCounts(FEATURES).enhanced, 22);   // PERF-SCALE's render scale; FT18: 27 less six - ten rows condensed into four (grass 2, wind 2, quick slots 2, blood 4), every switch still on a tile or in its drawer; DISC19-F's town watch, HB1's quickbar-or-hotbar switch, MAP-TOGGLE's enhanced map, QUICK-LOOT B4's take-from-the-plaque, GRASS-PX's grass style, BLOOD2g's gore dial, BLOOD2e's lens, FT4-FT8's seven, LR1's loot rarity, WIND3's three, WEATHER2b's field, EL1's lighting, QS's diamond, MAC-I's first-person lighting, CAMP1's camps & packs, SURV2's survival arc, GRAIN2's ground sharpness (which is BOTH kinds - the tile array is the classic lane's terrain too), BLOOD1a's blood marks, BLOOD1b's overkill
});
