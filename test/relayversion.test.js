...
const LAW = {
  ...
  world91: '0a4606f6b2d934132adaf12ec9bb3eb28190c5b080c2946445c395a2c315bd10',   // QUEST1 + TRADE1 + PEER-FS1 (2026-09-22, three drops from Mac's contributors in one deploy): the {t:'quest'} hub frame (a party member's quest shared, validQuestFrame, its own cooldown and QUEST_FRAME_MAX), the {t:'trade'} directed frame (a courier between two peers - validTradeData, tradeGate, the room's trade byte budget), and the pose's footstep byte for the peers' footsteps. An older relay closes on the unknown frames, so the clients offer Trade only to world91 or later (TRADE_RELAY_MIN).
};
