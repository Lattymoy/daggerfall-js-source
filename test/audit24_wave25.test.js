...
test('audit24 wave25: the factionListener comments name PlayerActivate, and claim nothing pending', () => {
  ...
  assert.match(m, /src\/scenes\/worldModes\.js:475/);   // FIX-F/E moved worldModes by eight lines; AUDIT 65 by one more; PERF5 by one more (the identity constant under the imports)
