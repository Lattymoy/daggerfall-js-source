...
test('audit24 wave28: the to-hit armour term has NO scalar fallback', () => {
  ...
  assert.match(f, /chance \+= \(target\.armorValues\?\.\[struckBodyPart\] \?\? 0\) \+ enchantArmorMod\(target\) - affixArmor\(target\);/);   // E1 widened the term with the enchantment channel; the NO-SCALAR law stands
