...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:6289/:6291,
// exterior.js:2757/:2765, ui/input.js:432/:438) and then routes that
// same key's release into the window it just mounted (world.js:6320 ->
...
/** world.js:6274's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:6320 delivers THAT SAME KEY'S release into the slot.
