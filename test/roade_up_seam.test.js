...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:4193/:4196,
// exterior.js:2140/:2148, ui/input.js:297/:303) and then routes that
// same key's release into the window it just mounted (world.js:4217 ->
...
/** world.js:4180's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:4217 delivers THAT SAME KEY'S release into the slot.
