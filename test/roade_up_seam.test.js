...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:6374/:6376,
// exterior.js:2814/:2822, ui/input.js:432/:438) and then routes that
// same key's release into the window it just mounted (world.js:6405 ->
...
/** world.js:6359's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:6405 delivers THAT SAME KEY'S release into the slot.
