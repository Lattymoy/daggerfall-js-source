...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:4472/:4475,
// exterior.js:2218/:2226, ui/input.js:334/:340) and then routes that
// same key's release into the window it just mounted (world.js:4496 ->
...
/** world.js:4459's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:4496 delivers THAT SAME KEY'S release into the slot.
