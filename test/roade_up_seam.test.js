...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:5391/:5393,
// exterior.js:2639/:2647, ui/input.js:412/:418) and then routes that
// same key's release into the window it just mounted (world.js:5422 ->
...
/** world.js:5376's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:5422 delivers THAT SAME KEY'S release into the slot.
