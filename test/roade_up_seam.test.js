...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:6614/:6616,
// exterior.js:2874/:2882, ui/input.js:515/:521) and then routes that
// same key's release into the window it just mounted (world.js:6645 ->
...
/** world.js:6586's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:6632 delivers THAT SAME KEY'S release into the slot.
