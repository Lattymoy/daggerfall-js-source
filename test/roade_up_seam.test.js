...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:6442/:6444,
// exterior.js:2859/:2867, ui/input.js:513/:519) and then routes that
// same key's release into the window it just mounted (world.js:6473 ->
...
/** world.js:6427's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:6473 delivers THAT SAME KEY'S release into the slot.
