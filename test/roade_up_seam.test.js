...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:4107/:4110,
// exterior.js:2027/:2035, ui/input.js:297/:303) and then routes that
// same key's release into the window it just mounted (world.js:4131 ->
...
/** world.js:4094's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:4131 delivers THAT SAME KEY'S release into the slot.
