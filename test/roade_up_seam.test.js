...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:7432/:7434,
// exterior.js:3064/:3072, ui/input.js:579/:585) and then routes that
// same key's release into the window it just mounted (world.js:7468 ->
...
/** world.js:7404's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:7455 delivers THAT SAME KEY'S release into the slot.
