...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:4119/:4122,
// exterior.js:2039/:2047, ui/input.js:297/:303) and then routes that
// same key's release into the window it just mounted (world.js:4143 ->
...
/** world.js:4106's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:4143 delivers THAT SAME KEY'S release into the slot.
