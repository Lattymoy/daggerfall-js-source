...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:4975/:4977,
// exterior.js:2426/:2434, ui/input.js:337/:343) and then routes that
// same key's release into the window it just mounted (world.js:4999 ->
...
/** world.js:4962's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:4999 delivers THAT SAME KEY'S release into the slot.
