...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:4675/:4678,
// exterior.js:2345/:2353, ui/input.js:300/:306) and then routes that
// same key's release into the window it just mounted (world.js:4699 ->
...
/** world.js:4662's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:4699 delivers THAT SAME KEY'S release into the slot.
