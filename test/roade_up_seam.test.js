...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:6550/:6552,
// exterior.js:2873/:2881, ui/input.js:515/:521) and then routes that
// same key's release into the window it just mounted (world.js:6581 ->
...
/** world.js:6522's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:6568 delivers THAT SAME KEY'S release into the slot.
