...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:7570/:7572,
// exterior.js:3111/:3119, ui/input.js:598/:604) and then routes that
// same key's release into the window it just mounted (world.js:7606 ->
...
/** world.js:7542's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:7593 delivers THAT SAME KEY'S release into the slot.
