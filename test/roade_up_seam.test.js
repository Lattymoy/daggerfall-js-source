...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:6497/:6513,
// exterior.js:2736/:2744, ui/input.js:412/:418) and then routes that
// same key's release into the window it just mounted (world.js:6219 ->
...
/** world.js:6173's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:6219 delivers THAT SAME KEY'S release into the slot.
