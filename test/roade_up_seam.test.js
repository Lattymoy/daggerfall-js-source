...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:7481/:7483,
// exterior.js:3088/:3096, ui/input.js:579/:585) and then routes that
// same key's release into the window it just mounted (world.js:7517 ->
...
/** world.js:7453's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:7504 delivers THAT SAME KEY'S release into the slot.
