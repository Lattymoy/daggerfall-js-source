...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:6745/:6747,
// exterior.js:2957/:2965, ui/input.js:519/:525) and then routes that
// same key's release into the window it just mounted (world.js:6776 ->
...
/** world.js:6717's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:6763 delivers THAT SAME KEY'S release into the slot.
