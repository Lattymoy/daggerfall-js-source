...
// exterior.js:1465/:1453, ui/input.js:297/:303) and then routes that
...
/** world.js:4092's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:4129 delivers THAT SAME KEY'S release into the slot.
