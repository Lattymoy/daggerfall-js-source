...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:7502/:7504,
// exterior.js:3088/:3096, ui/input.js:579/:585) and then routes that
// same key's release into the window it just mounted (world.js:7538 ->
...
/** world.js:7474's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:7525 delivers THAT SAME KEY'S release into the slot.
