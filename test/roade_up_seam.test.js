...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:4907/:4909,
// exterior.js:2390/:2398, ui/input.js:337/:343) and then routes that
// same key's release into the window it just mounted (world.js:4931 ->
...
/** world.js:4894's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:4931 delivers THAT SAME KEY'S release into the slot.
