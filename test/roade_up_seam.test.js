...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:7704/:7706,
// exterior.js:3112/:3120, ui/input.js:598/:604) and then routes that
// same key's release into the window it just mounted (world.js:7741 ->
...
/** world.js:7675's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:7728 delivers THAT SAME KEY'S release into the slot.
