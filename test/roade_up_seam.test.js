...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:5076/:5078,
// exterior.js:2477/:2485, ui/input.js:337/:343) and then routes that
// same key's release into the window it just mounted (world.js:5106 ->
...
/** world.js:5063's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:5106 delivers THAT SAME KEY'S release into the slot.
