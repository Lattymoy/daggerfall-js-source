...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:7547/:7549,
// exterior.js:3090/:3098, ui/input.js:579/:585) and then routes that
// same key's release into the window it just mounted (world.js:7583 ->
...
/** world.js:7519's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:7570 delivers THAT SAME KEY'S release into the slot.
