...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:6906/:6908,
// exterior.js:2924/:2932, ui/input.js:519/:525) and then routes that
// same key's release into the window it just mounted (world.js:6937 ->
...
/** world.js:6878's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:6924 delivers THAT SAME KEY'S release into the slot.
