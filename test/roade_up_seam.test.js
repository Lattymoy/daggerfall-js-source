...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:7402/:7404,
// exterior.js:3056/:3064, ui/input.js:519/:525) and then routes that
// same key's release into the window it just mounted (world.js:7438 ->
...
/** world.js:7374's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:7425 delivers THAT SAME KEY'S release into the slot.
