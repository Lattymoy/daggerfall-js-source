...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:8257/:8259,
// exterior.js:3117/:3125, ui/input.js:598/:604) and then routes that
// same key's release into the window it just mounted (world.js:8294 ->
...
/** world.js:8228's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:8281 delivers THAT SAME KEY'S release into the slot.
