...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:7286/:7288,
// exterior.js:3017/:3025, ui/input.js:519/:525) and then routes that
// same key's release into the window it just mounted (world.js:7322 ->
...
/** world.js:7258's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:7309 delivers THAT SAME KEY'S release into the slot.
