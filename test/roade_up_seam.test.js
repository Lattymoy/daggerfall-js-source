...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:6233/:6235,
// exterior.js:2751/:2759, ui/input.js:432/:438) and then routes that
// same key's release into the window it just mounted (world.js:6264 ->
...
/** world.js:6218's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:6264 delivers THAT SAME KEY'S release into the slot.
