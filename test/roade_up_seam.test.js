...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:5363/:5365,
// exterior.js:2636/:2644, ui/input.js:404/:410) and then routes that
// same key's release into the window it just mounted (world.js:5394 ->
...
/** world.js:5348's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:5394 delivers THAT SAME KEY'S release into the slot.
