...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:6451/:6453,
// exterior.js:2871/:2879, ui/input.js:515/:521) and then routes that
// same key's release into the window it just mounted (world.js:6482 ->
...
/** world.js:6436's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:6482 delivers THAT SAME KEY'S release into the slot.
