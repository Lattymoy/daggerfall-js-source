...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:6619/:6621,
// exterior.js:2877/:2885, ui/input.js:519/:525) and then routes that
// same key's release into the window it just mounted (world.js:6650 ->
...
/** world.js:6591's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:6637 delivers THAT SAME KEY'S release into the slot.
