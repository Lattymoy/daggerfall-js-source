...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:6303/:6305,
// exterior.js:2764/:2772, ui/input.js:432/:438) and then routes that
// same key's release into the window it just mounted (world.js:6334 ->
...
/** world.js:6288's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:6334 delivers THAT SAME KEY'S release into the slot.
