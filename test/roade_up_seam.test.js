...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:6772/:6774,
// exterior.js:2967/:2975, ui/input.js:519/:525) and then routes that
// same key's release into the window it just mounted (world.js:6803 ->
...
/** world.js:6744's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:6790 delivers THAT SAME KEY'S release into the slot.
