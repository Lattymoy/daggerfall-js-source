...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:6109/:6111,
// exterior.js:2720/:2728, ui/input.js:412/:418) and then routes that
// same key's release into the window it just mounted (world.js:6140 ->
...
/** world.js:6094's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:6140 delivers THAT SAME KEY'S release into the slot.
