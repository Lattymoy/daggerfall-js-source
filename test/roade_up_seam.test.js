...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:4196/:4199,
// exterior.js:2067/:2075, ui/input.js:297/:303) and then routes that
// same key's release into the window it just mounted (world.js:4220 ->
...
/** world.js:4183's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:4220 delivers THAT SAME KEY'S release into the slot.
