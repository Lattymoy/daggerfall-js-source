...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:5250/:5252,
// exterior.js:2589/:2597, ui/input.js:404/:410) and then routes that
// same key's release into the window it just mounted (world.js:5281 ->
...
/** world.js:5237's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:5281 delivers THAT SAME KEY'S release into the slot.
