...
//
// THIS PORT OPENS ON THE PRESS in all four hosts (world.js:6325/:6327,
// exterior.js:2793/:2801, ui/input.js:432/:438) and then routes that
// same key's release into the window it just mounted (world.js:6356 ->
...
/** world.js:6310's keydown arm, verbatim in shape: the host consumes
...
test('E-FIX LIVE (townTalk): the R that OPENS the rest window does not close it on its own release', () => {
  ...
  try {
    ...
    // world.js:6356 delivers THAT SAME KEY'S release into the slot.
