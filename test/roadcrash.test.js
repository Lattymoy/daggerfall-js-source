...
// shape, with the host's onClose wired as world.js:7156 wires it).
...
function rig() {
  ...
  const said = [], scales = [];
  let to = null;
  // world.js:7156 - CAMP / close is InterruptTravel; the port's panel is
  ...
  to = createTravelOptions({
    ...
    // world.js:7235's own answer for both.
