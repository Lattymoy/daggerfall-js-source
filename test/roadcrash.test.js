...
// shape, with the host's onClose wired as world.js:7049 wires it).
...
function rig() {
  ...
  const said = [], scales = [];
  let to = null;
  // world.js:7049 - CAMP / close is InterruptTravel; the port's panel is
  ...
  to = createTravelOptions({
    ...
    // world.js:7128's own answer for both.
