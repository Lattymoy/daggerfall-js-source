...
// shape, with the host's onClose wired as world.js:6272 wires it).
...
function rig() {
  ...
  const said = [], scales = [];
  let to = null;
  // world.js:6272 - CAMP / close is InterruptTravel; the port's panel is
  ...
  to = createTravelOptions({
    ...
    // world.js:6351's own answer for both.
