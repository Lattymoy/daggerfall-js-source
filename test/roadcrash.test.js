...
// shape, with the host's onClose wired as world.js:7092 wires it).
...
function rig() {
  ...
  const said = [], scales = [];
  let to = null;
  // world.js:7092 - CAMP / close is InterruptTravel; the port's panel is
  ...
  to = createTravelOptions({
    ...
    // world.js:7171's own answer for both.
