...
// shape, with the host's onClose wired as world.js:7053 wires it).
...
function rig() {
  ...
  const said = [], scales = [];
  let to = null;
  // world.js:7053 - CAMP / close is InterruptTravel; the port's panel is
  ...
  to = createTravelOptions({
    ...
    // world.js:7132's own answer for both.
