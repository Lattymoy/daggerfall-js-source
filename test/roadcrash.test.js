...
// shape, with the host's onClose wired as world.js:6981 wires it).
...
function rig() {
  ...
  const said = [], scales = [];
  let to = null;
  // world.js:6981 - CAMP / close is InterruptTravel; the port's panel is
  ...
  to = createTravelOptions({
    ...
    // world.js:7060's own answer for both.
