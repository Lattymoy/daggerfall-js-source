...
// enchantCtx at the strike site (formulas.js:506 defaults it null) -
...
test('AUDIT 58: the WABBAJACK re-stands a foe in the pool that owns it', () => {
  ...
  // (exteriorFoes.js:443-448) and both pools share the host's one
...
test('AUDIT 58 (f2/hosts): the EXTERIOR host mounts the same body over its own pools', () => {
  ...
  // (world.js:5046's shape) - the removal, never the re-stand
