...
// enchantCtx at the strike site (formulas.js:504 defaults it null) -
...
test('AUDIT 58: the WABBAJACK re-stands a foe in the pool that owns it', () => {
  ...
  // (exteriorFoes.js:289-294) and both pools share the host's one
...
test('AUDIT 58 (f2/hosts): the EXTERIOR host mounts the same body over its own pools', () => {
  ...
  // engine (effects.js:881/:895 heals the caster through them).
  ...
  // (world.js:2699's shape) - the removal, never the re-stand
