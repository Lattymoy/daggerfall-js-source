...
test('AUDIT 58: the WABBAJACK re-stands a foe in the pool that owns it', () => {
  ...
  // (exteriorFoes.js:412-417) and both pools share the host's one
...
test('AUDIT 58 (f2/hosts): the EXTERIOR host mounts the same body over its own pools', () => {
  ...
  // engine (effects.js:890/:904 heals the caster through them).
  ...
  // (world.js:4409's shape) - the removal, never the re-stand
