...
test('AUDIT 58: the WABBAJACK re-stands a foe in the pool that owns it', () => {
  ...
  // (exteriorFoes.js:414-419) and both pools share the host's one
...
test('AUDIT 58 (f2/hosts): the EXTERIOR host mounts the same body over its own pools', () => {
  ...
  // engine (effects.js:887/:901 heals the caster through them).
  ...
  // (world.js:4362's shape) - the removal, never the re-stand
