...
/** The producer, not a literal: ui/inventoryDoor.js:61 is the ONE seam
...
test('AUDIT 65 UI-5: every host wheel seam hands the window the live point', () => {
  ...
  // townTalk.js is the seam for BOTH outdoor hosts (world.js:7859 and
  // exterior.js:3207 hand it the raw event).
