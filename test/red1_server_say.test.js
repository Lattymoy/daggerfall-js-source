...
test('RED1: the wire version moved, because this is a relay change', () => {
  ...
  assert.equal(RELAY_VERSION, 'world98');   // world98: HCC-PARK + RIDE; world91: QUEST1 + TRADE1 + PEER-FS1; world92: AUDIT DROPS B3/C1/C3; world96: the party-rest drop's pose fields
