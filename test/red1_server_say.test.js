...
test('RED1: the wire version moved, because this is a relay change', () => {
  ...
  assert.equal(RELAY_VERSION, 'world111');   // RENOWN1's level and renown frame moved it on (world111 - world108 on its branch; main's HT-WAIST-NET, PROFILE2 and SKIN2, and EVENT1 took world108 to world110 first); world107: DUEL1's duel frame and the card's account stamp; world106: DISC23-B's look; world105: AUDIT 68's relay law; world104: TITLE-N's narrate/dm frame and badge vocabulary; world103: the contributor's dd/rz over the arc's deploy; world102: CHAT-CHAN + DICE1 + EMOTE1 + INSPECT1 + JOURNAL1 + AUDIT ATTACH; world101: DISC12 lh/wb; world100: DISC7 hs; world99: HCC-PARK + RIDE; world98: SPELLFX1; world91: QUEST1 + TRADE1 + PEER-FS1; world92: AUDIT DROPS B3/C1/C3; world96: the party-rest drop's pose fields
