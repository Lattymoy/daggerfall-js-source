...
test('AUDIT PARTY-REST wire (world95, then world96 under ALLY-CAST, world97 under its audit): `readyAt` rides the party pose under voteAt\'s own bounds - rounded, floored at zero, absent as null; the version moved with it', () => {
  ...
  assert.equal(RELAY_VERSION, 'world115', 'GUILD1c (the guild on the token, the guild frames and line, world115 - world113 on its branch) last; the Enhanced Plus patch (PEERLIGHT1/2 and PEERFX1\'s pose fields, world114) before it; AUDIT WB and WB3 (the gate frame, the boss room and the relay\'s half of their audit, world113 - world110 and world111 on their branch) before it; PARTY-TRAVEL (the party pose\'s journey fields, world112 - world110 on its branch) before it; RENOWN1 (the level beside the name and its renown frame, world111 - world108 on its branch) before it; EVENT1 (world110), PROFILE2 and SKIN2 (world109) and HT-WAIST-NET (world108) before it; DUEL1 (the duel frame, the card\'s account stamp, world107) last; DISC23-B (the look\'s eo, world106) and AUDIT 68 (the relay\'s own law, world105) before it; TITLE-N (the dm frame, the badge vocabulary) before it; ALLY-CAST moved it again, AUDIT ALLY-CAST once more, SPELLFX1\'s pose fields a third time, HCC-PARK + RIDE (the park frame, the pose\'s riding fields) a fourth, DISC7\'s hs and DISC12\'s lh/wb after, and the community arc\'s frames and AUDIT ATTACH\'s meters after them (world102)');
