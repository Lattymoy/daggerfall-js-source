...
test('FIX-E: the interior slot releases what it overwrites, and the fixed city offers no F11 it cannot honour', () => {
  ...
  assert.match(ds, /hint = isOnlinePage\(\) \? ONLINE_DEATH_HINT : 'ENTER end   F11 load'/, 'the default hint is the full one offline (DISC17-C: an online page\'s says its respawn)');
