...
test('PARTY-TRAVEL wire: the relay\'s door projects the fields through (validPartyPose in parseClient - an OLDER relay strips them, so this deploy is the relay\'s), the version moved, and a hub from before it opens no round', () => {
  ...
  assert.equal(RELAY_VERSION, 'world115', 'GUILD1c (world115 - world113 on its branch) and the Enhanced Plus patch (world114) moved it on after WB3 and AUDIT WB (the gate\'s boss room, world113); PARTY-TRAVEL: the party pose\'s journey fields (world112 - world110 on its branch; EVENT1 and RENOWN1 took 110-111)');
