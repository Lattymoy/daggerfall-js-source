...
test('PARTY-TRAVEL wire: the relay\'s door projects the fields through (validPartyPose in parseClient - an OLDER relay strips them, so this deploy is the relay\'s), the version moved, and a hub from before it opens no round', () => {
  ...
  assert.equal(RELAY_VERSION, 'world114', 'SHADOW-FANG (the badge vocabulary, world114) last; WB3 and AUDIT WB (the gate\'s boss room, world113) moved it on; PARTY-TRAVEL: the party pose\'s journey fields (world112 - world110 on its branch; EVENT1 and RENOWN1 took 110-111)');
