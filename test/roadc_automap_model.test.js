...
test('c2/S1 the hash grid answers the same set as a linear scan, over 500 random points', () => {
  // AUDIT 58: the skin's magnitude, so a change to it is a deliberate,
  ...
  // reveals at all - is pinned in test/audit58_pins.test.js.
  ...
  for (let i = 0; i < 500; i++) {
    ...
    // AUDIT 58: an EXPLICIT literal tolerance on both sides. This read
