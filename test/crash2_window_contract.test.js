...
//       was skipped), and omitted `tick`, which interior.js:361 calls
...
//       townTalk.js:1116 paints every COVERED window too
...
test('CRASH2: the required arms are DERIVED from the hosts, not typed here', () => {
  ...
  assert.ok(required.has('tick'),
    'interior.js:361 calls `overlay.tick(dt)` unguarded every frame; CRASH1 omitted `tick` from the contract entirely.');
