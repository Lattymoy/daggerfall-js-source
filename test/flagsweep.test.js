...
// world.js:2135 sent them to one in dungeonContext.js that had never
...
test('FS1: the melee/arrow clauses are retired, and the tree contradicts them', () => {
  ...
  // shipped comment still claiming world.js:10974's order, green.
...
test('FS1: the enchant ctx is MOUNTED by every host that owes it', () => {
  ...
  // shipped. dungeonContext.js:1912 and hostEnchant.js:8 both say
