...
test('AUDIT 63 F27: both foe records carry the flag, and the dungeon applies it BEFORE the corpse', () => {
  ...
  const aw = DC.slice(DC.indexOf('function patchFoe(f, sf, wire = false)'), DC.indexOf('\n  }\n', DC.indexOf('droppedLoot.restorePiles')));   // WORLD3: the per-foe body is patchFoe, above applyWorld
