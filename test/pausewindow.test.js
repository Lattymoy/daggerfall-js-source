...
test('AUDIT 65 UI-2: the classic pause window relocks on RESUME, and only on resume', () => {
  ...
  try {
    ...
    // (world.js:6278-6285, worldModes.js:7410-7416,
    // dungeonContext.js:5450-5456), so `saveLoadPushes` is true and the
    ...
    // resume: a host with no saveAs/loadKey seam (exterior.js:2551's bag
