...
test('AUDIT 65 UI-2: the classic pause window relocks on RESUME, and only on resume', () => {
  // MAC1 J's mechanism is the enhanced door's (ui/pauseDoor.js:141-161):
  ...
  try {
    ...
    // NOT the exit. There is no world to relock into - pauseDoor.js:156's
    // own `action !== 'exit'`.
    relocked = 0;
    ...
    // (world.js:8445-8452, worldModes.js:9136-9142,
    ...
    // relocks on exactly it - pauseDoor.js:156 fires for 'save' and
    ...
    // resume: a host with no saveAs/loadKey seam (exterior.js:2874's bag
