...
test('AUDIT 65 UI-2: the classic pause window relocks on RESUME, and only on resume', () => {
  ...
  try {
    ...
    // (world.js:6504-6511, worldModes.js:8101-8107,
    // dungeonContext.js:5694-5700), so `saveLoadPushes` is true and the
    ...
    // resume: a host with no saveAs/loadKey seam (exterior.js:2631's bag
