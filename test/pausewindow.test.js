...
test('AUDIT 65 UI-2: the classic pause window relocks on RESUME, and only on resume', () => {
  ...
  try {
    ...
    // (world.js:6397-6404, worldModes.js:7922-7928,
    // dungeonContext.js:5625-5631), so `saveLoadPushes` is true and the
    ...
    // resume: a host with no saveAs/loadKey seam (exterior.js:2601's bag
