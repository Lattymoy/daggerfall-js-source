...
test('AUDIT 65 UI-2: the classic pause window relocks on RESUME, and only on resume', () => {
  ...
  try {
    ...
    // (world.js:7524-7531, worldModes.js:8516-8522,
    // dungeonContext.js:5853-5859), so `saveLoadPushes` is true and the
    ...
    // resume: a host with no saveAs/loadKey seam (exterior.js:2840's bag
