...
test('FT2: the registry row - both labels, over the pref, showing and writing through the module', () => {
  ...
  assert.deepEqual(featureCounts(FEATURES), { all: 16, enhanced: 7, mod: 6, classic: 5 });   // FT4 the outdoors (enhanced + mod); FT5-FT8 the port's own; FT9 the five packs; FT10 three of DFU's
});
