...
test('FT2: the registry row - both labels, over the pref, showing and writing through the module', () => {
  ...
  assert.deepEqual(featureCounts(FEATURES), { all: 29, enhanced: 12, mod: 9, classic: 10 });   // WM3 Windmills the ninth Mod Authored row (a PREF row - the pack ships no settings file to carry an Enabled key); HT1 Handheld Torches the eighth pack; WEATHER2b the weather field; WIND3 the wind's three rows; WW1 Weapon Widget the seventh pack; FT4 the outdoors (enhanced + mod); FT5-FT8 the port's own; LR1 loot rarity; FT9 the five packs; FT10/FT11 DFU's own
});
