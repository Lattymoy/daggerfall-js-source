...
test('ALLY-CAST wire (world97): validCastData projects a bounded spell record and refuses the whole frame otherwise; parseClient carries the `cast` frame after a hello and inside the cap', () => {
  assert.equal(RELAY_VERSION, 'world102');   // PCORPSE1 + RESURRECT1 + PCORPSE3's death pose, Resurrect call and fallen body (world102); DISC12's pose hand and beast bits moved it (world101); DISC7's hs (world100); SPELLFX1's pose fields moved it once more (world98), HCC-PARK + RIDE again (world99); the cast frame is world97's
