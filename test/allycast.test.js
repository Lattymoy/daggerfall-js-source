...
test('ALLY-CAST wire (world97): validCastData projects a bounded spell record and refuses the whole frame otherwise; parseClient carries the `cast` frame after a hello and inside the cap', () => {
  assert.equal(RELAY_VERSION, 'world101');   // SPELLFX1's pose fields moved it once more (world98), HCC-PARK + RIDE again (world99), DISC7's half-speed bit (world100), the chat's frames, the card and AUDIT ATTACH's meters (world101); the cast frame is world97's
