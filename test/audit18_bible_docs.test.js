...
test('AUDIT 39r: the foreign-pass count is the real call-site count', () => {
  ...
  assert.equal(hosts, 16, 'sixteen host call sites across the twelve passes (DUEL1: the duel ring\'s wall, the world host alone; WB2: the Oblivion Gate\'s fire and beacon, the world host alone; WB4a: the Burning Court boss\'s telegraph, the world host alone, drawn in the dungeon arm; WB6a: the Deadlands\' sea and sky round the court, the world host alone, drawn in the dungeon arm; GR1: the lab\'s grass; WIND3: the wisps, WEATHER2d: the sand, BOLT: the lightning\'s channels, one seam per exterior host each; DW-C: Iliac Puddle No More\'s surfaces, the world host alone - its floors and its sky fog ride the sky\'s seam; the overworld map\'s seam went with it in MAP1)');
