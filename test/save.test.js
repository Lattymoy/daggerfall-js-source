...
test('save: round-trip restores everything; extras carried; deep copies', () => {
  ...
  assert.deepEqual(extras, { position: [1, 2, 3], pose: null, classicMinutes: 77.5, readiedSpellIndex: 97, world, locationKey: 'dungeon:42', quest: null, talk: null });   // S12: the world rides the envelope; Q4-v/TK-i: the quest + talk slots (null when the host passed none)
