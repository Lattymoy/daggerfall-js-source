...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:4916,
  // dungeonContext.js:5892, worldModes.js:7121) and the bookshelf
  // picker (worldModes.js:1666-1676) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1132,
  // worldModes.js:7299, dungeonContext.js:5630). The window's header
