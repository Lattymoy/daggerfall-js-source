...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:8375,
  // dungeonContext.js:7028, worldModes.js:9297) and the bookshelf
  // picker (worldModes.js:1865-2070) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1210,
  // worldModes.js:9515, dungeonContext.js:6762). The window's header
