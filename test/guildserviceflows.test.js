...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:6160,
  // dungeonContext.js:6246, worldModes.js:7485) and the bookshelf
  // picker (worldModes.js:1715-1725) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1156,
  // worldModes.js:7666, dungeonContext.js:5980). The window's header
