...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:4776,
  // dungeonContext.js:5123, worldModes.js:6912) and the bookshelf
  // picker (worldModes.js:1588-1598) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1123,
  // worldModes.js:7090, dungeonContext.js:4867). The window's header
