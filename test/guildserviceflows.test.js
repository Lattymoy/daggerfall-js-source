...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:6484,
  // dungeonContext.js:6662, worldModes.js:8242) and the bookshelf
  // picker (worldModes.js:1964-1974) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1187,
  // worldModes.js:8433, dungeonContext.js:6396). The window's header
