...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // dungeonContext.js:6712, worldModes.js:8455) and the bookshelf
  // picker (worldModes.js:1763-1945) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1203,
  // worldModes.js:8673, dungeonContext.js:6447). The window's header
