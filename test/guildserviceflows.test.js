...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:6837,
  // dungeonContext.js:6776, worldModes.js:8551) and the bookshelf
  // picker (worldModes.js:1771-1953) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1203,
  // worldModes.js:8769, dungeonContext.js:6510). The window's header
