...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:7495,
  // dungeonContext.js:6789, worldModes.js:8627) and the bookshelf
  // picker (worldModes.js:1778-1963) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1205,
  // worldModes.js:8845, dungeonContext.js:6523). The window's header
