...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:6310,
  // dungeonContext.js:6456, worldModes.js:7541) and the bookshelf
  // picker (worldModes.js:1729-1739) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1156,
  // worldModes.js:7722, dungeonContext.js:6190). The window's header
