...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:6599,
  // dungeonContext.js:6658, worldModes.js:8390) and the bookshelf
  // picker (worldModes.js:1759-1941) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1187,
  // worldModes.js:8595, dungeonContext.js:6393). The window's header
