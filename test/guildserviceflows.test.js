...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:6284,
  // dungeonContext.js:6443, worldModes.js:7535) and the bookshelf
  // picker (worldModes.js:1728-1738) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1172,
  // worldModes.js:7716, dungeonContext.js:6177). The window's header
