...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:6687,
  // dungeonContext.js:6743, worldModes.js:8491) and the bookshelf
  // picker (worldModes.js:1764-1946) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1203,
  // worldModes.js:8709, dungeonContext.js:6477). The window's header
