...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // dungeonContext.js:6834, worldModes.js:8724) and the bookshelf
  // picker (worldModes.js:1798-1989) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1210,
  // worldModes.js:8942, dungeonContext.js:6568). The window's header
