...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:6251,
  // dungeonContext.js:6385, worldModes.js:7529) and the bookshelf
  // picker (worldModes.js:1722-1732) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1156,
  // worldModes.js:7710, dungeonContext.js:6119). The window's header
