...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:7861,
  // dungeonContext.js:6838, worldModes.js:8685) and the bookshelf
  // picker (worldModes.js:1798-1983) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1210,
  // worldModes.js:8903, dungeonContext.js:6572). The window's header
