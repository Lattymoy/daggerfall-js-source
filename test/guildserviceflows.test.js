...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:4897,
  // dungeonContext.js:5822, worldModes.js:7099) and the bookshelf
  // picker (worldModes.js:1656-1666) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1132,
  // worldModes.js:7277, dungeonContext.js:5560). The window's header
