...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:4895,
  // dungeonContext.js:5791, worldModes.js:7097) and the bookshelf
  // picker (worldModes.js:1654-1664) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1132,
  // worldModes.js:7275, dungeonContext.js:5529). The window's header
