...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:6200,
  // dungeonContext.js:6289, worldModes.js:7520) and the bookshelf
  // picker (worldModes.js:1720-1730) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1156,
  // worldModes.js:7701, dungeonContext.js:6023). The window's header
