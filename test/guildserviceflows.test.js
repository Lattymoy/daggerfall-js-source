...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:6143,
  // dungeonContext.js:6212, worldModes.js:7474) and the bookshelf
  // picker (worldModes.js:1714-1724) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1156,
  // worldModes.js:7655, dungeonContext.js:5946). The window's header
