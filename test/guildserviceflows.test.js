...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:5406,
  // dungeonContext.js:6134, worldModes.js:7295) and the bookshelf
  // picker (worldModes.js:1674-1684) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1154,
  // worldModes.js:7476, dungeonContext.js:5870). The window's header
