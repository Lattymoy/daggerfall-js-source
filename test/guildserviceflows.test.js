...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:7521,
  // dungeonContext.js:6790, worldModes.js:8639) and the bookshelf
  // picker (worldModes.js:1779-1964) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1205,
  // worldModes.js:8857, dungeonContext.js:6524). The window's header
