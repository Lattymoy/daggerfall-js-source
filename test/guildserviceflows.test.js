...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:6600,
  // dungeonContext.js:6667, worldModes.js:8395) and the bookshelf
  // picker (worldModes.js:1761-1943) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1187,
  // worldModes.js:8604, dungeonContext.js:6396). The window's header
