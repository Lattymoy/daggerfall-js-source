...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:6664,
  // dungeonContext.js:6690, worldModes.js:8428) and the bookshelf
  // picker (worldModes.js:1763-1945) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1187,
  // worldModes.js:8646, dungeonContext.js:6425). The window's header
