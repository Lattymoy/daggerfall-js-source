...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:5104,
  // dungeonContext.js:6032, worldModes.js:7250) and the bookshelf
  // picker (worldModes.js:1668-1678) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1154,
  // worldModes.js:7428, dungeonContext.js:5770). The window's header
