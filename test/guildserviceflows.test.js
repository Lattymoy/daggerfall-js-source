...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:6153,
  // dungeonContext.js:6233, worldModes.js:7469) and the bookshelf
  // picker (worldModes.js:1710-1720) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1156,
  // worldModes.js:7650, dungeonContext.js:5967). The window's header
