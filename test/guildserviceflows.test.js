...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:5049,
  // dungeonContext.js:5989, worldModes.js:7210) and the bookshelf
  // picker (worldModes.js:1667-1677) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1144,
  // worldModes.js:7388, dungeonContext.js:5727). The window's header
