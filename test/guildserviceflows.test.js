...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:6128,
  // dungeonContext.js:6199, worldModes.js:7458) and the bookshelf
  // picker (worldModes.js:1709-1719) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1156,
  // worldModes.js:7639, dungeonContext.js:5933). The window's header
