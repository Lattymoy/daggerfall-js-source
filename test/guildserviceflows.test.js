...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:5065,
  // dungeonContext.js:5990, worldModes.js:7225) and the bookshelf
  // picker (worldModes.js:1670-1680) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1144,
  // worldModes.js:7403, dungeonContext.js:5728). The window's header
