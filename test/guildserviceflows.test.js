...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:5828,
  // dungeonContext.js:6134, worldModes.js:7320) and the bookshelf
  // picker (worldModes.js:1674-1684) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1156,
  // worldModes.js:7501, dungeonContext.js:5870). The window's header
