...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:7630,
  // dungeonContext.js:6927, worldModes.js:8778) and the bookshelf
  // picker (worldModes.js:1800-1991) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1210,
  // worldModes.js:8996, dungeonContext.js:6802). The window's header
