...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:5068,
  // dungeonContext.js:6003, worldModes.js:7239) and the bookshelf
  // picker (worldModes.js:1670-1680) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1154,
  // worldModes.js:7417, dungeonContext.js:5741). The window's header
