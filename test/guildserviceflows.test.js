...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:8319,
  // dungeonContext.js:6925, worldModes.js:9142) and the bookshelf
  // picker (worldModes.js:1860-2065) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1210,
  // worldModes.js:9360, dungeonContext.js:6659). The window's header
