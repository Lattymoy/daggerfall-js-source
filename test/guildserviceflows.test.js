...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:5029,
  // dungeonContext.js:5988, worldModes.js:7191) and the bookshelf
  // picker (worldModes.js:1666-1676) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1144,
  // worldModes.js:7369, dungeonContext.js:5726). The window's header
