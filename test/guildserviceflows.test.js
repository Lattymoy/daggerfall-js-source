...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // dungeonContext.js:6478, worldModes.js:7691) and the bookshelf
  // picker (worldModes.js:1728-1882) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1156,
  // worldModes.js:7872, dungeonContext.js:6212). The window's header
