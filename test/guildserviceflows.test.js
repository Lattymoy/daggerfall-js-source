...
test('AUDIT 65 UI-1: a BARE picker takes the HOST\'s four-argument click, and the 4th slot is not its clock', () => {
  ...
  // - the U key's useMagicItemWindow (world.js:5443,
  // dungeonContext.js:6066, worldModes.js:7280) and the bookshelf
  // picker (worldModes.js:1671-1681) - are dispatched by the hosts'
  // ONE shape: `click(vx, vy, right, middle)` (townTalk.js:1154,
  // worldModes.js:7458, dungeonContext.js:5804). The window's header
