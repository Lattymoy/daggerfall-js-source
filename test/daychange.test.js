...
test('S41 re-entrancy: the exhaustion collapse re-enters the tick, and one midnight must still fire ONCE', () => {
  ...
  // fired from inside sinks.drainFatigue (shared.js:755 ->
  // exterior.js:887, world.js:735), which re-enters tickPlayerMinutes
  ...
  try {
    ...
    ticker = {
      tick(dt) {
        ...
        setWorldMinutes(r.classicMinutes);          // shared.js:789 - the write-back
        return r;
      },
