...
test('S41 re-entrancy: the exhaustion collapse re-enters the tick, and one midnight must still fire ONCE', () => {
  ...
  // fired from inside sinks.drainFatigue (shared.js:793 ->
  // exterior.js:1042, world.js:1423), which re-enters tickPlayerMinutes
  ...
  try {
    ...
    ticker = {
      tick(dt) {
        ...
        setWorldMinutes(r.classicMinutes);          // shared.js:828 - the write-back
        return r;
      },
