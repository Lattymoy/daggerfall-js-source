...
test('S41 re-entrancy: the exhaustion collapse re-enters the tick, and one midnight must still fire ONCE', () => {
  ...
  // fired from inside sinks.drainFatigue (shared.js:698 ->
  // exterior.js:766, world.js:685), which re-enters tickPlayerMinutes
  ...
  try {
    ...
    ticker = {
      tick(dt) {
        ...
        setWorldMinutes(r.classicMinutes);          // shared.js:732 - the write-back
        return r;
      },
