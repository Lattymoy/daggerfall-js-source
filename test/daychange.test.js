...
test('S41 re-entrancy: the exhaustion collapse re-enters the tick, and one midnight must still fire ONCE', () => {
  ...
  // fired from inside sinks.drainFatigue (shared.js:791 ->
  // exterior.js:971, world.js:1070), which re-enters tickPlayerMinutes
  ...
  try {
    ...
    ticker = {
      tick(dt) {
        ...
        setWorldMinutes(r.classicMinutes);          // shared.js:825 - the write-back
        return r;
      },
