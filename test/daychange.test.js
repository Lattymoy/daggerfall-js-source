...
test('S41 re-entrancy: the exhaustion collapse re-enters the tick, and one midnight must still fire ONCE', () => {
  ...
  // fired from inside sinks.drainFatigue (shared.js:778 ->
  // exterior.js:940, world.js:868), which re-enters tickPlayerMinutes
  ...
  try {
    ...
    ticker = {
      tick(dt) {
        ...
        setWorldMinutes(r.classicMinutes);          // shared.js:812 - the write-back
        return r;
      },
