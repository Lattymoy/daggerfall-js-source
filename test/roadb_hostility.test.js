...
test('ROAD-B: both exterior/interior foe pools take the area walk on a struck passive foe', () => {
  ...
  const j = f.indexOf('if (_striker) f.ai.makeEnemyHostileToAttacker?.(_striker, playerFeet ?? null);');   // WORLD6b-ii: a peer\'s blow names the peer; AUDIT WORLD6b-ii A3: never me
