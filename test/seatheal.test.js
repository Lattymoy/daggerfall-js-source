...
function joiner() {
  ...
  const ctx = new Function('__s', `with (__s) { ${ctxBody} }`)(scoped({ foes, validFoeRecord, retypeFoe: (...a) => hooks.retype(...a), console, addCorpseFood: () => 0, liveStat: () => 50, playerEntity: null, renownFoeStruck, renownFoeDied }));
