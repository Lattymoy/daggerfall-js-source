...
//     (Port-Ledger.md:827)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4187\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1477/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3792/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3792/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1473`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6945` for a line
  // that is 5921, `world.js:13173` for 8836, `interior.js:323` for 329,
  ...
  // (`world.js:5859` for a line that is 8950; `:915` for 1215; `:1807` for
...
// multi-number citation: `cityGuards.js:925-832`, `world.js:8549-8523`,
// `worldModes.js:1302 against :1083`. Forty of them came out as ranges
