...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4186\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1476/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3791/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3791/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1472`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6944` for a line
  // that is 5921, `world.js:13158` for 8836, `interior.js:323` for 329,
  ...
  // (`world.js:5858` for a line that is 8950; `:914` for 1215; `:1806` for
...
// multi-number citation: `cityGuards.js:925-832`, `world.js:8548-8522`,
