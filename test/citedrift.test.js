...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3091\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2803/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2803/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:5794` for a line
  // that is 5921, `world.js:9377` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4582` for a line that is 8950; `:748` for 1215; `:1258` for
...
// multi-number citation: `cityGuards.js:802-715`, `world.js:6986-6960`,
