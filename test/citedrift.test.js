...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3500\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3125/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3125/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1112`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6718` for a line
  // that is 5921, `world.js:11190` for 8836, `interior.js:315` for 329,
  ...
  // (`world.js:5085` for a line that is 8950; `:824` for 1215; `:1370` for
  ...
  // range that cannot exist (`exterior.js:1630-1314`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:7644-7618`,
