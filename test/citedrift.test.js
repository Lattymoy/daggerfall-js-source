...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3219\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2895/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2895/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // that is 5921, `world.js:9549` for 8836, `interior.js:303` for 329,
  ...
  // (`world.js:4699` for a line that is 8950; `:797` for 1215; `:1328` for
  ...
  // range that cannot exist (`exterior.js:1394-1291`).
...
// multi-number citation: `cityGuards.js:806-716`, `world.js:7133-7107`,
