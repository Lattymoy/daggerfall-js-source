...
//     (Port-Ledger.md:806)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4181\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1464/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3785/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3785/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1460`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6858` for a line
  // that is 5921, `world.js:12611` for 8836, `interior.js:319` for 329,
  ...
  // (`world.js:5841` for a line that is 8950; `:905` for 1215; `:1797` for
  ...
  // range that cannot exist (`exterior.js:1730-1394`).
...
// multi-number citation: `cityGuards.js:924-831`, `world.js:8478-8452`,
// `worldModes.js:1290 against :1086`. Forty of them came out as ranges
