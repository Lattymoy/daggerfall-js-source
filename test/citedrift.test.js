...
//     (Port-Ledger.md:760)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2626\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:874/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2404/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2404/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:869`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:8474` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4018` for a line that is 8950; `:658` for 1215; `:1107` for
  ...
  // range that cannot exist (`exterior.js:1270-1228`).
...
// multi-number citation: `cityGuards.js:768-693`, `world.js:6239-6213`,
