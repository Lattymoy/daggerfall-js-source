...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2568\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:849/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2346/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2346/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:844`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // range that cannot exist (`exterior.js:1265-1223`).
...
// multi-number citation: `cityGuards.js:768-693`, `world.js:5767-5741`,
// `worldModes.js:1163 against :1056`. Forty of them came out as ranges
