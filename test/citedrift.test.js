...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4124\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3729/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3729/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // that is 5921, `world.js:12055` for 8836, `interior.js:319` for 329,
  ...
  // (`world.js:5728` for a line that is 8950; `:890` for 1215; `:1775` for
  ...
  // range that cannot exist (`exterior.js:1715-1381`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:8329-8303`,
