...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3250\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1050/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2876/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2876/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1046`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:5835` for a line
  // that is 5921, `world.js:9515` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4713` for a line that is 8950; `:793` for 1215; `:1303` for
...
// multi-number citation: `cityGuards.js:803-716`, `world.js:7117-7091`,
