...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3107\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1005/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2819/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2819/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1001`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:5792` for a line
  // that is 5921, `world.js:9401` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4606` for a line that is 8950; `:748` for 1215; `:1258` for
  ...
  // range that cannot exist (`exterior.js:1337-1284`).
...
// multi-number citation: `cityGuards.js:802-715`, `world.js:7010-6984`,
// `worldModes.js:1217 against :1056`. Forty of them came out as ranges
