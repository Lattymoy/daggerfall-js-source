...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2579\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:856/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2357/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2357/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:851`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // range that cannot exist (`exterior.js:1268-1226`).
...
// multi-number citation: `cityGuards.js:768-693`, `world.js:5797-5771`,
