...
//     (Port-Ledger.md:815)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4199\)/,
  ...
  // that is 5921, `world.js:13075` for 8836, `interior.js:319` for 329,
  ...
  // (`world.js:5876` for a line that is 8950; `:917` for 1215; `:1810` for
...
// multi-number citation: `cityGuards.js:929-836`, `world.js:8515-8489`,
