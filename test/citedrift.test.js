...
//     (Port-Ledger.md:793)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3418\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3043/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3043/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6693` for a line
  // that is 5921, `world.js:10950` for 8836, `interior.js:315` for 329,
  ...
  // (`world.js:4991` for a line that is 8950; `:815` for 1215; `:1361` for
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:7546-7520`,
