...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3344\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1098/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3020/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3020/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1094`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6502` for a line
  // that is 5921, `world.js:9854` for 8836, `interior.js:312` for 329,
  ...
  // (`world.js:4854` for a line that is 8950; `:806` for 1215; `:1352` for
...
// multi-number citation: `cityGuards.js:809-719`, `world.js:7355-7329`,
// `worldModes.js:1275 against :1085`. Forty of them came out as ranges
