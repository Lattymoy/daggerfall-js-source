...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3544\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1127/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3169/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3169/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1123`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:11599` for 8836, `interior.js:315` for 329,
  ...
  // (`world.js:5131` for a line that is 8950; `:835` for 1215; `:1381` for
  ...
  // range that cannot exist (`exterior.js:1652-1318`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:7711-7685`,
