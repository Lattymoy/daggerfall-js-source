...
//     (Port-Ledger.md:803)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4130\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1449/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3735/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3735/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1445`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6868` for a line
  ...
  // (`world.js:5768` for a line that is 8950; `:891` for 1215; `:1779` for
...
// multi-number citation: `cityGuards.js:812-722`, `world.js:8378-8352`,
// `worldModes.js:1294 against :1075`. Forty of them came out as ranges
