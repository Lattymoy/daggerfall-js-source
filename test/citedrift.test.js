...
//     (Port-Ledger.md:840)". Section A carried no widget row at all -
...
// pick - `/exterior\.js:(\d+)\/:1547/`, `/exterior\.js:951\/:(\d+)/` -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4828\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1975/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:4422/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:4422/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1971`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:7446` for a line
  // that is 5921, `world.js:14341` for 8836, `interior.js:325` for 329,
  ...
  // (`world.js:6547` for a line that is 8950; `:1019` for 1215; `:2345` for
  ...
  // range that cannot exist (`exterior.js:1737-1401`).
...
// multi-number citation: `cityGuards.js:929-836`, `world.js:9367-9341`,
// `worldModes.js:1367 against :1143`. Forty of them came out as ranges
