...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3256\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1052/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2882/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2882/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1048`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:9521` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4719` for a line that is 8950; `:795` for 1215; `:1305` for
...
// multi-number citation: `cityGuards.js:803-716`, `world.js:7123-7097`,
