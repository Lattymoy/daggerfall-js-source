...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4821\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1968/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:4415/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:4415/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1964`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:7499` for a line
  // that is 5921, `world.js:14532` for 8836, `interior.js:325` for 329,
  ...
  // (`world.js:6540` for a line that is 8950; `:1012` for 1215; `:2338` for
...
// multi-number citation: `cityGuards.js:930-837`, `world.js:9359-9333`,
// `worldModes.js:1368 against :1144`. Forty of them came out as ranges
