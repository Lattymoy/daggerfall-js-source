...
//     (Port-Ledger.md:816)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4207\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1488/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3802/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3802/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1484`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:7086` for a line
  // that is 5921, `world.js:13090` for 8836, `interior.js:319` for 329,
  ...
  // (`world.js:5884` for a line that is 8950; `:925` for 1215; `:1818` for
...
// multi-number citation: `cityGuards.js:929-836`, `world.js:8523-8497`,
// `worldModes.js:1311 against :1087`. Forty of them came out as ranges
