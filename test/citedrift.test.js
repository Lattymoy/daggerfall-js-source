...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4188\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1478/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3793/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3793/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1474`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6965` for a line
  // that is 5921, `world.js:13192` for 8836, `interior.js:323` for 329,
  ...
  // (`world.js:5860` for a line that is 8950; `:916` for 1215; `:1808` for
...
// multi-number citation: `cityGuards.js:925-832`, `world.js:8550-8524`,
