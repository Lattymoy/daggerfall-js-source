...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3346\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1100/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3022/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3022/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1096`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:9897` for 8836, `interior.js:312` for 329,
  ...
  // (`world.js:4856` for a line that is 8950; `:808` for 1215; `:1354` for
...
// multi-number citation: `cityGuards.js:809-719`, `world.js:7357-7331`,
