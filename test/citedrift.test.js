...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3516\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1117/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3141/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3141/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6720` for a line
  // that is 5921, `world.js:11220` for 8836, `interior.js:315` for 329,
  ...
  // (`world.js:5101` for a line that is 8950; `:825` for 1215; `:1371` for
  ...
  // range that cannot exist (`exterior.js:1641-1315`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:7672-7646`,
