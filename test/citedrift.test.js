...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3695\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1223/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3320/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3320/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1219`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:11377` for 8836, `interior.js:315` for 329,
  ...
  // (`world.js:5280` for a line that is 8950; `:840` for 1215; `:1509` for
  ...
  // range that cannot exist (`exterior.js:1609-1354`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:7835-7809`,
