...
//     (Port-Ledger.md:765)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2670\)/,
  ...
  ['src/systems/potions.js', /exterior\.js:(\d+)\) and useItem\.js:274/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:868/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2419/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2419/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:863`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:5661` for a line
  // that is 5921, `world.js:8372` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4108` for a line that is 8950; `:652` for 1215; `:1103` for
  ...
  // range that cannot exist (`exterior.js:1289-1237`).
...
// multi-number citation: `cityGuards.js:768-693`, `world.js:6105-6079`,
// `worldModes.js:1168 against :1056`. Forty of them came out as ranges
