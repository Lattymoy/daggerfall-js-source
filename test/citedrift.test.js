...
//     (Port-Ledger.md:799)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3542\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1125/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3167/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3167/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1121`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6732` for a line
  // that is 5921, `world.js:11430` for 8836, `interior.js:315` for 329,
  ...
  // (`world.js:5132` for a line that is 8950; `:830` for 1215; `:1379` for
  ...
  // range that cannot exist (`exterior.js:1656-1322`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:7708-7682`,
