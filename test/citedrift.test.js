...
//     (Port-Ledger.md:824)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4184\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3789/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3789/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // that is 5921, `world.js:13122` for 8836, `interior.js:323` for 329,
  ...
  // (`world.js:5856` for a line that is 8950; `:912` for 1215; `:1804` for
...
// multi-number citation: `cityGuards.js:925-832`, `world.js:8546-8520`,
