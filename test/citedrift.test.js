...
//     (Port-Ledger.md:764)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2622\)/,
  ...
  ['src/systems/potions.js', /exterior\.js:(\d+)\) and useItem\.js:272/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:863/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2372/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2372/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:858`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:8308` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4052` for a line that is 8950; `:647` for 1215; `:1096` for
  ...
  // range that cannot exist (`exterior.js:1271-1229`).
...
// multi-number citation: `cityGuards.js:781-706`, `world.js:6045-6019`,
