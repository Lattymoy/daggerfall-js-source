...
//     (Port-Ledger.md:798)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3540\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3164/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3164/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6759` for a line
  // that is 5921, `world.js:11445` for 8836, `interior.js:315` for 329,
  ...
  // range that cannot exist (`exterior.js:1655-1320`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:7717-7691`,
