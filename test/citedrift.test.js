...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3052\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1004/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2764/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2764/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1000`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:5747` for a line
  // that is 5921, `world.js:9338` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4543` for a line that is 8950; `:747` for 1215; `:1256` for
  ...
  // range that cannot exist (`exterior.js:1328-1276`).
...
// multi-number citation: `cityGuards.js:802-715`, `world.js:6947-6921`,
// `worldModes.js:1184 against :1056`. Forty of them came out as ranges
