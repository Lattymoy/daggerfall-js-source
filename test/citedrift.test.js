...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4816\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1963/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:4410/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:4410/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1959`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:7455` for a line
  // that is 5921, `world.js:14335` for 8836, `interior.js:325` for 329,
  ...
  // (`world.js:6535` for a line that is 8950; `:1007` for 1215; `:2333` for
...
// multi-number citation: `cityGuards.js:929-836`, `world.js:9349-9323`,
