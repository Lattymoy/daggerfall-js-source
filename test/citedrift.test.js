...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4814\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1961/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:4408/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:4408/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1957`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:14329` for 8836, `interior.js:325` for 329,
  ...
  // (`world.js:6534` for a line that is 8950; `:1005` for 1215; `:2331` for
...
// multi-number citation: `cityGuards.js:929-836`, `world.js:9354-9328`,
