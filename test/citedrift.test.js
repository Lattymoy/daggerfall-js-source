...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3415\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1107/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3040/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3040/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1103`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6667` for a line
  // that is 5921, `world.js:10942` for 8836, `interior.js:315` for 329,
  ...
  // (`world.js:4988` for a line that is 8950; `:815` for 1215; `:1361` for
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:7543-7517`,
// `worldModes.js:1272 against :1068`. Forty of them came out as ranges
