...
//     (Port-Ledger.md:814)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4192\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3787/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3787/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6892` for a line
  // that is 5921, `world.js:13066` for 8836, `interior.js:319` for 329,
  ...
  // (`world.js:5869` for a line that is 8950; `:910` for 1215; `:1803` for
...
// multi-number citation: `cityGuards.js:929-836`, `world.js:8506-8480`,
