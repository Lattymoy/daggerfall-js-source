...
test('CD1: Ledger A row TB1 exists, in section A, STRUCK by the classic-modals cleanup, and names the windows that cite it', () => {
  ...
  // doctrine.test.js:363 skips the file because it shouts no DEPARTURE
...
// pick - `/exterior\.js:(\d+)\/:1547/`, `/exterior\.js:950\/:(\d+)/` -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4615\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1881/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:4219/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:4219/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1877`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6906` for a line
  // that is 5921, `world.js:13490` for 8836, `interior.js:324` for 329,
  // `dungeon.js:966` for 959). Every one is captured now, against the
  ...
  // (`world.js:6302` for a line that is 8950; `:930` for 1215; `:2220` for
  ...
  // range that cannot exist (`exterior.js:1736-1400`).
...
// multi-number citation: `cityGuards.js:925-832`, `world.js:8997-8971`,
// `worldModes.js:1301 against :1082`. Forty of them came out as ranges
