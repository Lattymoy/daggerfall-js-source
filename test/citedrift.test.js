...
//     (Port-Ledger.md:828)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4799\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1947/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:4393/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:4393/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1943`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:7351` for a line
  // that is 5921, `world.js:14016` for 8836, `interior.js:325` for 329,
  ...
  // (`world.js:6517` for a line that is 8950; `:991` for 1215; `:2317` for
...
// multi-number citation: `cityGuards.js:929-836`, `world.js:9292-9266`,
// `worldModes.js:1363 against :1139`. Forty of them came out as ranges
