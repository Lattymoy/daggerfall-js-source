...
//     (Port-Ledger.md:821)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4180\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1470/, EX, /playerTicker\.advance\(60\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1466`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:13039` for 8836, `interior.js:323` for 329,
  ...
  // (`world.js:5851` for a line that is 8950; `:908` for 1215; `:1800` for
...
// multi-number citation: `cityGuards.js:925-832`, `world.js:8516-8490`,
