...
//     (Port-Ledger.md:754)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2563\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:844/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2341/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2341/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:839`/, EX, /playerTicker\.advance\(60\);/],
  ...
  ['bible/01-Overview/Port-Ledger.md', /`exterior\.js:(\d+)`, `dungeonContext\.js:1306`/,
    EX, /drinkPotion: \(key\) => magic\.drinkPotion\(key\)/],
  ['bible/01-Overview/Port-Ledger.md', /`world\.js:3877`, `exterior\.js:(\d+)`/,
    EX, /renderer\.setWindowEmission\(windowEmissionRGB\(/],
  ['bible/01-Overview/Port-Ledger.md', /`world\.js:644`, `exterior\.js:(\d+)` pass `getNameBankOfRegion`/,
...
const NO_LINE_LEFT = [
  [/`world\.js:4166-4169` and its `exterior\.js` twin, both DELETED by FX1/, 'no loot'],
...
// multi-number citation: `cityGuards.js:768-693`, `world.js:5720-5694`,
