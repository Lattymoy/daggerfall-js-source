...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4128\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3733/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3733/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6807` for a line
  ...
  // (`world.js:5732` for a line that is 8950; `:891` for 1215; `:1779` for
  ...
  // range that cannot exist (`exterior.js:1720-1386`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:8336-8310`,
