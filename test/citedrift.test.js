...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2906\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2626/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2626/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // that is 5921, `world.js:9078` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4388` for a line that is 8950; `:673` for 1215; `:1182` for
  ...
  // range that cannot exist (`exterior.js:1315-1263`).
...
// multi-number citation: `cityGuards.js:789-714`, `world.js:6760-6734`,
