...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3345\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1099/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3021/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3021/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1095`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:9864` for 8836, `interior.js:312` for 329,
  ...
  // (`world.js:4855` for a line that is 8950; `:807` for 1215; `:1353` for
...
// multi-number citation: `cityGuards.js:809-719`, `world.js:7356-7330`,
