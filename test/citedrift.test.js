...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4019\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1383/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3644/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3644/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1379`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6746` for a line
  // that is 5921, `world.js:11899` for 8836, `interior.js:315` for 329,
  ...
  // (`world.js:5626` for a line that is 8950; `:877` for 1215; `:1715` for
  ...
  // range that cannot exist (`exterior.js:1700-1366`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:8220-8194`,
