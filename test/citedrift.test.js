...
const SOURCE_CITES = [
  ...
  // four of the five had been stale for waves (`worldModes.js:6709` for a line
  // that is 5921, `world.js:11202` for 8836, `interior.js:315` for 329,
  ...
  // (`world.js:5013` for a line that is 8950; `:818` for 1215; `:1367` for
  ...
  // range that cannot exist (`exterior.js:1566-1311`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:7571-7545`,
