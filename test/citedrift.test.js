...
const SOURCE_CITES = [
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3783/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3783/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // that is 5921, `world.js:13050` for 8836, `interior.js:319` for 329,
  ...
  // (`world.js:5865` for a line that is 8950; `:907` for 1215; `:1799` for
...
// multi-number citation: `cityGuards.js:927-834`, `world.js:8502-8476`,
