...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:5045\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:2185/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:4639/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:4639/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:2181`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:14558` for 8836, `interior.js:325` for 329,
  ...
  // (`world.js:6767` for a line that is 8950; `:1009` for 1215; `:2557` for
...
// multi-number citation: `cityGuards.js:929-836`, `world.js:9583-9557`,
