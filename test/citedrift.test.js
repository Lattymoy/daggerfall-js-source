...
//     (Port-Ledger.md:830)". Section A carried no widget row at all -
...
// pick - `/exterior\.js:(\d+)\/:1547/`, `/exterior\.js:947\/:(\d+)/` -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4190\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1480/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3795/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3795/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1476`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6985` for a line
  // that is 5921, `world.js:13216` for 8836, `interior.js:323` for 329,
  ...
  // (`world.js:5862` for a line that is 8950; `:918` for 1215; `:1810` for
  ...
  // range that cannot exist (`exterior.js:1732-1396`).
...
// multi-number citation: `cityGuards.js:925-832`, `world.js:8553-8527`,
// `worldModes.js:1303 against :1084`. Forty of them came out as ranges
