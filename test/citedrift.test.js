...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2983\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2701/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2701/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // that is 5921, `world.js:9172` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4474` for a line that is 8950; `:686` for 1215; `:1195` for
...
// multi-number citation: `cityGuards.js:802-715`, `world.js:6828-6802`,
