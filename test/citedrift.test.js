...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2573\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:850/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2351/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2351/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:845`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // range that cannot exist (`exterior.js:1266-1224`).
...
// multi-number citation: `cityGuards.js:768-693`, `world.js:5791-5765`,
// `worldModes.js:1164 against :1056`. Forty of them came out as ranges
