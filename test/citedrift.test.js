...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2668\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:866/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2417/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2417/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:861`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:5653` for a line
  // that is 5921, `world.js:8367` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4106` for a line that is 8950; `:650` for 1215; `:1101` for
  ...
  // range that cannot exist (`exterior.js:1287-1235`).
...
// multi-number citation: `cityGuards.js:768-693`, `world.js:6101-6075`,
