...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4161\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1463/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:12559` for 8836, `interior.js:319` for 329,
  ...
  // (`world.js:5795` for a line that is 8950; `:904` for 1215; `:1796` for
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:8426-8400`,
