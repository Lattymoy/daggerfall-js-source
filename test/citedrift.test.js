...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3232\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1058/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2889/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2889/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1054`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:9497` for 8836, `interior.js:301` for 329,
  ...
  // (`world.js:4695` for a line that is 8950; `:801` for 1215; `:1312` for
...
// multi-number citation: `cityGuards.js:803-716`, `world.js:7099-7073`,
