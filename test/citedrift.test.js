...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2913\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:937/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2633/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2633/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:933`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:9085` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4395` for a line that is 8950; `:681` for 1215; `:1190` for
...
// multi-number citation: `cityGuards.js:789-714`, `world.js:6767-6741`,
