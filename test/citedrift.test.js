...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3379\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1123/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3051/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3051/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1120`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6482` for a line
  // that is 5921, `world.js:9762` for 8836, `interior.js:306` for 329,
  ...
  // (`world.js:4870` for a line that is 8950; `:803` for 1215; `:1377` for
  ...
  // range that cannot exist (`exterior.js:1464-1297`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:7333-7307`,
