...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4819\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1966/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:4413/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:4413/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1962`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:14473` for 8836, `interior.js:325` for 329,
  ...
  // (`world.js:6538` for a line that is 8950; `:1010` for 1215; `:2336` for
...
// multi-number citation: `cityGuards.js:930-837`, `world.js:9357-9331`,
