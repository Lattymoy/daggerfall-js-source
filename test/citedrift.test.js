...
//     (Port-Ledger.md:825)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4185\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1475/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3790/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3790/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1471`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:13147` for 8836, `interior.js:323` for 329,
  ...
  // (`world.js:5857` for a line that is 8950; `:913` for 1215; `:1805` for
...
// multi-number citation: `cityGuards.js:925-832`, `world.js:8547-8521`,
