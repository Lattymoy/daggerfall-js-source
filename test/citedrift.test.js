...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3391\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3063/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3063/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6601` for a line
  // that is 5921, `world.js:9774` for 8836, `interior.js:306` for 329,
  ...
  // (`world.js:4882` for a line that is 8950; `:803` for 1215; `:1377` for
  ...
  // range that cannot exist (`exterior.js:1476-1297`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:7345-7319`,
