...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4083\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1434/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3708/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3708/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1430`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6756` for a line
  ...
  // (`world.js:5687` for a line that is 8950; `:879` for 1215; `:1766` for
  ...
  // range that cannot exist (`exterior.js:1705-1371`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:8291-8265`,
