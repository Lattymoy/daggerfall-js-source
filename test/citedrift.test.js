...
//     (Port-Ledger.md:813)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3782/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3782/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6891` for a line
  // that is 5921, `world.js:13040` for 8836, `interior.js:319` for 329,
  ...
  // (`world.js:5861` for a line that is 8950; `:906` for 1215; `:1798` for
...
// multi-number citation: `cityGuards.js:925-832`, `world.js:8498-8472`,
