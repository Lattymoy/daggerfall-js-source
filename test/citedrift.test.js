...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3889\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1298/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3514/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3514/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1294`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:11732` for 8836, `interior.js:315` for 329,
  ...
  // (`world.js:5482` for a line that is 8950; `:852` for 1215; `:1591` for
  ...
  // range that cannot exist (`exterior.js:1699-1365`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:8055-8029`,
