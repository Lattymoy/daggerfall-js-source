...
//     (Port-Ledger.md:822)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4183\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1473/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3788/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3788/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1469`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6942` for a line
  // that is 5921, `world.js:13098` for 8836, `interior.js:323` for 329,
  ...
  // (`world.js:5855` for a line that is 8950; `:911` for 1215; `:1803` for
...
// multi-number citation: `cityGuards.js:925-832`, `world.js:8545-8519`,
