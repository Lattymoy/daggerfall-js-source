...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3190\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1047/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2866/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2866/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1043`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:5806` for a line
  // that is 5921, `world.js:9455` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4653` for a line that is 8950; `:790` for 1215; `:1300` for
  ...
  // range that cannot exist (`exterior.js:1391-1288`).
...
// multi-number citation: `cityGuards.js:803-716`, `world.js:7057-7031`,
// `worldModes.js:1224 against :1056`. Forty of them came out as ranges
