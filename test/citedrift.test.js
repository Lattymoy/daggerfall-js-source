...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3140\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1009/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3996/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3996/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1005`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:5805` for a line
  // that is 5921, `world.js:9480` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4685` for a line that is 8950; `:752` for 1215; `:1262` for
...
// multi-number citation: `cityGuards.js:803-716`, `world.js:7089-7063`,
// `worldModes.js:1223 against :1056`. Forty of them came out as ranges
