...
const SOURCE_CITES = [
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1446/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3739/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3739/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1442`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:12109` for 8836, `interior.js:319` for 329,
  ...
  // (`world.js:5748` for a line that is 8950; `:891` for 1215; `:1779` for
  ...
  // range that cannot exist (`exterior.js:1725-1389`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:8369-8343`,
