...
//     (Port-Ledger.md:767)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2634\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2384/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2384/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:5663` for a line
  // that is 5921, `world.js:8335` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4084` for a line that is 8950; `:647` for 1215; `:1096` for
  ...
  // range that cannot exist (`exterior.js:1272-1230`).
...
// multi-number citation: `cityGuards.js:768-693`, `world.js:6077-6051`,
