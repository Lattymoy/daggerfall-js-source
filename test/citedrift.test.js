...
//     (Port-Ledger.md:826)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4360\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1533/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3955/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3955/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1529`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:7388` for a line
  // that is 5921, `world.js:13517` for 8836, `interior.js:323` for 329,
  ...
  // (`world.js:6062` for a line that is 8950; `:966` for 1215; `:1894` for
...
// multi-number citation: `cityGuards.js:929-836`, `world.js:8784-8758`,
// `worldModes.js:1361 against :1137`. Forty of them came out as ranges
