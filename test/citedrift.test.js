...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4174\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1465/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3779/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3779/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1461`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:12949` for 8836, `interior.js:322` for 329,
  ...
  // (`world.js:5845` for a line that is 8950; `:903` for 1215; `:1795` for
...
// multi-number citation: `cityGuards.js:925-832`, `world.js:8487-8461`,
