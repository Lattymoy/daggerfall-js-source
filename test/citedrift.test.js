...
//     (Port-Ledger.md:782)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3191\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1048/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2867/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2867/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1044`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:5834` for a line
  // that is 5921, `world.js:9474` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4654` for a line that is 8950; `:791` for 1215; `:1301` for
  ...
  // range that cannot exist (`exterior.js:1392-1289`).
...
// multi-number citation: `cityGuards.js:803-716`, `world.js:7058-7032`,
