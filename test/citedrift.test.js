...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2914\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:930/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2634/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2634/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:926`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:9098` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4405` for a line that is 8950; `:674` for 1215; `:1183` for
  ...
  // range that cannot exist (`exterior.js:1323-1271`).
...
// multi-number citation: `cityGuards.js:789-714`, `world.js:6780-6754`,
