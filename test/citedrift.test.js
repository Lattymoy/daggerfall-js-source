...
//     (Port-Ledger.md:801)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4132\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1443/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3736/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3736/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1439`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6838` for a line
  // that is 5921, `world.js:12191` for 8836, `interior.js:319` for 329,
  ...
  // (`world.js:5747` for a line that is 8950; `:891` for 1215; `:1776` for
  ...
  // range that cannot exist (`exterior.js:1720-1384`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:8381-8355`,
// `worldModes.js:1289 against :1085`. Forty of them came out as ranges
