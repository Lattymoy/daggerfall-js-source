...
//     (Port-Ledger.md:779)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2905\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:929/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2625/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2625/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:925`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:5738` for a line
  // that is 5921, `world.js:9077` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4387` for a line that is 8950; `:673` for 1215; `:1182` for
  ...
  // range that cannot exist (`exterior.js:1314-1262`).
...
// multi-number citation: `cityGuards.js:789-714`, `world.js:6759-6733`,
// `worldModes.js:1175 against :1056`. Forty of them came out as ranges
