...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4086\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1437/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3711/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3711/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1433`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:12206` for 8836, `interior.js:315` for 329,
  ...
  // (`world.js:5690` for a line that is 8950; `:885` for 1215; `:1769` for
