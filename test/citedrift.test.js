...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3296\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1114/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2972/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2972/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1111`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6287` for a line
  // that is 5921, `world.js:9619` for 8836, `interior.js:298` for 329,
  ...
  // (`world.js:4776` for a line that is 8950; `:794` for 1215; `:1368` for
  ...
  // range that cannot exist (`exterior.js:1405-1291`).
...
// multi-number citation: `cityGuards.js:810-720`, `world.js:7190-7164`,
// `worldModes.js:1239 against :1056`. Forty of them came out as ranges
