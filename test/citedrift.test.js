...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4069\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1423/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3694/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3694/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1419`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:11999` for 8836, `interior.js:315` for 329,
  ...
  // (`world.js:5673` for a line that is 8950; `:878` for 1215; `:1755` for
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:8274-8248`,
