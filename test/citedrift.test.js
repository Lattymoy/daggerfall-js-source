...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4315\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1498/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3920/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3920/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1494`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:13315` for 8836, `interior.js:323` for 329,
  ...
  // (`world.js:6013` for a line that is 8950; `:936` for 1215; `:1859` for
...
// multi-number citation: `cityGuards.js:925-832`, `world.js:8732-8706`,
