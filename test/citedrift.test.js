...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2727\)/,
  ...
  ['src/systems/potions.js', /exterior\.js:(\d+)\) and useItem\.js:281/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2476/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2476/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // that is 5921, `world.js:8432` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4165` for a line that is 8950; `:659` for 1215; `:1110` for
...
// multi-number citation: `cityGuards.js:768-693`, `world.js:6162-6136`,
