...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3011\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:970/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2729/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2729/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:966`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:9240` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4502` for a line that is 8950; `:713` for 1215; `:1222` for
...
// multi-number citation: `cityGuards.js:802-715`, `world.js:6864-6838`,
