...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3216\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2892/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2892/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:5849` for a line
  // that is 5921, `world.js:9571` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4711` for a line that is 8950; `:793` for 1215; `:1324` for
  ...
  // range that cannot exist (`exterior.js:1398-1295`).
...
// multi-number citation: `cityGuards.js:806-716`, `world.js:7143-7117`,
