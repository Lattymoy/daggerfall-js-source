...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3108\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1006/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2820/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2820/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1002`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:5799` for a line
  // that is 5921, `world.js:9402` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4607` for a line that is 8950; `:749` for 1215; `:1259` for
  ...
  // range that cannot exist (`exterior.js:1338-1285`).
...
// multi-number citation: `cityGuards.js:802-715`, `world.js:7011-6985`,
// `worldModes.js:1218 against :1056`. Forty of them came out as ranges
