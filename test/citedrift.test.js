...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2949\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2669/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2669/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // that is 5921, `world.js:9121` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4431` for a line that is 8950; `:681` for 1215; `:1190` for
...
// multi-number citation: `cityGuards.js:789-714`, `world.js:6803-6777`,
