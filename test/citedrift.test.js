...
const SOURCE_CITES = [
  ...
  // that is 5921, `world.js:9789` for 8836, `interior.js:306` for 329,
  // `dungeon.js:924` for 959). Every one is captured now, against the
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:7360-7334`,
