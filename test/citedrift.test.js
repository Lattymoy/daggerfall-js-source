...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3401\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1101/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3026/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3026/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1097`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6634` for a line
  // that is 5921, `world.js:9953` for 8836, `interior.js:315` for 329,
  ...
  // (`world.js:4860` for a line that is 8950; `:809` for 1215; `:1355` for
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:7388-7362`,
