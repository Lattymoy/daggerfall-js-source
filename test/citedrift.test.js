...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3260\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1056/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2886/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2886/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1052`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:9525` for 8836, `interior.js:301` for 329,
  ...
  // (`world.js:4723` for a line that is 8950; `:799` for 1215; `:1309` for
  ...
  // range that cannot exist (`exterior.js:1399-1296`).
...
// multi-number citation: `cityGuards.js:803-716`, `world.js:7127-7101`,
