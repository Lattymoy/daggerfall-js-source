...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4579\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1847/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:4184/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:4184/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1843`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:13431` for 8836, `interior.js:324` for 329,
  ...
  // (`world.js:6266` for a line that is 8950; `:926` for 1215; `:2185` for
...
// multi-number citation: `cityGuards.js:925-832`, `world.js:8938-8912`,
