...
//     (Port-Ledger.md:772)". Section A carried no widget row at all -
...
test('CD1: Ledger A row TB1 exists, in section A, and names the windows that cite it', () => {
  ...
  // doctrine.test.js:289 skips the file because it shouts no DEPARTURE
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2768\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2488/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2488/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // that is 5921, `world.js:8510` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4222` for a line that is 8950; `:659` for 1215; `:1110` for
...
// multi-number citation: `cityGuards.js:781-706`, `world.js:6231-6205`,
