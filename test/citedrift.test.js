...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3098\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1007/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2810/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2810/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1003`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:5800` for a line
  // that is 5921, `world.js:9392` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4597` for a line that is 8950; `:750` for 1215; `:1260` for
  ...
  // range that cannot exist (`exterior.js:1344-1286`).
...
// multi-number citation: `cityGuards.js:803-716`, `world.js:7001-6975`,
// `worldModes.js:1222 against :1056`. Forty of them came out as ranges
