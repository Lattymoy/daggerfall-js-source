...
//     (Port-Ledger.md:781)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3235\)/,
  ...
  ['src/systems/potions.js', /exterior\.js:(\d+)\) and useItem\.js:303/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1059/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2891/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2891/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1055`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:5855` for a line
  // that is 5921, `world.js:9501` for 8836, `interior.js:301` for 329,
  // `dungeon.js:895` for 959). Every one is captured now, against the
  ...
  // (`world.js:4698` for a line that is 8950; `:802` for 1215; `:1313` for
  ...
  // range that cannot exist (`exterior.js:1406-1303`).
...
// multi-number citation: `cityGuards.js:803-716`, `world.js:7102-7076`,
// `worldModes.js:1228 against :1056`. Forty of them came out as ranges
