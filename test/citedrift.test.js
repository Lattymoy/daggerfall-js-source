...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4250\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3855/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3855/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // that is 5921, `world.js:13041` for 8836, `interior.js:322` for 329,
  ...
  // (`world.js:5929` for a line that is 8950; `:905` for 1215; `:1811` for
...
// multi-number citation: `cityGuards.js:925-832`, `world.js:8569-8543`,
