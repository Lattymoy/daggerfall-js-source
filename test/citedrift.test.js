...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2963\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:943/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2683/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2683/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:939`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:9147` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4454` for a line that is 8950; `:686` for 1215; `:1195` for
  ...
  // range that cannot exist (`exterior.js:1326-1274`).
...
// multi-number citation: `cityGuards.js:789-714`, `world.js:6808-6782`,
