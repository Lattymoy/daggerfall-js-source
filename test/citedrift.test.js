...
const SOURCE_CITES = [
  ...
  ['bible/01-Overview/Port-Ledger.md', /`exterior\.js:(\d+)`, `dungeonContext\.js:1305`/,
    EX, /drinkPotion: \(key\) => magic\.drinkPotion\(key\)/],
  ['bible/01-Overview/Port-Ledger.md', /`world\.js:3834`, `exterior\.js:(\d+)`/,
...
const NO_LINE_LEFT = [
  [/`world\.js:4125-4128` and its `exterior\.js` twin, both DELETED by FX1/, 'no loot'],
...
// multi-number citation: `cityGuards.js:768-693`, `world.js:5616-5590`,
