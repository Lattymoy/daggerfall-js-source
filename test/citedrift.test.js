...
//     (Port-Ledger.md:791)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3414\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1106/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3039/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3039/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1102`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6642` for a line
  // that is 5921, `world.js:10362` for 8836, `interior.js:315` for 329,
  ...
  // (`world.js:4951` for a line that is 8950; `:814` for 1215; `:1360` for
  ...
  // range that cannot exist (`exterior.js:1558-1303`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:7479-7453`,
// `worldModes.js:1270 against :1067`. Forty of them came out as ranges
