...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2810\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:888/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2530/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2530/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:883`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:8871` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4284` for a line that is 8950; `:672` for 1215; `:1123` for
...
// multi-number citation: `cityGuards.js:781-706`, `world.js:6592-6566`,
