...
const SOURCE_CITES = [
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1071/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:9567` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4710` for a line that is 8950; `:793` for 1215; `:1324` for
  ...
  // range that cannot exist (`exterior.js:1397-1294`).
...
// multi-number citation: `cityGuards.js:806-716`, `world.js:7142-7116`,
