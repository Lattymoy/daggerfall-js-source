...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:4140\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3744/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3744/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6837` for a line
  // that is 5921, `world.js:12114` for 8836, `interior.js:319` for 329,
  ...
  // (`world.js:5753` for a line that is 8950; `:893` for 1215; `:1784` for
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:8374-8348`,
