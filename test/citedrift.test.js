...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3393\)/,
  ...
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3065/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3065/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1122`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:9795` for 8836, `interior.js:306` for 329,
  ...
  // (`world.js:4884` for a line that is 8950; `:805` for 1215; `:1379` for
  ...
  // range that cannot exist (`exterior.js:1478-1299`).
