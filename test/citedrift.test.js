...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3332\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1116/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3008/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3008/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1113`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6331` for a line
  // that is 5921, `world.js:9655` for 8836, `interior.js:298` for 329,
  ...
  // (`world.js:4812` for a line that is 8950; `:796` for 1215; `:1370` for
  ...
  // range that cannot exist (`exterior.js:1441-1293`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:7226-7200`,
// `worldModes.js:1258 against :1056`. Forty of them came out as ranges
