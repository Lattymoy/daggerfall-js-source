...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3422\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1111/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:3047/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:3047/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:1107`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6705` for a line
  // that is 5921, `world.js:10987` for 8836, `interior.js:315` for 329,
  ...
  // (`world.js:4995` for a line that is 8950; `:816` for 1215; `:1365` for
  ...
  // range that cannot exist (`exterior.js:1565-1310`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:7553-7527`,
