...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3009\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:969/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2727/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2727/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:965`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:9223` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4500` for a line that is 8950; `:712` for 1215; `:1221` for
...
// multi-number citation: `cityGuards.js:802-715`, `world.js:6862-6836`,
