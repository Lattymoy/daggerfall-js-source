...
//     (Port-Ledger.md:796)". Section A carried no widget row at all -
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3426\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1115/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:6706` for a line
  // that is 5921, `world.js:11363` for 8836, `interior.js:315` for 329,
  // `dungeon.js:940` for 959). Every one is captured now, against the
  ...
  // (`world.js:5015` for a line that is 8950; `:823` for 1215; `:1369` for
  ...
  // range that cannot exist (`exterior.js:1562-1307`).
...
// multi-number citation: `cityGuards.js:811-721`, `world.js:7577-7551`,
