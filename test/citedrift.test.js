...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:3215\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1070/, EX, /playerTicker\.advance\(60\);/],
  ...
  // four of the five had been stale for waves (`worldModes.js:5896` for a line
  // that is 5921, `world.js:9526` for 8836, `interior.js:298` for 329,
  ...
  // (`world.js:4695` for a line that is 8950; `:792` for 1215; `:1324` for
  ...
  // range that cannot exist (`exterior.js:1393-1290`).
...
// multi-number citation: `cityGuards.js:806-716`, `world.js:7109-7083`,
// `worldModes.js:1233 against :1056`. Forty of them came out as ranges
