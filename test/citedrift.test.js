...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2918\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:942/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2638/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2638/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:938`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:9090` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4400` for a line that is 8950; `:686` for 1215; `:1195` for
