...
test('CD1: Ledger A row TB1 exists, in section A, and names the windows that cite it', () => {
  ...
  // doctrine.test.js:294 skips the file because it shouts no DEPARTURE
...
const SOURCE_CITES = [
  ...
  ['src/combat/weaponRig.js', /\(exterior\.js:(\d+), world\.js:2766\)/,
  ...
  ['test/daychange.test.js', /exterior\.js:(\d+), world\.js:1845/, EX, /playerTicker\.advance\(60\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+) and world\.js:2486/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ['test/overlayreentry.test.js', /exterior\.js:(\d+), world\.js:2486/,
    EX, /if \(townTalk\.overlay\?\.isRestWindow\) townTalk\.closeOverlay\?\.\(\);/],
  ...
  ['bible/06-Systems/Systems-Arc.md', /`exterior\.js:(\d+)`, `world\.js:903`/, EX, /playerTicker\.advance\(60\);/],
  ...
  // that is 5921, `world.js:8818` for 8836, `interior.js:297` for 329,
  ...
  // (`world.js:4228` for a line that is 8950; `:671` for 1215; `:1120` for
...
// multi-number citation: `cityGuards.js:789-714`, `world.js:6603-6577`,
