...
// existed (worldModes.js named `world.js:6701` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9872 and dungeonContext.js:6270, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6480's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6768/:6781, dungeonContext.js:6319/:6319 and
  // worldModes.js:9870-9871 - three copies, one law, carried verbatim.
