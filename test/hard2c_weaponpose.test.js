...
// existed (worldModes.js named `world.js:5291` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8472 and dungeonContext.js:5620, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5086's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5318/:5331, dungeonContext.js:5702/:5702 and
  // worldModes.js:8503-8504 - three copies, one law, carried verbatim.
