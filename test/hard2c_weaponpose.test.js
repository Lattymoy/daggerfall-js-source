...
// existed (worldModes.js named `world.js:5767` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9610 and dungeonContext.js:6178, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5561's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5825/:5838, dungeonContext.js:6227/:6227 and
  // worldModes.js:9608-9609 - three copies, one law, carried verbatim.
