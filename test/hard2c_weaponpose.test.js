...
// existed (worldModes.js named `world.js:4522` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8234 and dungeonContext.js:5431, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:4332's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:4520/:4533, dungeonContext.js:5523/:5529 and
  // worldModes.js:8265-8266 - three copies, one law, carried verbatim.
