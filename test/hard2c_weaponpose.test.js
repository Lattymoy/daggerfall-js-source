...
// existed (worldModes.js named `world.js:5448` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8607 and dungeonContext.js:5754, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5243's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5475/:5488, dungeonContext.js:5836/:5836 and
  // worldModes.js:8638-8639 - three copies, one law, carried verbatim.
