...
// existed (worldModes.js named `world.js:5729` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9524 and dungeonContext.js:6146, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5523's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5787/:5800, dungeonContext.js:6195/:6195 and
  // worldModes.js:9522-9523 - three copies, one law, carried verbatim.
