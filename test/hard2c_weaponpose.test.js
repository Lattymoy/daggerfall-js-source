...
// existed (worldModes.js named `world.js:5629` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9331 and dungeonContext.js:6084, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5423's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5655/:5668, dungeonContext.js:6174/:6174 and
  // worldModes.js:9362-9363 - three copies, one law, carried verbatim.
