...
// existed (worldModes.js named `world.js:6719` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9890 and dungeonContext.js:6316, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6485's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6786/:6799, dungeonContext.js:6365/:6365 and
  // worldModes.js:9888-9889 - three copies, one law, carried verbatim.
