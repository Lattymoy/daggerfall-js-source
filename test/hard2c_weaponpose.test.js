...
// existed (worldModes.js named `world.js:7162` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9904 and dungeonContext.js:6293, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6927's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:7231/:7244, dungeonContext.js:6342/:6342 and
  // worldModes.js:9902-9903 - three copies, one law, carried verbatim.
