...
// existed (worldModes.js named `world.js:4550` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8282 and dungeonContext.js:5446, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:4356's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:4548/:4561, dungeonContext.js:5538/:5544 and
  // worldModes.js:8313-8314 - three copies, one law, carried verbatim.
