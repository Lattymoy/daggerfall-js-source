...
// existed (worldModes.js named `world.js:5491` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8698 and dungeonContext.js:5886, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5285's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5517/:5530, dungeonContext.js:5976/:5976 and
  // worldModes.js:8729-8730 - three copies, one law, carried verbatim.
