...
// existed (worldModes.js named `world.js:5787` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9674 and dungeonContext.js:6206, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5581's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5845/:5858, dungeonContext.js:6255/:6255 and
  // worldModes.js:9672-9673 - three copies, one law, carried verbatim.
