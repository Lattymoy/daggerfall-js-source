...
// existed (worldModes.js named `world.js:6637` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9843 and dungeonContext.js:6251, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6416's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6704/:6717, dungeonContext.js:6300/:6300 and
  // worldModes.js:9841-9842 - three copies, one law, carried verbatim.
