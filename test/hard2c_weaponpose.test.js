...
// existed (worldModes.js named `world.js:5330` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8522 and dungeonContext.js:5634, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5125's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5357/:5370, dungeonContext.js:5716/:5716 and
  // worldModes.js:8553-8554 - three copies, one law, carried verbatim.
