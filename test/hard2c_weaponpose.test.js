...
// existed (worldModes.js named `world.js:6458` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  ...
  // world.js:6238's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6525/:6538, dungeonContext.js:6270/:6270 and
