...
// existed (worldModes.js named `world.js:5639` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9543 and dungeonContext.js:6141, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5433's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5697/:5710, dungeonContext.js:6190/:6190 and
  // worldModes.js:9541-9542 - three copies, one law, carried verbatim.
