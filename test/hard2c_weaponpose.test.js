...
// existed (worldModes.js named `world.js:5394` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8601 and dungeonContext.js:5724, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5189's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5421/:5434, dungeonContext.js:5806/:5806 and
  // worldModes.js:8632-8633 - three copies, one law, carried verbatim.
