...
// existed (worldModes.js named `world.js:6063` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9671 and dungeonContext.js:6206, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5857's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6121/:6134, dungeonContext.js:6255/:6255 and
  // worldModes.js:9669-9670 - three copies, one law, carried verbatim.
