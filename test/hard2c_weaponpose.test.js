...
// existed (worldModes.js named `world.js:7679` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:10474 and dungeonContext.js:6467, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:7443's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:7749/:7762, dungeonContext.js:6518/:6518 and
  // worldModes.js:10472-10473 - three copies, one law, carried verbatim.
