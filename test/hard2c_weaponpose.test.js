...
// existed (worldModes.js named `world.js:5792` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9681 and dungeonContext.js:6220, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5586's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5850/:5863, dungeonContext.js:6269/:6269 and
  // worldModes.js:9679-9680 - three copies, one law, carried verbatim.
