...
// existed (worldModes.js named `world.js:4538` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8255 and dungeonContext.js:5432, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:4348's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:4536/:4549, dungeonContext.js:5524/:5530 and
  // worldModes.js:8286-8287 - three copies, one law, carried verbatim.
