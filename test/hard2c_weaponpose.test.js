...
// existed (worldModes.js named `world.js:4879` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8343 and dungeonContext.js:5565, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:4683's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:4877/:4890, dungeonContext.js:5657/:5663 and
  // worldModes.js:8374-8375 - three copies, one law, carried verbatim.
