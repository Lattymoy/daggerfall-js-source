...
// existed (worldModes.js named `world.js:6551` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9781 and dungeonContext.js:6223, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6331's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6618/:6631, dungeonContext.js:6272/:6272 and
  // worldModes.js:9779-9780 - three copies, one law, carried verbatim.
