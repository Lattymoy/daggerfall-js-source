...
// existed (worldModes.js named `world.js:5915` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9701 and dungeonContext.js:6221, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5707's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5977/:5990, dungeonContext.js:6270/:6270 and
  // worldModes.js:9699-9700 - three copies, one law, carried verbatim.
