...
// existed (worldModes.js named `world.js:5497` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8709 and dungeonContext.js:5886, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5291's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5523/:5536, dungeonContext.js:5976/:5976 and
  // worldModes.js:8740-8741 - three copies, one law, carried verbatim.
