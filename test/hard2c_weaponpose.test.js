...
// existed (worldModes.js named `world.js:5640` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9318 and dungeonContext.js:6070, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5434's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5667/:5680, dungeonContext.js:6120/:6120 and
  // worldModes.js:9326-9327 - three copies, one law, carried verbatim.
