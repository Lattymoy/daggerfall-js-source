...
// existed (worldModes.js named `world.js:4525` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  ...
  // world.js:4335's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:4523/:4536, dungeonContext.js:5523/:5529 and
