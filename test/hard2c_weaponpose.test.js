...
// existed (worldModes.js named `world.js:6706` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9898 and dungeonContext.js:6286, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6472's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6773/:6786, dungeonContext.js:6335/:6335 and
  // worldModes.js:9896-9897 - three copies, one law, carried verbatim.
