...
// existed (worldModes.js named `world.js:5393` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8565 and dungeonContext.js:5723, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5188's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5420/:5433, dungeonContext.js:5805/:5805 and
  // worldModes.js:8596-8597 - three copies, one law, carried verbatim.
