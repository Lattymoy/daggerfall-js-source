...
// existed (worldModes.js named `world.js:6583` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9819 and dungeonContext.js:6248, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6362's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6650/:6663, dungeonContext.js:6297/:6297 and
  // worldModes.js:9817-9818 - three copies, one law, carried verbatim.
