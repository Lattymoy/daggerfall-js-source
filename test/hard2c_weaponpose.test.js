...
// existed (worldModes.js named `world.js:5894` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9688 and dungeonContext.js:6207, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5686's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5956/:5969, dungeonContext.js:6256/:6256 and
  // worldModes.js:9686-9687 - three copies, one law, carried verbatim.
