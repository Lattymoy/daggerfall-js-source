...
// existed (worldModes.js named `world.js:5632` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9355 and dungeonContext.js:6085, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5426's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5658/:5671, dungeonContext.js:6175/:6175 and
  // worldModes.js:9386-9387 - three copies, one law, carried verbatim.
