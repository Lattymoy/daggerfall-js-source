...
// existed (worldModes.js named `world.js:5458` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8639 and dungeonContext.js:5879, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5252's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5484/:5497, dungeonContext.js:5969/:5969 and
  // worldModes.js:8670-8671 - three copies, one law, carried verbatim.
