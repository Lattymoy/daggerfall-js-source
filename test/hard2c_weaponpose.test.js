...
// existed (worldModes.js named `world.js:5338` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8520 and dungeonContext.js:5634, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5133's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5365/:5378, dungeonContext.js:5716/:5716 and
  // worldModes.js:8551-8552 - three copies, one law, carried verbatim.
