...
// existed (worldModes.js named `world.js:7445` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:10477 and dungeonContext.js:6475, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:7210's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:7514/:7527, dungeonContext.js:6526/:6526 and
  // worldModes.js:10475-10476 - three copies, one law, carried verbatim.
