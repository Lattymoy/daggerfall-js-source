...
// existed (worldModes.js named `world.js:5659` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9471 and dungeonContext.js:6116, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5453's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5686/:5699, dungeonContext.js:6165/:6165 and
  // worldModes.js:9469-9470 - three copies, one law, carried verbatim.
