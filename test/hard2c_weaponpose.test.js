...
// existed (worldModes.js named `world.js:4820` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8329 and dungeonContext.js:5540, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:4624's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:4818/:4831, dungeonContext.js:5632/:5638 and
  // worldModes.js:8360-8361 - three copies, one law, carried verbatim.
