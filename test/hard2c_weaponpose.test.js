...
// existed (worldModes.js named `world.js:4822` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8330 and dungeonContext.js:5542, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:4626's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:4820/:4833, dungeonContext.js:5634/:5640 and
  // worldModes.js:8361-8362 - three copies, one law, carried verbatim.
