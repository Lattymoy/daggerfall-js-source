...
// existed (worldModes.js named `world.js:5436` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8643 and dungeonContext.js:5921, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5230's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5463/:5476, dungeonContext.js:5971/:5971 and
  // worldModes.js:8649-8650 - three copies, one law, carried verbatim.
