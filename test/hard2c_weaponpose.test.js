...
// existed (worldModes.js named `world.js:6542` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9783 and dungeonContext.js:6221, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6322's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6609/:6622, dungeonContext.js:6270/:6270 and
  // worldModes.js:9781-9782 - three copies, one law, carried verbatim.
