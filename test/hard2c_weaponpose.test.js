...
// existed (worldModes.js named `world.js:5347` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8527 and dungeonContext.js:5668, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5142's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5374/:5387, dungeonContext.js:5750/:5750 and
  // worldModes.js:8558-8559 - three copies, one law, carried verbatim.
