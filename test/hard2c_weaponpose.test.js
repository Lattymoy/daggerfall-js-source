...
// existed (worldModes.js named `world.js:4554` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8270 and dungeonContext.js:5433, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:4360's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:4552/:4565, dungeonContext.js:5525/:5531 and
  // worldModes.js:8301-8302 - three copies, one law, carried verbatim.
