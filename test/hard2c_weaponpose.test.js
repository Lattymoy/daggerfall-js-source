...
// existed (worldModes.js named `world.js:7398` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:10366 and dungeonContext.js:6380, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:7163's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:7467/:7480, dungeonContext.js:6429/:6429 and
  // worldModes.js:10364-10365 - three copies, one law, carried verbatim.
