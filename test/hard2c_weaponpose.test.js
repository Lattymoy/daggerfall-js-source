...
// existed (worldModes.js named `world.js:5652` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9437 and dungeonContext.js:6084, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5446's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5679/:5692, dungeonContext.js:6134/:6134 and
  // worldModes.js:9445-9446 - three copies, one law, carried verbatim.
