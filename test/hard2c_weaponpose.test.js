...
// existed (worldModes.js named `world.js:6743` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9976 and dungeonContext.js:6373, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6509's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6810/:6823, dungeonContext.js:6424/:6424 and
  // worldModes.js:9974-9975 - three copies, one law, carried verbatim.
