...
// existed (worldModes.js named `world.js:6738` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9948 and dungeonContext.js:6290, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6504's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6805/:6818, dungeonContext.js:6341/:6341 and
  // worldModes.js:9946-9947 - three copies, one law, carried verbatim.
