...
// existed (worldModes.js named `world.js:6742` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:10085 and dungeonContext.js:6342, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6508's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6809/:6822, dungeonContext.js:6391/:6391 and
  // worldModes.js:10083-10084 - three copies, one law, carried verbatim.
