...
// existed (worldModes.js named `world.js:6603` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9836 and dungeonContext.js:6255, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6375's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6670/:6683, dungeonContext.js:6304/:6304 and
  // worldModes.js:9834-9835 - three copies, one law, carried verbatim.
