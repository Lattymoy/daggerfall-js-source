...
// existed (worldModes.js named `world.js:5432` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8609 and dungeonContext.js:5755, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5227's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5459/:5472, dungeonContext.js:5844/:5844 and
  // worldModes.js:8640-8641 - three copies, one law, carried verbatim.
