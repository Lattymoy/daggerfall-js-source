...
// existed (worldModes.js named `world.js:4440` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8197 and dungeonContext.js:5359, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:4270's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:4438/:4451, dungeonContext.js:5451/:5457 and
  // worldModes.js:8228-8229 - three copies, one law, carried verbatim.
