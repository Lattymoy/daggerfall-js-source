...
// existed (worldModes.js named `world.js:4588` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8295 and dungeonContext.js:5475, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:4394's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:4586/:4599, dungeonContext.js:5567/:5573 and
  // worldModes.js:8326-8327 - three copies, one law, carried verbatim.
