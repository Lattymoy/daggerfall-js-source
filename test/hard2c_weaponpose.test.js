...
// existed (worldModes.js named `world.js:7449` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:10476 and dungeonContext.js:6471, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:7214's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:7518/:7531, dungeonContext.js:6522/:6522 and
  // worldModes.js:10474-10475 - three copies, one law, carried verbatim.
