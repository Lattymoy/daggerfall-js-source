...
// existed (worldModes.js named `world.js:4557` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8284 and dungeonContext.js:5446, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:4363's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:4555/:4568, dungeonContext.js:5538/:5544 and
  // worldModes.js:8315-8316 - three copies, one law, carried verbatim.
