...
// existed (worldModes.js named `world.js:6600` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9827 and dungeonContext.js:6249, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6379's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6667/:6680, dungeonContext.js:6298/:6298 and
  // worldModes.js:9825-9826 - three copies, one law, carried verbatim.
