...
// existed (worldModes.js named `world.js:4547` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8268 and dungeonContext.js:5433, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:4353's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:4545/:4558, dungeonContext.js:5525/:5531 and
  // worldModes.js:8299-8300 - three copies, one law, carried verbatim.
