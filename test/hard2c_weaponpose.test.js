...
// existed (worldModes.js named `world.js:4817` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8348 and dungeonContext.js:5510, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:4623's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:4815/:4828, dungeonContext.js:5602/:5608 and
  // worldModes.js:8379-8380 - three copies, one law, carried verbatim.
