...
// existed (worldModes.js named `world.js:5517` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9095 and dungeonContext.js:5965, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5311's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5544/:5557, dungeonContext.js:6015/:6015 and
  // worldModes.js:9103-9104 - three copies, one law, carried verbatim.
