...
// existed (worldModes.js named `world.js:6574` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9822 and dungeonContext.js:6246, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6353's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6641/:6654, dungeonContext.js:6295/:6295 and
  // worldModes.js:9820-9821 - three copies, one law, carried verbatim.
