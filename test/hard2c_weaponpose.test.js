...
// existed (worldModes.js named `world.js:5451` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8632 and dungeonContext.js:5839, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5245's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5477/:5490, dungeonContext.js:5929/:5929 and
  // worldModes.js:8663-8664 - three copies, one law, carried verbatim.
