...
// existed (worldModes.js named `world.js:6744` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:10237 and dungeonContext.js:6342, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6510's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6811/:6824, dungeonContext.js:6391/:6391 and
  // worldModes.js:10235-10236 - three copies, one law, carried verbatim.
