...
// existed (worldModes.js named `world.js:6451` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9729 and dungeonContext.js:6221, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6231's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6518/:6531, dungeonContext.js:6270/:6270 and
  // worldModes.js:9727-9728 - three copies, one law, carried verbatim.
