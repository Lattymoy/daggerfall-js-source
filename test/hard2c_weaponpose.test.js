...
// existed (worldModes.js named `world.js:4444` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8212 and dungeonContext.js:5407, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:4274's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:4442/:4455, dungeonContext.js:5499/:5505 and
  // worldModes.js:8243-8244 - three copies, one law, carried verbatim.
