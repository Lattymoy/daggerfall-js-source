...
// existed (worldModes.js named `world.js:5770` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9668 and dungeonContext.js:6200, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5564's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5828/:5841, dungeonContext.js:6249/:6249 and
  // worldModes.js:9666-9667 - three copies, one law, carried verbatim.
