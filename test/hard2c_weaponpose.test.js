...
// existed (worldModes.js named `world.js:5243` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  ...
  // world.js:5038's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5270/:5283, dungeonContext.js:5702/:5702 and
