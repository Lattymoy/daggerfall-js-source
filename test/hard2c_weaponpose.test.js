...
// existed (worldModes.js named `world.js:4642` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8325 and dungeonContext.js:5509, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:4448's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:4640/:4653, dungeonContext.js:5601/:5607 and
  // worldModes.js:8356-8357 - three copies, one law, carried verbatim.
