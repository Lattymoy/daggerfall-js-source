...
// existed (worldModes.js named `world.js:5441` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8614 and dungeonContext.js:5819, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5235's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5467/:5480, dungeonContext.js:5909/:5909 and
  // worldModes.js:8645-8646 - three copies, one law, carried verbatim.
