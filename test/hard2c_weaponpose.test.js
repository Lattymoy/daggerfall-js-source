...
// existed (worldModes.js named `world.js:7446` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:10484 and dungeonContext.js:6484, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:7211's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:7515/:7528, dungeonContext.js:6535/:6535 and
  // worldModes.js:10482-10483 - three copies, one law, carried verbatim.
