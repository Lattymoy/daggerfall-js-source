...
// existed (worldModes.js named `world.js:5337` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8539 and dungeonContext.js:5647, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5132's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5364/:5377, dungeonContext.js:5729/:5729 and
  // worldModes.js:8570-8571 - three copies, one law, carried verbatim.
