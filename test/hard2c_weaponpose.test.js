...
// existed (worldModes.js named `world.js:6589` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9830 and dungeonContext.js:6248, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6368's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6656/:6669, dungeonContext.js:6297/:6297 and
  // worldModes.js:9828-9829 - three copies, one law, carried verbatim.
