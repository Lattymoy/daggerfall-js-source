...
// existed (worldModes.js named `world.js:4839` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  ...
  // world.js:4645's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:4837/:4850, dungeonContext.js:5602/:5608 and
