...
// existed (worldModes.js named `world.js:4851` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:8340 and dungeonContext.js:5545, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:4655's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:4849/:4862, dungeonContext.js:5637/:5643 and
  // worldModes.js:8371-8372 - three copies, one law, carried verbatim.
