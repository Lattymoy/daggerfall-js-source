...
// existed (worldModes.js named `world.js:6699` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9867 and dungeonContext.js:6269, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:6478's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:6766/:6779, dungeonContext.js:6318/:6318 and
  // worldModes.js:9865-9866 - three copies, one law, carried verbatim.
