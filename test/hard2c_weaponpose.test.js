...
// existed (worldModes.js named `world.js:5602` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9253 and dungeonContext.js:6050, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5396's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5629/:5642, dungeonContext.js:6100/:6100 and
  // worldModes.js:9261-9262 - three copies, one law, carried verbatim.
