...
// existed (worldModes.js named `world.js:5793` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9669 and dungeonContext.js:6201, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5587's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5851/:5864, dungeonContext.js:6250/:6250 and
  // worldModes.js:9667-9668 - three copies, one law, carried verbatim.
