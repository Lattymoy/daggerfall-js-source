...
// existed (worldModes.js named `world.js:5899` and `dungeonContext
...
test('HARD2c: the WRITE differential - the old inline arithmetic, carried verbatim', () => {
  // worldModes.js:9698 and dungeonContext.js:6221, character for
  // character as they stood before this slice.
  const oldCompose = (w) => ({ weaponDrawn: !w.sheathed, usingRightHand: w.usingRightHand });
  // world.js:5691's own, which is the MERGE - `wp` is the mode host's
...
test('HARD2c: the RESTORE differential - all three copies were the same law', () => {
  // world.js:5961/:5974, dungeonContext.js:6270/:6270 and
  // worldModes.js:9696-9697 - three copies, one law, carried verbatim.
