...
test('world: MAGEAA00 flats pinned', { skip: skipReal }, () => {
  ...
  // AUDIT 64 F12: every misc flat carries the editor stamp; a light (210)
  // is not an editor flat (199).
  assert.deepEqual(flats[0], { archive: 210, record: 29, editor: false, x: 84.325, y: -0.05, z: 43.45, factionID: 0, flags: 0, recordPosition: 48535, rawX: 3373, rawY: -4, rawZ: -2358 });
  const byArchive = {};
