...
documented absence - `worldModes.js:287` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:344-356`,
...
response." (`worldModes.js:833`). Again the engine is complete - only
