...
documented absence - `worldModes.js:275` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:330-342`,
...
response." (`worldModes.js:793`). Again the engine is complete - only
