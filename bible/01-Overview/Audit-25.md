...
documented absence - `worldModes.js:320` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:379-391`,
...
response." (`worldModes.js:894`). Again the engine is complete - only
