...
documented absence - `worldModes.js:248` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:302-314`,
...
response." (`worldModes.js:702`). Again the engine is complete - only
