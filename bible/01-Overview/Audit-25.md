...
documented absence - `worldModes.js:244` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:298-310`,
...
response." (`worldModes.js:647`). Again the engine is complete - only
