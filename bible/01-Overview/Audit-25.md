...
documented absence - `worldModes.js:247` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:301-313`,
...
response." (`worldModes.js:650`). Again the engine is complete - only
