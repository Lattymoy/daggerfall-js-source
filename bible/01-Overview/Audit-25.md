...
documented absence - `worldModes.js:285` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:340-352`,
...
response." (`worldModes.js:829`). Again the engine is complete - only
