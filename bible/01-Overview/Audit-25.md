...
documented absence - `worldModes.js:266` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:320-332`,
...
response." (`worldModes.js:776`). Again the engine is complete - only
