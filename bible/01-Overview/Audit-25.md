...
documented absence - `worldModes.js:273` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:328-340`,
...
response." (`worldModes.js:798`). Again the engine is complete - only
