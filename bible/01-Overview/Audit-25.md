...
documented absence - `worldModes.js:298` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:357-369`,
...
response." (`worldModes.js:840`). Again the engine is complete - only
