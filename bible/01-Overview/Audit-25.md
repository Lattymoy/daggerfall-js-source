...
documented absence - `worldModes.js:259` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:313-325`,
...
response." (`worldModes.js:732`). Again the engine is complete - only
