...
documented absence - `worldModes.js:261` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:315-327`,
...
response." (`worldModes.js:737`). Again the engine is complete - only
