...
documented absence - `worldModes.js:260` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:314-326`,
...
response." (`worldModes.js:723`). Again the engine is complete - only
