...
documented absence - `worldModes.js:250` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:304-316`,
...
response." (`worldModes.js:715`). Again the engine is complete - only
