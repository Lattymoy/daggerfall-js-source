...
documented absence - `worldModes.js:246` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:300-312`,
...
response." (`worldModes.js:649`). Again the engine is complete - only
