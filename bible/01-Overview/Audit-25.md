...
documented absence - `worldModes.js:293` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:348-360`,
...
response." (`worldModes.js:856`). Again the engine is complete - only
