...
documented absence - `worldModes.js:265` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:319-331`,
...
response." (`worldModes.js:775`). Again the engine is complete - only
