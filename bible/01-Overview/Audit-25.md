...
documented absence - `worldModes.js:270` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:324-336`,
...
response." (`worldModes.js:780`). Again the engine is complete - only
