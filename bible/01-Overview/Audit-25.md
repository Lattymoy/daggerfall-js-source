...
documented absence - `worldModes.js:326` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:385-397`,
...
response." (`worldModes.js:900`). Again the engine is complete - only
...
which have no classic key). `applySpell` (`effects.js:472-827`) lands
