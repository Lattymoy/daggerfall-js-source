...
documented absence - `worldModes.js:267` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:321-333`,
...
response." (`worldModes.js:777`). Again the engine is complete - only
