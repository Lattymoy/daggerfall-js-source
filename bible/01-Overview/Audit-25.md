...
documented absence - `worldModes.js:255` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:309-321`,
...
response." (`worldModes.js:718`). Again the engine is complete - only
