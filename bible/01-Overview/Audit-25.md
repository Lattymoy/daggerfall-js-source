...
documented absence - `worldModes.js:306` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:365-377`,
...
response." (`worldModes.js:859`). Again the engine is complete - only
