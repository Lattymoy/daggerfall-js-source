...
documented absence - `worldModes.js:319` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:378-390`,
...
response." (`worldModes.js:893`). Again the engine is complete - only
