...
documented absence - `worldModes.js:322` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:381-393`,
...
response." (`worldModes.js:896`). Again the engine is complete - only
