...
documented absence - `worldModes.js:327` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:386-398`,
...
response." (`worldModes.js:901`). Again the engine is complete - only
