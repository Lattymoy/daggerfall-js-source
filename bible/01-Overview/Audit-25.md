...
documented absence - `worldModes.js:249` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:303-315`,
...
response." (`worldModes.js:703`). Again the engine is complete - only
