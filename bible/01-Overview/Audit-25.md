...
documented absence - `worldModes.js:274` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:329-341`,
...
response." (`worldModes.js:799`). Again the engine is complete - only
