...
documented absence - `worldModes.js:318` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:377-389`,
...
response." (`worldModes.js:892`). Again the engine is complete - only
