...
documented absence - `worldModes.js:281` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:336-348`,
...
response." (`worldModes.js:818`). Again the engine is complete - only
