...
documented absence - `worldModes.js:279` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:334-346`,
...
response." (`worldModes.js:797`). Again the engine is complete - only
