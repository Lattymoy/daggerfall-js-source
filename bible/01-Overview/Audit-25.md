...
documented absence - `worldModes.js:256` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:310-322`,
...
response." (`worldModes.js:719`). Again the engine is complete - only
