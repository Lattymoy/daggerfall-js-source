...
documented absence - `worldModes.js:245` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:299-311`,
...
response." (`worldModes.js:648`). Again the engine is complete - only
