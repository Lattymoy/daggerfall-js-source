...
documented absence - `worldModes.js:314` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:373-385`,
...
response." (`worldModes.js:885`). Again the engine is complete - only
