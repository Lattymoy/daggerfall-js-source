...
documented absence - `worldModes.js:299` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:358-370`,
...
response." (`worldModes.js:841`). Again the engine is complete - only
