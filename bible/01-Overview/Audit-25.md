...
documented absence - `worldModes.js:282` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:337-349`,
...
response." (`worldModes.js:819`). Again the engine is complete - only
