...
documented absence - `worldModes.js:294` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:351-363`,
...
response." (`worldModes.js:834`). Again the engine is complete - only
...
which have no classic key). `applySpell` (`effects.js:469-815`) lands
