...
documented absence - `worldModes.js:254` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:308-320`,
...
response." (`worldModes.js:717`). Again the engine is complete - only
