...
documented absence - `worldModes.js:317` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:376-388`,
...
response." (`worldModes.js:891`). Again the engine is complete - only
