...
documented absence - `worldModes.js:262` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:316-328`,
...
response." (`worldModes.js:725`). Again the engine is complete - only
