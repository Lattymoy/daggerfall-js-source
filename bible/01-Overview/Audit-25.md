...
documented absence - `worldModes.js:251` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:305-317`,
...
response." (`worldModes.js:714`). Again the engine is complete - only
