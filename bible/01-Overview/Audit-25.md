...
documented absence - `worldModes.js:263` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:317-329`,
...
response." (`worldModes.js:770`). Again the engine is complete - only
