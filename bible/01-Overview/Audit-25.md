...
documented absence - `worldModes.js:264` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:318-330`,
...
response." (`worldModes.js:771`). Again the engine is complete - only
