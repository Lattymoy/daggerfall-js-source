...
documented absence - `worldModes.js:313` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:372-384`,
...
response." (`worldModes.js:883`). Again the engine is complete - only
