...
documented absence - `worldModes.js:284` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:339-351`,
...
response." (`worldModes.js:828`). Again the engine is complete - only
