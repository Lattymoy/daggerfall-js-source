...
documented absence - `worldModes.js:292` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:349-361`,
...
response." (`worldModes.js:832`). Again the engine is complete - only
