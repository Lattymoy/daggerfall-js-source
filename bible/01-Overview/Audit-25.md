...
documented absence - `worldModes.js:253` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:307-319`,
...
response." (`worldModes.js:716`). Again the engine is complete - only
