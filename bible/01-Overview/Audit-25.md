...
documented absence - `worldModes.js:269` "standFoe is absent",
...
(IsPlayerHere). The interior adapter ships (`worldModes.js:323-335`,
...
response." (`worldModes.js:779`). Again the engine is complete - only
