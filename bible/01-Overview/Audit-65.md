...
- `TextProvider.GetSkillSummary` (`TextProvider.cs:489-529`) formats
  ...
  number (`enhancedMenu.js:2067-2068`) - correctly, since the attribute
...
spell), and two escaped-regex cites in tests (`dungeon\.js:487`,
`worldModes\.js:557`), which the mapper cannot see - the CS1 edge AUDIT
