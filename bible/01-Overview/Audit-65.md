...
- `TextProvider.GetSkillSummary` (`TextProvider.cs:489-529`) formats
  ...
  number (`enhancedMenu.js:2080-2081`) - correctly, since the attribute
...
spell), and two escaped-regex cites in tests (`dungeon\.js:531`,
`worldModes\.js:559`), which the mapper cannot see - the CS1 edge AUDIT
