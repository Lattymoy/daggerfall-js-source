...
- **SL-1** `restoreWeather` lowered `_evolveHour` but not
  ...
  `weatherSim.js:476`; no envelope change. The CLK4 pin stayed green
...
- `TextProvider.GetSkillSummary` (`TextProvider.cs:489-529`) formats
  ...
  number (`enhancedMenu.js:2459-2460`) - correctly, since the attribute
...
spell), and two escaped-regex cites in tests (`dungeon\.js:536`,
`worldModes\.js:562`), which the mapper cannot see - the CS1 edge AUDIT
