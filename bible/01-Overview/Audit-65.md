...
- `TextProvider.GetSkillSummary` (`TextProvider.cs:489-529`) formats
  ...
  number (`enhancedMenu.js:1952-1953`) - correctly, since the attribute
...
- `this.standing` and `movingLessThanHalfSpeed` are a port-side CACHE
  ...
  repeated - `worldTick.js:620-621` is climb-first, matching
...
`worldModes\.js:485`), which the mapper cannot see - the CS1 edge AUDIT
