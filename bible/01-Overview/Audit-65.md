...
- `TextProvider.GetSkillSummary` (`TextProvider.cs:489-529`) formats
  ...
  number (`enhancedMenu.js:2432-2433`) - correctly, since the attribute
...
spell), and two escaped-regex cites in tests (`dungeon\.js:507`,
`worldModes\.js:585`), which the mapper cannot see - the CS1 edge AUDIT
