...
- `TextProvider.GetSkillSummary` (`TextProvider.cs:489-529`) formats
  ...
  number (`enhancedMenu.js:1696-1697`) - correctly, since the attribute
...
- `this.standing` and `movingLessThanHalfSpeed` are a port-side CACHE
  ...
  repeated - `worldTick.js:525-526` is climb-first, matching
...
`worldModes\.js:476`), which the mapper cannot see - the CS1 edge AUDIT
