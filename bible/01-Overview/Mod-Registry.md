...
| `roleplay-realism` | manifest, settings, presets, the button index, the string table and the seven scripts (MIT, verbatim); the seven variant-NPC textures, the three quests and the two world-data files are RR2/RR3 | Hazelnut | 1.8 | shipped zip `RoleplayRealism-1.8-16-1-8-1721491697`; behaviour off the author's SOURCE (`ajrb/dfunity-mods` @ `0af2ec9`, `RoleplayRealism/`, the day after the Nexus upload) | code MIT (every script's header) - granted (Mac handed the zip over 2026-09-23) - **RECORD OPEN** | RR1 | 2026-09-23 | `06-Systems/Roleplay-Realism.md` |
