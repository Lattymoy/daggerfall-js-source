...
| `eye-of-the-beholder` | manifest, settings, presets, the per-sprite offsets folded to one table, and all 3035 sprites re-encoded as indexed PNG | RedRoryOTheGlen | 2.1 | shipped `.zip` `Eye_of_the_Beholder-762-2-1-1775438888`; behaviour off the DLL's IL | granted (Mac handed the archive over 2026-09-15) - **RECORD OPEN** | EOTB0-EOTB7, AUDIT-EOTB, AUDIT-EOTB2 (PARTIAL: 29 of 62 methods - 13 off the IL, 16 off the settings' own words; the assembly is NOT in the tree and is what the rest needs; see the page) | 2026-09-16 | `06-Systems/Eye-Of-The-Beholder.md` |
