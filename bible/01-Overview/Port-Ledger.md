...
| ~~OnMonsterHit special attack effects (audit F2 interim)~~ SHIPPED (S18: diseases + the rider table per landed hit; spider/scorpion paralysis pends S19's Paralyze, vampirism/lycanthropy stay routed) | FormulaHelper.OnMonsterHit + DiseaseEffect | Systems arc (disease/poison) |
