...
The modal passes (`worldModes.js:7211` the dungeon, `:7403` the interior)
...
underground. It hands over both layers' batches now (`world.js:12466`). A
...
`:339`), which four files call: `world.js:14424`, `exterior.js:5117`,
`worldModes.js:7204` and `:7301` (the dungeon and the interior passes),
...
calls it at `world.js:14425`, and the modal passes reach it through
`host.drawPeerBodies` (`worldModes.js:7205`, `:7302`). The fix therefore
