...
underground. It hands over both layers' batches now (`world.js:12343`). A
...
`:339`), which four files call: `world.js:14287`, `exterior.js:5097`,
...
calls it at `world.js:14288`, and the modal passes reach it through
...
object-fit: contain (`enhancedStyle.js:3631`). It framed `meshBounds` over
