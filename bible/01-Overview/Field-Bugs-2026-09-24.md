...
The modal passes (`worldModes.js:7267` the dungeon, `:7460` the interior)
...
underground. It hands over both layers' batches now (`world.js:12629`). A
...
`:339`), which four files call: `world.js:14616`, `exterior.js:5117`,
`worldModes.js:7259` and `:7358` (the dungeon and the interior passes),
...
calls it at `world.js:14617`, and the modal passes reach it through
`host.drawPeerBodies` (`worldModes.js:7260`, `:7359`). The fix therefore
