...
The wire was never at fault. `wb` goes out on its edge (`wire.js:1023`),
...
underground. It hands over both layers' batches now (`world.js:12484`). A
...
`:339`), which four files call: `world.js:14443`, `exterior.js:5117`,
...
calls it at `world.js:14444`, and the modal passes reach it through
