...
The modal passes (`worldModes.js:7258` the dungeon, `:7451` the interior)
...
underground. It hands over both layers' batches now (`world.js:12564`). A
...
`:339`), which four files call: `world.js:14544`, `exterior.js:5117`,
`worldModes.js:7250` and `:7349` (the dungeon and the interior passes),
...
calls it at `world.js:14545`, and the modal passes reach it through
`host.drawPeerBodies` (`worldModes.js:7251`, `:7350`). The fix therefore
