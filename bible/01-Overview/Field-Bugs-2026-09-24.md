...
The modal passes (`worldModes.js:7264` the dungeon, `:7457` the interior)
...
underground. It hands over both layers' batches now (`world.js:12610`). A
...
`:339`), which four files call: `world.js:14596`, `exterior.js:5117`,
`worldModes.js:7256` and `:7355` (the dungeon and the interior passes),
...
calls it at `world.js:14597`, and the modal passes reach it through
`host.drawPeerBodies` (`worldModes.js:7257`, `:7356`). The fix therefore
