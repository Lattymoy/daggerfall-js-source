...
underground. It hands over both layers' batches now (`world.js:12439`). A
...
`:339`), which four files call: `world.js:14385`, `exterior.js:5097`,
...
calls it at `world.js:14386`, and the modal passes reach it through
...
object-fit: contain (`enhancedStyle.js:3605`). It framed `meshBounds` over
