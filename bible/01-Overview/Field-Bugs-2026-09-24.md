...
`:339`), which four files call: `world.js:14286`, `exterior.js:5105`,
...
calls it at `world.js:14287`, and the modal passes reach it through
...
object-fit: contain (`enhancedStyle.js:3715`). It framed `meshBounds` over
