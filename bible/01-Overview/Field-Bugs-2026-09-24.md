...
The modal passes (`worldModes.js:7238` the dungeon, `:7431` the interior)
...
underground. It hands over both layers' batches now (`world.js:12541`). A
...
`:339`), which four files call: `world.js:14520`, `exterior.js:5117`,
`worldModes.js:7230` and `:7329` (the dungeon and the interior passes),
...
calls it at `world.js:14521`, and the modal passes reach it through
`host.drawPeerBodies` (`worldModes.js:7231`, `:7330`). The fix therefore
