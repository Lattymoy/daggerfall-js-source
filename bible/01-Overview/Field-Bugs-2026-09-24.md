...
The modal passes (`worldModes.js:7773` the dungeon, `:7970` the interior)
...
underground. It hands over both layers' batches now (`world.js:13863`). A
...
`:339`), which four files call: `world.js:15978`, `exterior.js:5123`,
`worldModes.js:7765` and `:7864` (the dungeon and the interior passes),
...
calls it at `world.js:15979`, and the modal passes reach it through
`host.drawPeerBodies` (`worldModes.js:7766`, `:7865`). The fix therefore
...
figure (`enhancedInventory.js:1510`), which is shown in a 110:184 cell with
