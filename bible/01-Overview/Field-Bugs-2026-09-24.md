...
The modal passes (`worldModes.js:7211` the dungeon, `:7404` the interior)
...
underground. It hands over both layers' batches now (`world.js:12482`). A
...
`:339`), which four files call: `world.js:14445`, `exterior.js:5117`,
`worldModes.js:7204` and `:7302` (the dungeon and the interior passes),
...
calls it at `world.js:14446`, and the modal passes reach it through
`host.drawPeerBodies` (`worldModes.js:7205`, `:7303`). The fix therefore
