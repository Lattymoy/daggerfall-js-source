...
underground. It hands over both layers' batches now (`world.js:12647`). A
...
`:339`), which four files call: `world.js:14613`, `exterior.js:5117`,
...
calls it at `world.js:14614`, and the modal passes reach it through
...
object-fit: contain (`enhancedStyle.js:3810`). It framed `meshBounds` over
