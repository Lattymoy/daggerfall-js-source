...
|---|---|---|
| `dungeonContext.js:284` | `new Collider(() => -Infinity)` | floor meshes |
| `interiorContext.js:320` | `new Collider(() => -Infinity)` | floor meshes |
| `exterior.js:516` | `new Collider(() => GROUND_OFFSET * 0.025)` | **`heightAt`** |
| `world.js:994` | `new Collider(heightAt)` | **`heightAt`** |
