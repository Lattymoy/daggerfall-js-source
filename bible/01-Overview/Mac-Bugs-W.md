...
|---|---|---|
| `dungeonContext.js:302` | `new Collider(() => -Infinity)` | floor meshes |
| `interiorContext.js:323` | `new Collider(() => -Infinity)` | floor meshes |
| `exterior.js:563` | `new Collider(() => GROUND_OFFSET * 0.025)` | **`heightAt`** |
| `world.js:1367` | `new Collider(heightAt)` | **`heightAt`** |
