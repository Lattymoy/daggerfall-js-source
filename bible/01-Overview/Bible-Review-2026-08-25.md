...
- `src/ui/deathScreen.js:42-43` claims "`drop` is read by each host's
  frame" - no host reads it (the Ledger row `:371` is right, the
  comment is wrong).
...
`Port-Ledger.md:472` (save.js:28/:465/:474 → :28/:491/:521), `:473`
(world.js:1926 → :2409); `Quest-Arc.md:719`/`:2905`
(worldModes.js:475 → :903); `Player-Arc.md:955` (worldModes.js:620 →
