...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1441-1452` opens the real talk window.
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:5585-5586` routes them). UI-Arc carries no records
...
`Port-Ledger.md:567` (save.js:32/:556/:565 → :28/:615/:645), `:595`
(world.js:3132 → :2412); `Quest-Arc.md:719`/`:2906`
(worldModes.js:589 → :903); `Player-Arc.md:955` (worldModes.js:849 →
