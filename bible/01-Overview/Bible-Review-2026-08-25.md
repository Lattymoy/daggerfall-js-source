...
(`dungeonContext.js:2350`). This is the one page whose live-queue
...
- `src/ui/deathScreen.js:42-43` claims "`drop` is read by each host's
  frame" - no host reads it (the Ledger row `:413` is right, the
  comment is wrong).
...
`Port-Ledger.md:512` (save.js:29/:505/:514 → :28/:531/:561), `:523`
...
(interiorContext.js:205 → :199); `Rendering.md:70`
