...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1434-1445` opens the real talk window.
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:5505-5506` routes them). UI-Arc carries no records
...
`Port-Ledger.md:566` (save.js:32/:554/:563 → :28/:612/:642), `:593`
(world.js:3132 → :2412); `Quest-Arc.md:719`/`:2906`
(worldModes.js:585 → :903); `Player-Arc.md:955` (worldModes.js:842 →
...
(interiorContext.js:207 → :199); `Rendering.md:121`
