...
(`dungeonContext.js:2315`). This is the one page whose live-queue
...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1235-1246` opens the real talk window.
...
- *Systems-Arc*: `:1445-1454` (S27) "Open and Lock are still not
  ...
  foes, `dungeonContext.js:694-753`); the mid-file Queue
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:4279-4280` routes them). UI-Arc carries no records
...
`Port-Ledger.md:508` (save.js:29/:473/:482 → :28/:499/:529), `:491`
(world.js:1983 → :2412); `Quest-Arc.md:719`/`:2905`
(worldModes.js:480 → :903); `Player-Arc.md:955` (worldModes.js:685 →
