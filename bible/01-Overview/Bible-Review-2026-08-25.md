...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1304-1315` opens the real talk window.
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:4379-4380` routes them). UI-Arc carries no records
...
(CHAR_PIXEL "7" - `renderer.js:611` ships 9, and the doc missed two
