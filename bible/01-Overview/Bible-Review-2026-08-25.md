...
(`dungeonContext.js:2320`). This is the one page whose live-queue
...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1240-1251` opens the real talk window.
...
- *Systems-Arc*: `:1445-1454` (S27) "Open and Lock are still not
  ...
  foes, `dungeonContext.js:696-755`); the mid-file Queue
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:4284-4285` routes them). UI-Arc carries no records
...
- `src/ui/deathScreen.js:42-43` claims "`drop` is read by each host's
  frame" - no host reads it (the Ledger row `:411` is right, the
  comment is wrong).
...
`Port-Ledger.md:510` (save.js:29/:504/:513 → :28/:530/:560), `:522`
(world.js:2007 → :2412); `Quest-Arc.md:719`/`:2905`
(worldModes.js:485 → :903); `Player-Arc.md:955` (worldModes.js:690 →
:2764), `:304` (world.js "531 lines" → 3,564); `Characters-Arc.md:190`
(CHAR_PIXEL "7" - `renderer.js:479` ships 9, and the doc missed two
later revisions recorded in `paperdollViewer.js:138`), `:2114`
(interiorContext.js:205 → :199); `Rendering.md:65`
