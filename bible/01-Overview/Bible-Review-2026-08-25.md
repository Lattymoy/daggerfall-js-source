...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1237-1248` opens the real talk window.
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:4281-4282` routes them). UI-Arc carries no records
...
(world.js:1996 → :2412); `Quest-Arc.md:719`/`:2905`
(worldModes.js:482 → :903); `Player-Arc.md:955` (worldModes.js:687 →
:2764), `:304` (world.js "531 lines" → 3,564); `Characters-Arc.md:190`
(CHAR_PIXEL "7" - `renderer.js:470` ships 9, and the doc missed two
