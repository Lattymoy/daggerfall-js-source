...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:4293-4294` routes them). UI-Arc carries no records
...
- `src/ui/deathScreen.js:42-43` claims "`drop` is read by each host's
  frame" - no host reads it (the Ledger row `:420` is right, the
  comment is wrong).
...
`Port-Ledger.md:522` (save.js:29/:506/:515 → :28/:532/:562), `:524`
(world.js:2064 → :2412); `Quest-Arc.md:719`/`:2905`
