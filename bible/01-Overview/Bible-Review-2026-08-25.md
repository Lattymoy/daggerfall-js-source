...
(`dungeonContext.js:2663`). This is the one page whose live-queue
...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1384-1395` opens the real talk window.
...
- *Systems-Arc*: `:1445-1454` (S27) "Open and Lock are still not
  ...
  foes, `dungeonContext.js:817-868`); the mid-file Queue
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:5287-5288` routes them). UI-Arc carries no records
...
- `src/ui/deathScreen.js:87-88` claims "`drop` is read by each host's
  frame" - no host reads it (the Ledger row `:480` is right, the
  comment is wrong).
...
`Port-Ledger.md:576` (save.js:32/:549/:558 → :28/:607/:637), `:589`
(world.js:3119 → :2412); `Quest-Arc.md:719`/`:2906`
(worldModes.js:569 → :903); `Player-Arc.md:955` (worldModes.js:797 →
:2764), `:304` (world.js "531 lines" → 3,564); `Characters-Arc.md:190`
(CHAR_PIXEL "7" - `renderer.js:587` ships 9, and the doc missed two
later revisions recorded in `paperdollViewer.js:138`), `:2114`
(interiorContext.js:206 → :199); `Rendering.md:123`
