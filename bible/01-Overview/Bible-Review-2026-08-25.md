...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1249-1260` opens the real talk window.
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:4307-4308` routes them). UI-Arc carries no records
...
(worldModes.js:496 → :903); `Player-Arc.md:955` (worldModes.js:699 →
