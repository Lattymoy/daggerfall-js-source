...
(`dungeonContext.js:2705`). This is the one page whose live-queue
...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1449-1460` opens the real talk window.
...
- *Systems-Arc*: `:1445-1454` (S27) "Open and Lock are still not
  ...
  foes, `dungeonContext.js:841-892`); the mid-file Queue
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:5601-5602` routes them). UI-Arc carries no records
...
- `src/ui/deathScreen.js:87-88` claims "`drop` is read by each host's
  frame" - no host reads it (the Ledger row `:493` is right, the
  comment is wrong).
...
`Port-Ledger.md:589` (save.js:32/:556/:565 → :28/:615/:645), `:596`
(world.js:3962 → :2412); `Quest-Arc.md:719`/`:2906`
(worldModes.js:597 → :903); `Player-Arc.md:955` (worldModes.js:857 →
:2764), `:304` (world.js "531 lines" → 3,564); `Characters-Arc.md:190`
(CHAR_PIXEL "7" - `renderer.js:605` ships 9, and the doc missed two
