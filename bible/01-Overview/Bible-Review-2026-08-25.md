...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1246-1257` opens the real talk window.
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:4304-4305` routes them). UI-Arc carries no records
...
(world.js:2209 → :2412); `Quest-Arc.md:719`/`:2905`
(worldModes.js:493 → :903); `Player-Arc.md:955` (worldModes.js:696 →
