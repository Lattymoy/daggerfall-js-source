...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1440-1451` opens the real talk window.
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:5550-5551` routes them). UI-Arc carries no records
...
(worldModes.js:588 → :903); `Player-Arc.md:955` (worldModes.js:848 →
