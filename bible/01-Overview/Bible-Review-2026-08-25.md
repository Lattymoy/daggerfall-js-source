...
(`dungeonContext.js:2706`). This is the one page whose live-queue
...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1450-1461` opens the real talk window.
...
- *Systems-Arc*: `:1445-1454` (S27) "Open and Lock are still not
  ...
  foes, `dungeonContext.js:842-893`); the mid-file Queue
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:5640-5641` routes them). UI-Arc carries no records
...
(world.js:3738 → :2412); `Quest-Arc.md:719`/`:2906`
(worldModes.js:598 → :903); `Player-Arc.md:955` (worldModes.js:858 →
