...
(`dungeonContext.js:2418`). This is the one page whose live-queue
...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1291-1302` opens the real talk window.
...
- *Systems-Arc*: `:1445-1454` (S27) "Open and Lock are still not
  ...
  foes, `dungeonContext.js:717-776`); the mid-file Queue
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:4349-4350` routes them). UI-Arc carries no records
...
(world.js:2348 → :2412); `Quest-Arc.md:719`/`:2905`
(worldModes.js:511 → :903); `Player-Arc.md:955` (worldModes.js:729 →
