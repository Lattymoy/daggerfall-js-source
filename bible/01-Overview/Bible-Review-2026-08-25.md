...
(`dungeonContext.js:2396`). This is the one page whose live-queue
...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1258-1269` opens the real talk window.
...
- *Systems-Arc*: `:1445-1454` (S27) "Open and Lock are still not
  ...
  foes, `dungeonContext.js:707-766`); the mid-file Queue
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:4316-4317` routes them). UI-Arc carries no records
...
`Port-Ledger.md:537` (save.js:29/:508/:517 → :28/:537/:567), `:524`
(world.js:2210 → :2412); `Quest-Arc.md:719`/`:2905`
(worldModes.js:505 → :903); `Player-Arc.md:955` (worldModes.js:708 →
