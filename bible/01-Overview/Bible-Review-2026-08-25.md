...
(`dungeonContext.js:2697`). This is the one page whose live-queue
...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1445-1456` opens the real talk window.
...
- *Systems-Arc*: `:1445-1454` (S27) "Open and Lock are still not
  ...
  foes, `dungeonContext.js:837-888`); the mid-file Queue
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:5597-5598` routes them). UI-Arc carries no records
...
`Port-Ledger.md:577` (save.js:32/:556/:565 → :28/:615/:645), `:596`
(world.js:3717 → :2412); `Quest-Arc.md:719`/`:2906`
(worldModes.js:593 → :903); `Player-Arc.md:955` (worldModes.js:853 →
...
(interiorContext.js:207 → :199); `Rendering.md:122`
