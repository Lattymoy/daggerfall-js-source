...
(`dungeonContext.js:2370`). This is the one page whose live-queue
...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1241-1252` opens the real talk window.
...
- *Systems-Arc*: `:1445-1454` (S27) "Open and Lock are still not
  ...
  foes, `dungeonContext.js:697-756`); the mid-file Queue
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:4285-4286` routes them). UI-Arc carries no records
...
- `src/ui/deathScreen.js:42-43` claims "`drop` is read by each host's
  frame" - no host reads it (the Ledger row `:414` is right, the
  comment is wrong).
...
`Port-Ledger.md:513` (save.js:29/:505/:514 → :28/:531/:561), `:523`
(world.js:2038 → :2412); `Quest-Arc.md:719`/`:2905`
(worldModes.js:486 → :903); `Player-Arc.md:955` (worldModes.js:691 →
:2764), `:304` (world.js "531 lines" → 3,564); `Characters-Arc.md:190`
(CHAR_PIXEL "7" - `renderer.js:480` ships 9, and the doc missed two
