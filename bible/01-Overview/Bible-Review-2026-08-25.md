...
(`dungeonContext.js:2251`). This is the one page whose live-queue
...
- `src/ui/deathScreen.js:42-43` claims "`drop` is read by each host's
  frame" - no host reads it (the Ledger row `:366` is right, the
  comment is wrong).
...
`Port-Ledger.md:467` (save.js:28/:465/:474 → :28/:491/:521), `:471`
(world.js:1898 → :2409); `Quest-Arc.md:719`/`:2925`
