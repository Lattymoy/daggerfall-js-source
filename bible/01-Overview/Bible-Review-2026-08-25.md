...
(`dungeonContext.js:2344`). This is the one page whose live-queue
...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1238-1249` opens the real talk window.
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:4282-4283` routes them). UI-Arc carries no records
...
- `src/ui/deathScreen.js:42-43` claims "`drop` is read by each host's
  frame" - no host reads it (the Ledger row `:410` is right, the
  comment is wrong).
...
`Port-Ledger.md:509` (save.js:29/:505/:514 → :28/:531/:561), `:523`
(world.js:2001 → :2412); `Quest-Arc.md:719`/`:2905`
(worldModes.js:483 → :903); `Player-Arc.md:955` (worldModes.js:688 →
:2764), `:304` (world.js "531 lines" → 3,564); `Characters-Arc.md:190`
(CHAR_PIXEL "7" - `renderer.js:474` ships 9, and the doc missed two
later revisions recorded in `paperdollViewer.js:138`), `:2114`
(interiorContext.js:205 → :199); `Rendering.md:45`
