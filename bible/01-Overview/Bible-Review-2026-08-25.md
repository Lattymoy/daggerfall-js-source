...
(`dungeonContext.js:2310`). This is the one page whose live-queue
...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1225-1236` opens the real talk window.
...
- *Systems-Arc*: `:1445-1454` (S27) "Open and Lock are still not
  ...
  foes, `dungeonContext.js:685-745`); the mid-file Queue
...
(world.js:1934 → :2412); `Quest-Arc.md:719`/`:2905`
(worldModes.js:477 → :903); `Player-Arc.md:955` (worldModes.js:673 →
