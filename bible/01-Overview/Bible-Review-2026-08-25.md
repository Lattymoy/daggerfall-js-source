...
(`dungeonContext.js:2540`). This is the one page whose live-queue
...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1311-1322` opens the real talk window.
...
- *Systems-Arc*: `:1445-1454` (S27) "Open and Lock are still not
  ...
  foes, `dungeonContext.js:756-815`); the mid-file Queue
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:4386-4387` routes them). UI-Arc carries no records
...
`Port-Ledger.md:538` (save.js:29/:525/:534 → :28/:558/:588), `:545`
(world.js:2416 → :2412); `Quest-Arc.md:719`/`:2906`
(worldModes.js:528 → :903); `Player-Arc.md:955` (worldModes.js:749 →
