...
(`dungeonContext.js:2423`). This is the one page whose live-queue
...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1297-1308` opens the real talk window.
...
- *Systems-Arc*: `:1445-1454` (S27) "Open and Lock are still not
  ...
  foes, `dungeonContext.js:722-781`); the mid-file Queue
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:4361-4362` routes them). UI-Arc carries no records
...
(world.js:2351 → :2412); `Quest-Arc.md:719`/`:2905`
(worldModes.js:514 → :903); `Player-Arc.md:955` (worldModes.js:735 →
