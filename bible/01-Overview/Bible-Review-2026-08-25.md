...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1226-1237` opens the real talk window.
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:4261-4262` routes them). UI-Arc carries no records
...
`Port-Ledger.md:494` (save.js:28/:472/:481 → :28/:498/:528), `:490`
(world.js:1948 → :2412); `Quest-Arc.md:719`/`:2905`
(worldModes.js:478 → :903); `Player-Arc.md:955` (worldModes.js:676 →
