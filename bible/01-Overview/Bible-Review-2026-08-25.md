...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1253-1264` opens the real talk window.
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:4297-4298` routes them). UI-Arc carries no records
...
`Port-Ledger.md:511` (save.js:29/:521/:530 → :28/:547/:577), `:539`
(world.js:2008 → :2412); `Quest-Arc.md:719`/`:2905`
(worldModes.js:498 → :903); `Player-Arc.md:955` (worldModes.js:703 →
