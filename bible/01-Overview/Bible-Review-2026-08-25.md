...
(`dungeonContext.js:2582`). This is the one page whose live-queue
...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1352-1363` opens the real talk window.
...
- *Systems-Arc*: `:1445-1454` (S27) "Open and Lock are still not
  ...
  foes, `dungeonContext.js:790-849`); the mid-file Queue
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:5155-5156` routes them). UI-Arc carries no records
...
- `src/ui/deathScreen.js:42-43` claims "`drop` is read by each host's
  frame" - no host reads it (the Ledger row `:444` is right, the
  comment is wrong).
...
`Port-Ledger.md:540` (save.js:29/:528/:537 → :28/:574/:604), `:561`
(world.js:2482 → :2412); `Quest-Arc.md:719`/`:2906`
(worldModes.js:554 → :903); `Player-Arc.md:955` (worldModes.js:782 →
:2764), `:304` (world.js "531 lines" → 3,564); `Characters-Arc.md:190`
(CHAR_PIXEL "7" - `renderer.js:614` ships 9, and the doc missed two
