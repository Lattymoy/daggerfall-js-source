...
- `src/ui/deathScreen.js:87-88` claims "`drop` is read by each host's
  frame" - no host reads it (the Ledger row `:482` is right, the
  comment is wrong).
...
`Port-Ledger.md:578` (save.js:32/:549/:558 → :28/:607/:637), `:589`
(world.js:3121 → :2412); `Quest-Arc.md:719`/`:2906`
...
(interiorContext.js:206 → :199); `Rendering.md:124`
