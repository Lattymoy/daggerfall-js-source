...
(`dungeonContext.js:2635`). This is the one page whose live-queue
...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1369-1380` opens the real talk window.
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:5273-5274` routes them). UI-Arc carries no records
...
(world.js:3062 → :2412); `Quest-Arc.md:719`/`:2906`
