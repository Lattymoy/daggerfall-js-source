...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1303-1314` opens the real talk window.
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:4378-4379` routes them). UI-Arc carries no records
...
`Port-Ledger.md:537` (save.js:29/:524/:533 → :28/:557/:587), `:544`
(world.js:2412 → :2412); `Quest-Arc.md:719`/`:2906`
(worldModes.js:520 → :903); `Player-Arc.md:955` (worldModes.js:741 →
