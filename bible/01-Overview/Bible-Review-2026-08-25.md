...
- `:340` residue "a static NPC currently answers with the
  ...
  `:446` (B7); `worldModes.js:1432-1443` opens the real talk window.
...
- *UI-Arc*: a dozen closed flags stand (talk pages B5-6 at
  ...
  (`worldModes.js:5489-5490` routes them). UI-Arc carries no records
...
(worldModes.js:584 → :903); `Player-Arc.md:955` (worldModes.js:840 →
