...
| **sys-sim** | Law line-for-line / clock seam broken | **Near-1:1** | `preventEnemySpawns` is live on the fast-travel path (`world.js:1912`, `:1708`). Ledger row `:579`'s residue list is spent - see list 2. |
...
- **`src/ui/enhancedMenu.js:2278`** - the rest of the keyboard; the
