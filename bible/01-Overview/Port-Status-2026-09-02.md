...
| **sys-sim** | Law line-for-line / clock seam broken | **Near-1:1** | `preventEnemySpawns` is live on the fast-travel path (`world.js:2335`, `:2052`). Ledger row `:622`'s residue list is spent - see list 2. |
...
- ~~**`src/scenes/dungeonContext.js:1947`** - the two window seams this
