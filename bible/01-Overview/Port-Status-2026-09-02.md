...
| **sys-sim** | Law line-for-line / clock seam broken | **Near-1:1** | `preventEnemySpawns` is live on the fast-travel path (`world.js:3073`, `:2781`). Ledger row `:658`'s residue list is spent - see list 2. |
