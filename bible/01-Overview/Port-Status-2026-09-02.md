...
| **sys-sim** | Law line-for-line / clock seam broken | **Near-1:1** | `preventEnemySpawns` is live on the fast-travel path (`world.js:3067`, `:2775`). Ledger row `:648`'s residue list is spent - see list 2. |
...
- ~~**`src/ui/hudLarge.js:75`** - the docked bar occludes, it does not
  ...
  (`render/renderer.js:2233, :2067, :2981, :3304`) and the 2D passes
