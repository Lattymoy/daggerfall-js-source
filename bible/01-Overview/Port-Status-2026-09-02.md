...
| **scenes-world** | Law 1:1 / seams broken | **Near-1:1** | `currentWeatherKey` reads a live getter (`world.js:6272`). Region identity, the quest region/vampire faction seams and `CleanupUntrackedObjects` were the wave; `world.js:3693` carries the sweep and `hostMagic.js:608` its missile half. |
...
- **`src/scenes/exterior.js:1970`** - Recall pends here; the anchor
...
9. **`:579` UseItem's unbuilt destinations.** Every arm the row names is
   ...
   (`ui/nativeInventory.js:778-782`, `scenes/world.js:3793`), the
...
10. **`:629` fast-travel residue.** Its three named survivors are spent:
    ...
    `scenes/world.js:4858` (the arrival clamp anchoring the encounter
