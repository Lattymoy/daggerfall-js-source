...
| **characters-voxel** | Departure (deliberate) | **Departure, still editor-only** | 86 designs across seven tables - 42 of the 43 monster mobiles, 19 class, 25 villager. The rig is 1,791 lines across 7 modules and is still gated: `worldModes.js:5299` passes `voxelfolk`, `scenes/interiorContext.js:577` consumes it. |
...
- ~~**`src/scenes/exterior.js:1943`** - PX3: this test host mounts no
  ...
  site. (The `src/scenes/worldModes.js:2370` row below is struck: ROAD-E
...
- ~~**`src/characters/enemyCasting.js:91`** - now exactly one term
  ...
  second.*
- ~~**`src/scenes/worldModes.js:1970`** - above ground only:
...
(**CLOSED at the ship landing**), ~~`worldModes.js:1933` -> `:1810`~~
...
- ~~**`src/scenes/worldModes.js:2045`** - above ground only: the GUILD
...
- **The voxel character engine** (Mac's system, Port-Doctrine). 86
  ...
  by a game host: `worldModes.js:5609` passes `voxelfolk`,
