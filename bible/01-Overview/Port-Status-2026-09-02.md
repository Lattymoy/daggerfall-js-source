...
9. **`:547` UseItem's unbuilt destinations.** Every arm the row names is
   ...
   (`ui/nativeInventory.js:717-721`, `scenes/world.js:3048`), the
   (`ui/nativeInventory.js:717-721`, `scenes/world.js:2994`), the
...
10. **`:597` fast-travel residue.** Its three named survivors are spent:
    ...
    `scenes/world.js:4048` (the arrival clamp anchoring the encounter
    clock, so the traveled window is not replayed) and `:1966` (the
    `scenes/world.js:3992` (the arrival clamp anchoring the encounter
