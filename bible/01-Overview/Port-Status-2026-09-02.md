...
| **sys-sim** | Law line-for-line / clock seam broken | **Near-1:1** | `preventEnemySpawns` is live on the fast-travel path (`world.js:2324`, `:2041`). Ledger row `:622`'s residue list is spent - see list 2. |
