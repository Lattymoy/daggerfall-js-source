...
| **ui-enhanced** | Departure lane | **Departure lane, scoped** | `ui/worldPlaque.js:205` puts the skin gate above `ensure()`, so the unscoped `*`/`html`/`body`/`button`/`#app` rules never reach the classic page. 9 modules / 8,940 lines. |
