...
| **scenes-world** | Law 1:1 / seams broken | **Near-1:1** | `currentWeatherKey` reads a live getter (`world.js:6228`). Region identity, the quest region/vampire faction seams and `CleanupUntrackedObjects` were the wave; `world.js:3691` carries the sweep and `hostMagic.js:608` its missile half. |
...
- **`src/ui/enhancedMenu.js:2527`** - the rest of the keyboard; the
