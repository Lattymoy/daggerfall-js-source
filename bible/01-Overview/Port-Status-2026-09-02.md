...
| **characters-voxel** | Departure (deliberate) | **Departure, still editor-only** | 86 designs across seven tables - 42 of the 43 monster mobiles, 19 class, 25 villager. The rig is 1,791 lines across 7 modules and is still gated: `worldModes.js:5520` passes `voxelfolk`, `scenes/interiorContext.js:578` consumes it. |
...
- ~~**`src/scenes/exterior.js:1946`** - PX3: this test host mounts no
  ...
  site. (The `src/scenes/worldModes.js:2349` row below is struck: ROAD-E
...
- ~~**`src/characters/enemyCasting.js:91`** - now exactly one term
  ...
  second.*
- ~~**`src/scenes/worldModes.js:1963`** - above ground only:
...
(**CLOSED at the ship landing**), ~~`worldModes.js:1926` -> `:1803`~~
...
- ~~**`src/scenes/worldModes.js:2033`** - above ground only: the GUILD
...
- **The voxel character engine** (Mac's system, Port-Doctrine). 86
  ...
  by a game host: `worldModes.js:5520` passes `voxelfolk`,
