...
| **sys-sim** | Law line-for-line / clock seam broken | **Near-1:1** | `preventEnemySpawns` is live on the fast-travel path (`world.js:1932`, `:1711`). Ledger row `:579`'s residue list is spent - see list 2. |
...
- **`src/ui/enhancedMenu.js:2248`** - the rest of the keyboard; the
...
`Port-Ledger.md` section A carries **117 rows, 14 struck - 103 standing
