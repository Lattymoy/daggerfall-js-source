...
| **sys-sim** | Law line-for-line / clock seam broken | **Near-1:1** | `preventEnemySpawns` is live on the fast-travel path (`world.js:1950`, `:1729`). Ledger row `:591`'s residue list is spent - see list 2. |
