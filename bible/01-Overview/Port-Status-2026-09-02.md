...
| **sys-sim** | Law line-for-line / clock seam broken | **Near-1:1** | `preventEnemySpawns` is live on the fast-travel path (`world.js:2464`, `:2181`). Ledger row `:632`'s residue list is spent - see list 2. |
