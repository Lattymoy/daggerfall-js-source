...
| **sys-sim** | Law line-for-line / clock seam broken | **Near-1:1** | `preventEnemySpawns` is live on the fast-travel path (`world.js:2002`, `:1762`). Ledger row `:610`'s residue list is spent - see list 2. |
