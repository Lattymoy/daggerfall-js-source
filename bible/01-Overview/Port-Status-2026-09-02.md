...
| **scenes-world** | Law 1:1 / seams broken | **Near-1:1** | `currentWeatherKey` reads a live getter (`world.js:6192`). Region identity, the quest region/vampire faction seams and `CleanupUntrackedObjects` were the wave; `world.js:3669` carries the sweep and `hostMagic.js:608` its missile half. |
...
10. **`:623` fast-travel residue.** Its three named survivors are spent:
    ...
    `scenes/world.js:4806` (the arrival clamp anchoring the encounter
