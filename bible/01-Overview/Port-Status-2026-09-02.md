...
| **sys-sim** | Law line-for-line / clock seam broken | **Near-1:1** | `preventEnemySpawns` is live on the fast-travel path (`world.js:3164`, `:2872`). Ledger row `:661`'s residue list is spent - see list 2. |
...
10. **`:661` fast-travel residue.** Its three named survivors are spent:
    ...
    `scenes/world.js:4000` (the arrival clamp anchoring the encounter
