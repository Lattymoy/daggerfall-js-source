...
- **`src/ui/enhancedMenu.js:3321`** - the rest of the keyboard; the
...
- ~~**`src/ui/hudLarge.js:75`** - the docked bar occludes, it does not
  ...
  (`render/renderer.js:2331, :2058, :3069, :3394`) and the 2D passes
