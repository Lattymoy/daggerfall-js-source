...
| **scenes-world** | Law 1:1 / seams broken | **Near-1:1** | `currentWeatherKey` reads a live getter (`world.js:4867`). Region identity, the quest region/vampire faction seams and `CleanupUntrackedObjects` were the wave; `world.js:2879` carries the sweep and `hostMagic.js:601` its missile half. |
...
9. **`:529` UseItem's unbuilt destinations.** Every arm the row names is
   ...
   (`ui/nativeInventory.js:703-707`, `scenes/world.js:2928`), the
   (`ui/nativeInventory.js:703-707`, `scenes/world.js:2874`), the
...
10. **`:579` fast-travel residue.** Its three named survivors are spent:
    ...
    `scenes/world.js:3893` (the arrival clamp anchoring the encounter
