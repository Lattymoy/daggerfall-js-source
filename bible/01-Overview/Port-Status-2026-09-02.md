...
| **sys-sim** | Law line-for-line / clock seam broken | **Near-1:1** | `preventEnemySpawns` is live on the fast-travel path (`world.js:1949`, `:1728`). Ledger row `:590`'s residue list is spent - see list 2. |
