...
| **scenes-world** | Law 1:1 / seams broken | **Near-1:1** | `currentWeatherKey` reads a live getter (`world.js:4879`). Region identity, the quest region/vampire faction seams and `CleanupUntrackedObjects` were the wave; `world.js:2891` carries the sweep and `hostMagic.js:601` its missile half. |
...
- ~~**`src/scenes/world.js:3136`** - the port's default landing stands
...
Quests tab has a machine to read), ~~`world.js:3182` -> `:2988`~~
...
9. **`:529` UseItem's unbuilt destinations.** Every arm the row names is
   ...
   (`ui/nativeInventory.js:703-707`, `scenes/world.js:2940`), the
   (`ui/nativeInventory.js:703-707`, `scenes/world.js:2886`), the
