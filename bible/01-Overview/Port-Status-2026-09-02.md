...
| **sys-sim** | Law line-for-line / clock seam broken | **Near-1:1** | `preventEnemySpawns` is live on the fast-travel path (`world.js:1636`, `:1667`). Ledger row `:546`'s residue list is spent - see list 2. |
...
`:2934`, ~~`worldModes.js:1659` -> `:1687`~~ (**CLOSED at ROAD-F GS1**,
