...
(`scenes/world.js:3610`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:1967`) with the
...
(`scenes/dungeonContext.js:1940`, the standalone dungeon host's two
