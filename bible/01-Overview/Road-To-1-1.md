...
(`scenes/world.js:3577`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:1908`) with the
...
(`scenes/dungeonContext.js:1894`, the standalone dungeon host's two
