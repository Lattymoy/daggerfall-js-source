...
(`scenes/world.js:5811`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2349`) with the
...
(`scenes/dungeonContext.js:2262`, the standalone dungeon host's two
