...
(`scenes/world.js:3966`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:1991`) with the
...
(`scenes/dungeonContext.js:1999`, the standalone dungeon host's two
