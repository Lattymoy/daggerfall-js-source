...
(`scenes/world.js:4592`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2069`) with the
...
(`scenes/dungeonContext.js:2154`, the standalone dungeon host's two
