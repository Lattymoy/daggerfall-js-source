...
(`scenes/world.js:3850`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:1993`) with the
...
(`scenes/dungeonContext.js:1998`, the standalone dungeon host's two
