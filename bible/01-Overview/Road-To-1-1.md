...
(`scenes/world.js:5692`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2340`) with the
...
(`scenes/dungeonContext.js:2260`, the standalone dungeon host's two
