...
(`scenes/world.js:5751`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2416`) with the
...
(`scenes/dungeonContext.js:2266`, the standalone dungeon host's two
