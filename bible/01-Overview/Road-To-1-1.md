...
(`scenes/world.js:3780`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:1992`) with the
...
(`scenes/dungeonContext.js:1948`, the standalone dungeon host's two
