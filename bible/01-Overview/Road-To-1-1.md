...
(`scenes/world.js:4577`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2072`) with the
...
(`scenes/dungeonContext.js:2164`, the standalone dungeon host's two
