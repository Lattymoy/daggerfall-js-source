...
(`scenes/world.js:4536`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2060`) with the
...
(`scenes/dungeonContext.js:2069`, the standalone dungeon host's two
