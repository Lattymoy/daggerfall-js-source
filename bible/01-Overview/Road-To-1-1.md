...
(`scenes/world.js:4581`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2063`) with the
...
(`scenes/dungeonContext.js:2107`, the standalone dungeon host's two
