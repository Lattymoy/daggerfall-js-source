...
(`scenes/world.js:4764`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2277`) with the
...
(`scenes/dungeonContext.js:2168`, the standalone dungeon host's two
