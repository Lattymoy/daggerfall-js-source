...
(`scenes/world.js:4738`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2304`) with the
...
(`scenes/dungeonContext.js:2169`, the standalone dungeon host's two
