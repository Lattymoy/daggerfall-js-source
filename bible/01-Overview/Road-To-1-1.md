...
(`scenes/world.js:4535`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2053`) with the
...
(`scenes/dungeonContext.js:2068`, the standalone dungeon host's two
