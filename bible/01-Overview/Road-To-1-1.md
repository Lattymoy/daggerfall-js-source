...
(`scenes/world.js:4426`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2043`) with the
...
(`scenes/dungeonContext.js:2046`, the standalone dungeon host's two
