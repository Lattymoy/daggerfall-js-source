...
(`scenes/world.js:4269`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:1998`) with the
...
(`scenes/dungeonContext.js:2018`, the standalone dungeon host's two
