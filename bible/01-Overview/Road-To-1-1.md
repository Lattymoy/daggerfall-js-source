...
(`scenes/world.js:4833`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2281`) with the
...
(`scenes/dungeonContext.js:2204`, the standalone dungeon host's two
