...
(`scenes/world.js:4967`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2292`) with the
...
(`scenes/dungeonContext.js:2235`, the standalone dungeon host's two
