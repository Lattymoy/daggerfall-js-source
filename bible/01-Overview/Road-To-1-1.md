...
(`scenes/world.js:3620`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:1977`) with the
...
(`scenes/dungeonContext.js:1941`, the standalone dungeon host's two
