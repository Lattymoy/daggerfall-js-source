...
(`scenes/world.js:4603`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2078`) with the
...
(`scenes/dungeonContext.js:2165`, the standalone dungeon host's two
