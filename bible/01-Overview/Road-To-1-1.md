...
(`scenes/world.js:3636`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:1976`) with the
...
(`scenes/dungeonContext.js:1927`, the standalone dungeon host's two
