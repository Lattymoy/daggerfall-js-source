...
(`scenes/world.js:5921`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2345`) with the
...
(`scenes/dungeonContext.js:2269`, the standalone dungeon host's two
