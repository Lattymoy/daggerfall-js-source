...
(`scenes/world.js:3990`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:1994`) with the
...
(`scenes/dungeonContext.js:2007`, the standalone dungeon host's two
