...
(`scenes/world.js:3623`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:1978`) with the
...
(`scenes/dungeonContext.js:1926`, the standalone dungeon host's two
