...
(`scenes/world.js:4576`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2062`) with the
...
(`scenes/dungeonContext.js:2090`, the standalone dungeon host's two
