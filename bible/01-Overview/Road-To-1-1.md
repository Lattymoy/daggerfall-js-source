...
(`scenes/world.js:4489`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2044`) with the
...
(`scenes/dungeonContext.js:2048`, the standalone dungeon host's two
