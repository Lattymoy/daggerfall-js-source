...
(`scenes/world.js:5626`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2332`) with the
...
(`scenes/dungeonContext.js:2246`, the standalone dungeon host's two
