...
(`scenes/world.js:4387`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2010`) with the
...
(`scenes/dungeonContext.js:2036`, the standalone dungeon host's two
