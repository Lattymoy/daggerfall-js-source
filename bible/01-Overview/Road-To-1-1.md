...
(`scenes/world.js:6616`, the two ship pixels): the owner supplied the
...
guild-service popup above ground (`scenes/worldModes.js:2434`) with the
...
(`scenes/dungeonContext.js:2307`, the standalone dungeon host's two
