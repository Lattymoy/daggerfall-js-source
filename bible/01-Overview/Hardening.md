...
`dungeonContext.js:5729` - lines that had moved to `:4624` and `:5712`.
...
3. *"`worldModes.js:8322` disposes the dungeon overlay that
   `dungeonCtx.destroy()` disposes again - HARD1's double free."* Already
   known, already written down, at `dungeonContext.js:6388-6389`:
