...
`worldModes.js` that pointed between them cited `world.js:5967` and
`dungeonContext.js:6264` - lines that had moved to `:4914` and `:6239`.
...
3. *"`worldModes.js:9495` disposes the dungeon overlay that
   `dungeonCtx.destroy()` disposes again - HARD1's double free."* Already
   known, already written down, at `dungeonContext.js:7065-7066`:
