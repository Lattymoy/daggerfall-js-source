...
`dungeonContext.js:5995` - lines that had moved to `:4729` and `:5970`.
...
3. *"`worldModes.js:8483` disposes the dungeon overlay that
   `dungeonCtx.destroy()` disposes again - HARD1's double free."* Already
   known, already written down, at `dungeonContext.js:6748-6749`:
