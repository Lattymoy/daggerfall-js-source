...
`dungeonContext.js:5951` - lines that had moved to `:4733` and `:5926`.
...
3. *"`worldModes.js:8438` disposes the dungeon overlay that
   `dungeonCtx.destroy()` disposes again - HARD1's double free."* Already
   known, already written down, at `dungeonContext.js:6680-6681`:
