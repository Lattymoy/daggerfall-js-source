...
`dungeonContext.js:5909` - lines that had moved to `:4724` and `:5884`.
...
3. *"`worldModes.js:8397` disposes the dungeon overlay that
   `dungeonCtx.destroy()` disposes again - HARD1's double free."* Already
   known, already written down, at `dungeonContext.js:6568-6569`:
