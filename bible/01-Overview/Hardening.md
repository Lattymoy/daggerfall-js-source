...
`worldModes.js` that pointed between them cited `world.js:6732` and
`dungeonContext.js:6298` - lines that had moved to `:4946` and `:6273`.
...
3. *"`worldModes.js:9614` disposes the dungeon overlay that
   `dungeonCtx.destroy()` disposes again - HARD1's double free."* Already
   known, already written down, at `dungeonContext.js:7100-7101`:
