...
`dungeonContext.js:5750` - lines that had moved to `:4647` and `:5733`.
...
3. *"`worldModes.js:8311` disposes the dungeon overlay that
   `dungeonCtx.destroy()` disposes again - HARD1's double free."* Already
   known, already written down, at `dungeonContext.js:6409-6410`:
