...
and its `world.js:7649` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:8620`); all
...
`worldModes.js:7277`, `dungeonContext.js:5560`) and pinned as a set.
