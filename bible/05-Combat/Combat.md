...
dungeonContext.js:2010 by tools/fistProbe.mjs), the melee tally on
...
and its `world.js:13398` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:14957`); all
