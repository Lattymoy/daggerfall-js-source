...
dungeonContext.js:1669 by tools/fistProbe.mjs), the melee tally on
...
and its `world.js:7427` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:8398`); all
...
`worldModes.js:7162`, `dungeonContext.js:4950`) and pinned as a set.
