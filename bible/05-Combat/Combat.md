...
and its `world.js:9619` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:10953`); all
...
`worldModes.js:7590`, `dungeonContext.js:5921`) and pinned as a set.
