...
and its `world.js:7656` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:8624`); all
...
`worldModes.js:7275`, `dungeonContext.js:5641`) and pinned as a set.
