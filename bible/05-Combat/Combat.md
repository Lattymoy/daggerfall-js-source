...
and its `world.js:11368` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:12805`); all
...
`worldModes.js:8715`, `dungeonContext.js:6539`) and pinned as a set.
