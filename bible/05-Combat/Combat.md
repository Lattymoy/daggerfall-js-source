...
dungeonContext.js:2012 by tools/fistProbe.mjs), the melee tally on
...
and its `world.js:13352` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:14910`); all
...
`worldModes.js:8899`, `dungeonContext.js:6646`) and pinned as a set.
