...
and its `world.js:7543` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:8514`); all
...
`worldModes.js:7184`, `dungeonContext.js:5450`) and pinned as a set.
