...
and its `world.js:10232` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:11661`); all
...
`worldModes.js:8593`, `dungeonContext.js:6454`) and pinned as a set.
