...
and its `world.js:8666` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:9738`); all
...
`worldModes.js:7476`, `dungeonContext.js:5872`) and pinned as a set.
