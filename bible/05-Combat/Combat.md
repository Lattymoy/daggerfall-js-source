...
and its `world.js:7693` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:8708`); all
...
`worldModes.js:7306`, `dungeonContext.js:5657`) and pinned as a set.
