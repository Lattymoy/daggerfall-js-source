...
and its `world.js:7488` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:8459`); all
...
`worldModes.js:7165`, `dungeonContext.js:4987`) and pinned as a set.
