...
dungeonContext.js:2040 by tools/fistProbe.mjs), the melee tally on
...
and its `world.js:13658` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:15235`); all
...
`worldModes.js:8908`, `dungeonContext.js:6660`) and pinned as a set.
