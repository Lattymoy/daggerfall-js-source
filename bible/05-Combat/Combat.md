...
and its `world.js:7624` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:8595`); all
...
`worldModes.js:7275`, `dungeonContext.js:5537`) and pinned as a set.
