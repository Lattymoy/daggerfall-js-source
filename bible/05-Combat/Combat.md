...
and its `world.js:7647` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:8618`); all
...
`worldModes.js:7275`, `dungeonContext.js:5562`) and pinned as a set.
