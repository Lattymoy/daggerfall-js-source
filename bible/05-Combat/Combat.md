...
dungeonContext.js:2037 by tools/fistProbe.mjs), the melee tally on
...
and its `world.js:13654` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:15222`); all
...
`worldModes.js:8908`, `dungeonContext.js:6657`) and pinned as a set.
