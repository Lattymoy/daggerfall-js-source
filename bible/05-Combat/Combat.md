...
and its `world.js:12952` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:14509`); all
...
`worldModes.js:8893`, `dungeonContext.js:6612`) and pinned as a set.
