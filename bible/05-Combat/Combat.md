...
and its `world.js:7802` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:8818`); all
...
`worldModes.js:7363`, `dungeonContext.js:5722`) and pinned as a set.
