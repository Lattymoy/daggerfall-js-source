...
and its `world.js:12545` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:14060`); all
...
`worldModes.js:8767`, `dungeonContext.js:6563`) and pinned as a set.
