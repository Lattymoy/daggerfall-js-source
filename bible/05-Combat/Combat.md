...
and its `world.js:13887` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:15483`); all
...
`worldModes.js:9409`, `dungeonContext.js:6716`) and pinned as a set.
