...
dungeonContext.js:1715 by tools/fistProbe.mjs), the melee tally on
...
and its `world.js:7641` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:8612`); all
