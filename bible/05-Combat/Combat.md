...
and its `world.js:8196` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:9230`); all
...
`worldModes.js:7388`, `dungeonContext.js:5727`) and pinned as a set.
