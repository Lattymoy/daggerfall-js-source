...
and its `world.js:13343` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:14902`); all
...
`worldModes.js:8899`, `dungeonContext.js:6639`) and pinned as a set.
