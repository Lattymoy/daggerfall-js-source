...
and its `world.js:9851` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:11219`); all
...
`worldModes.js:7716`, `dungeonContext.js:6179`) and pinned as a set.
