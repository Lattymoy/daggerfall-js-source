...
and its `world.js:13346` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:14904`); all
...
`worldModes.js:8899`, `dungeonContext.js:6632`) and pinned as a set.
