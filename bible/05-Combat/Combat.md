...
and its `world.js:7622` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:8593`); all
...
`worldModes.js:7275`, `dungeonContext.js:5535`) and pinned as a set.
