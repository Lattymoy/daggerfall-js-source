...
and its `world.js:12228` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:13736`); all
...
`worldModes.js:8760`, `dungeonContext.js:6563`) and pinned as a set.
