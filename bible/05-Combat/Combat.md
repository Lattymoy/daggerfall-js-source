...
and its `world.js:7499` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:8470`); all
...
`worldModes.js:7183`, `dungeonContext.js:5146`) and pinned as a set.
