...
dungeonContext.js:1990 by tools/fistProbe.mjs), the melee tally on
...
and its `world.js:12394` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:13915`); all
...
`worldModes.js:8818`, `dungeonContext.js:6563`) and pinned as a set.
