...
and its `world.js:7570` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:8541`); all
...
`worldModes.js:7185`, `dungeonContext.js:5527`) and pinned as a set.
