...
and its `world.js:13415` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:14975`); all
...
`worldModes.js:8901`, `dungeonContext.js:6685`) and pinned as a set.
