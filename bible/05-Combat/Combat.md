...
dungeonContext.js:2056 by tools/fistProbe.mjs), the melee tally on
...
and its `world.js:14828` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:16526`); all
...
`worldModes.js:9473`, `dungeonContext.js:6829`) and pinned as a set.
