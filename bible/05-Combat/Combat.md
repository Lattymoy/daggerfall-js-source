...
dungeonContext.js:1966 by tools/fistProbe.mjs), the melee tally on
...
and its `world.js:11230` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:12665`); all
...
`worldModes.js:8657`, `dungeonContext.js:6491`) and pinned as a set.
