...
and its `world.js:7288` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:8252`); all
...
it move by one: the dungeon's `worldModes.js:5893` and
`chargenSession.js`'s `worldModes.js:7264` are bumped and pinned. Four
