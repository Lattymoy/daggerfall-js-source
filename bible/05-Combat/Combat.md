...
dungeonContext.js:1670 by tools/fistProbe.mjs), the melee tally on
...
and its `world.js:7466` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:8437`); all
...
`worldModes.js:7163`, `dungeonContext.js:4987`) and pinned as a set.
