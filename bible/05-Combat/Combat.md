...
and its `world.js:7635` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:8606`); all
...
`worldModes.js:7275`, `dungeonContext.js:5539`) and pinned as a set.
