...
dungeonContext.js:1776 by tools/fistProbe.mjs), the melee tally on
...
and its `world.js:8600` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:9671`); all
...
`worldModes.js:7462`, `dungeonContext.js:5839`) and pinned as a set.
