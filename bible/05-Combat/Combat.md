...
and its `world.js:7642` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:8613`); all
...
`worldModes.js:7275`, `dungeonContext.js:5546`) and pinned as a set.
