...
and its `world.js:14928` left naming a `WorldTime`/`PauseWhileOpen` note
800 lines from the host's `onPlayerArrowHitFoe` (`world.js:16643`); all
...
`worldModes.js:9473`, `dungeonContext.js:6830`) and pinned as a set.
