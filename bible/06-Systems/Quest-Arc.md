...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:486). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1073's
...
already ships, at `worldModes.js:486`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2365-2447) — and
...
other two engine-owning hosts wire (`world.js:2613-2614`,
`dungeonContext.js:2054-2055`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6175-6178`),
