...
spawns and the NPC-guard conversion with it (world.js:3863-3955) — and
...
other two engine-owning hosts wire (`world.js:4247-4248`,
`dungeonContext.js:2252-2253`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8632-8635`),
