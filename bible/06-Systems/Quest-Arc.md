...
spawns and the NPC-guard conversion with it (world.js:3741-3833) — and
...
other two engine-owning hosts wire (`world.js:4115-4116`,
`dungeonContext.js:2248-2249`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8485-8488`),
