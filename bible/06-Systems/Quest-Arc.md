...
spawns and the NPC-guard conversion with it (world.js:2980-3071) — and
...
other two engine-owning hosts wire (`world.js:3286-3287`,
`dungeonContext.js:2213-2214`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7328-7331`),
