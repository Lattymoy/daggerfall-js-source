...
spawns and the NPC-guard conversion with it (world.js:2249-2331) — and
...
other two engine-owning hosts wire (`world.js:2497-2498`,
`dungeonContext.js:1984-1985`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5569-5572`),
