...
spawns and the NPC-guard conversion with it (world.js:2227-2309) — and
...
other two engine-owning hosts wire (`world.js:2475-2476`,
`dungeonContext.js:1983-1984`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5542-5545`),
