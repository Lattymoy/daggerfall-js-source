...
spawns and the NPC-guard conversion with it (world.js:2179-2263) — and
...
other two engine-owning hosts wire (`world.js:2429-2430`,
`dungeonContext.js:1951-1952`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5496-5499`),
