...
spawns and the NPC-guard conversion with it (world.js:2169-2253) — and
...
other two engine-owning hosts wire (`world.js:2419-2420`,
`dungeonContext.js:1938-1939`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5436-5439`),
