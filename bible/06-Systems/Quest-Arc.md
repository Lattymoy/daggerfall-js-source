...
spawns and the NPC-guard conversion with it (world.js:3123-3215) — and
...
other two engine-owning hosts wire (`world.js:3478-3479`,
`dungeonContext.js:2229-2230`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7689-7692`),
