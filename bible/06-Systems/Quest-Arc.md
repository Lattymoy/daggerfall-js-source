...
spawns and the NPC-guard conversion with it (world.js:1804-1888) — and
...
other two engine-owning hosts wire (`world.js:2021-2022`,
`dungeonContext.js:1776-1777`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:4717-4720`),
