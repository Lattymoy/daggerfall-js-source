...
spawns and the NPC-guard conversion with it (world.js:2449-2538) — and
...
other two engine-owning hosts wire (`world.js:2755-2756`,
`dungeonContext.js:2074-2075`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6186-6189`),
