...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:475). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:992's
...
- the greeting says the NPC's name once reaction is above zero, and
  "stranger" below it (`townTalk.js:485`). Every static NPC in the
...
already ships, at `worldModes.js:475`. A pending marker over shipped
...
`dungeon.js:249`, the standalone host, has always had the right shape:
...
spawns and the NPC-guard conversion with it (world.js:2178-2262) — and
...
other two engine-owning hosts wire (`world.js:2428-2429`,
`dungeonContext.js:1951-1952`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5494-5497`),
