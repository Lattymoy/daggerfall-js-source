...
spawns and the NPC-guard conversion with it (world.js:3752-3844) — and
...
other two engine-owning hosts wire (`world.js:4126-4127`,
`dungeonContext.js:2252-2253`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8522-8525`),
