...
spawns and the NPC-guard conversion with it (world.js:2827-2916) — and
...
other two engine-owning hosts wire (`world.js:3132-3133`,
`dungeonContext.js:2112-2113`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7029-7032`),
