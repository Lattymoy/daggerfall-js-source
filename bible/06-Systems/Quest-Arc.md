...
and both hosts mint a fresh one at every click - worldModes.js:1216's
...
spawns and the NPC-guard conversion with it (world.js:3751-3843) — and
...
other two engine-owning hosts wire (`world.js:4125-4126`,
`dungeonContext.js:2252-2253`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8521-8524`),
