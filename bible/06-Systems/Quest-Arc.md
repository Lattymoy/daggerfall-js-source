...
spawns and the NPC-guard conversion with it (world.js:3473-3564) — and
...
other two engine-owning hosts wire (`world.js:3827-3828`,
`dungeonContext.js:2222-2223`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8027-8030`),
