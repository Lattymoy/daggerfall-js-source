...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:599). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1275's
...
already ships, at `worldModes.js:599`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:3914-4006) — and
...
other two engine-owning hosts wire (`world.js:4298-4299`,
`dungeonContext.js:2282-2283`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8756-8759`),
