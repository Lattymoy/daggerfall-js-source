...
spawns and the NPC-guard conversion with it (world.js:2204-2288) — and
...
other two engine-owning hosts wire (`world.js:2454-2455`,
`dungeonContext.js:1989-1990`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5522-5525`),
