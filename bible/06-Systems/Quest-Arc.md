...
spawns and the NPC-guard conversion with it (world.js:2319-2401) — and
...
other two engine-owning hosts wire (`world.js:2567-2568`,
`dungeonContext.js:2004-2005`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5753-5756`),
