...
spawns and the NPC-guard conversion with it (world.js:2322-2404) — and
...
other two engine-owning hosts wire (`world.js:2570-2571`,
`dungeonContext.js:2004-2005`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5757-5760`),
