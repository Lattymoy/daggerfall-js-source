...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:511). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1123's
...
already ships, at `worldModes.js:511`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2764-2853) — and
...
other two engine-owning hosts wire (`world.js:3069-3070`,
`dungeonContext.js:2090-2091`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6966-6969`),
