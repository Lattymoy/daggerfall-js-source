...
spawns and the NPC-guard conversion with it (world.js:3667-3758) — and
...
other two engine-owning hosts wire (`world.js:4021-4022`,
`dungeonContext.js:2223-2224`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8269-8272`),
