...
spawns and the NPC-guard conversion with it (world.js:1974-2058) — and
...
other two engine-owning hosts wire (`world.js:2200-2201`,
`dungeonContext.js:1789-1790`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:4928-4931`),
