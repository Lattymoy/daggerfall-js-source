...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:480). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1067's
...
already ships, at `worldModes.js:480`. A pending marker over shipped
...
`dungeon.js:252`, the standalone host, has always had the right shape:
...
spawns and the NPC-guard conversion with it (world.js:2297-2379) — and
...
other two engine-owning hosts wire (`world.js:2545-2546`,
`dungeonContext.js:2003-2004`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5670-5673`),
