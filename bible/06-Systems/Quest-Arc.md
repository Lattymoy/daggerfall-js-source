...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:605). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1281's
...
already ships, at `worldModes.js:605`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:4372-4465) — and
...
other two engine-owning hosts wire (`world.js:4757-4758`,
`dungeonContext.js:2294-2295`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:9329-9332`),
