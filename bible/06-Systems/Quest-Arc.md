...
spawns and the NPC-guard conversion with it (world.js:2725-2814) — and
...
other two engine-owning hosts wire (`world.js:3030-3031`,
`dungeonContext.js:2080-2081`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6927-6930`),
