...
and both hosts mint a fresh one at every click - worldModes.js:1225's
...
spawns and the NPC-guard conversion with it (world.js:3761-3853) — and
...
other two engine-owning hosts wire (`world.js:4145-4146`,
`dungeonContext.js:2252-2253`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8495-8498`),
