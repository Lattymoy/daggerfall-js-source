...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:476). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1005's
...
already ships, at `worldModes.js:476`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2189-2273) — and
...
other two engine-owning hosts wire (`world.js:2439-2440`,
`dungeonContext.js:1986-1987`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5506-5509`),
