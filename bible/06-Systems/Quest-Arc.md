...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:477). activeFactionPersons walks NON-COMPLETE quests only -
...
already ships, at `worldModes.js:477`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2218-2302) — and
