...
- the greeting says the NPC's name once reaction is above zero, and
  "stranger" below it (`townTalk.js:498`). Every static NPC in the
...
other two engine-owning hosts wire (`world.js:3156-3157`,
`dungeonContext.js:2175-2176`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7114-7117`),
