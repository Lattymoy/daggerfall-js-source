...
spawns and the NPC-guard conversion with it (world.js:3749-3841) — and
...
other two engine-owning hosts wire (`world.js:4123-4124`,
`dungeonContext.js:2252-2253`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8519-8522`),
