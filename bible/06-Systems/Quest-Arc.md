...
spawns and the NPC-guard conversion with it (world.js:3100-3191) — and
...
other two engine-owning hosts wire (`world.js:3454-3455`,
`dungeonContext.js:2221-2222`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7644-7647`),
