...
and both hosts mint a fresh one at every click - worldModes.js:1203's
...
spawns and the NPC-guard conversion with it (world.js:3695-3787) — and
...
other two engine-owning hosts wire (`world.js:4070-4071`,
`dungeonContext.js:2230-2231`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8353-8356`),
