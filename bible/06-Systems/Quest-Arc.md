...
spawns and the NPC-guard conversion with it (world.js:4178-4271) — and
...
other two engine-owning hosts wire (`world.js:4553-4554`,
`dungeonContext.js:2255-2256`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8969-8972`),
