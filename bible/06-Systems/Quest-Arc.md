...
spawns and the NPC-guard conversion with it (world.js:2435-2524) — and
...
other two engine-owning hosts wire (`world.js:2712-2713`,
`dungeonContext.js:2066-2067`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6115-6118`),
