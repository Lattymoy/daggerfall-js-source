...
spawns and the NPC-guard conversion with it (world.js:2316-2398) — and
...
other two engine-owning hosts wire (`world.js:2564-2565`,
`dungeonContext.js:2028-2029`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5799-5802`),
