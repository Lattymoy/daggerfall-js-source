...
spawns and the NPC-guard conversion with it (world.js:3628-3719) — and
...
other two engine-owning hosts wire (`world.js:3982-3983`,
`dungeonContext.js:2222-2223`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8228-8231`),
