...
`dungeon.js:216`, the standalone host, has always had the right shape:
...
spawns and the NPC-guard conversion with it (world.js:1816-1900) — and
...
other two engine-owning hosts wire (`world.js:2033-2034`,
`dungeonContext.js:1776-1777`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:4752-4755`),
