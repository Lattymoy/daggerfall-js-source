...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:598). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1274's
...
already ships, at `worldModes.js:598`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:3912-4004) — and
...
other two engine-owning hosts wire (`world.js:4296-4297`,
`dungeonContext.js:2282-2283`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8754-8757`),
