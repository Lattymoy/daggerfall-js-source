...
spawns and the NPC-guard conversion with it (world.js:3653-3744) — and
...
other two engine-owning hosts wire (`world.js:4007-4008`,
`dungeonContext.js:2222-2223`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8246-8249`),
