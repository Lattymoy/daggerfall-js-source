...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:597). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1273's
...
already ships, at `worldModes.js:597`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:3763-3855) — and
...
other two engine-owning hosts wire (`world.js:4147-4148`,
`dungeonContext.js:2252-2253`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8498-8501`),
