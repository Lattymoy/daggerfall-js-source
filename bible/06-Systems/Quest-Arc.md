...
spawns and the NPC-guard conversion with it (world.js:3829-3921) — and
...
other two engine-owning hosts wire (`world.js:4203-4204`,
`dungeonContext.js:2248-2249`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8557-8560`),
