...
spawns and the NPC-guard conversion with it (world.js:3012-3101) — and
...
other two engine-owning hosts wire (`world.js:3317-3318`,
`dungeonContext.js:2154-2155`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7305-7308`),
