...
spawns and the NPC-guard conversion with it (world.js:1885-1969) — and
...
other two engine-owning hosts wire (`world.js:2102-2103`,
`dungeonContext.js:1787-1788`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:4800-4803`),
