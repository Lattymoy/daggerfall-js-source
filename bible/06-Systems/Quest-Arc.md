...
spawns and the NPC-guard conversion with it (world.js:2662-2751) — and
...
other two engine-owning hosts wire (`world.js:2961-2962`,
`dungeonContext.js:2080-2081`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6800-6803`),
