...
spawns and the NPC-guard conversion with it (world.js:3599-3690) — and
...
other two engine-owning hosts wire (`world.js:3953-3954`,
`dungeonContext.js:2222-2223`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8173-8176`),
