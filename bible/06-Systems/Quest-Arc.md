...
spawns and the NPC-guard conversion with it (world.js:2253-2335) — and
...
other two engine-owning hosts wire (`world.js:2501-2502`,
`dungeonContext.js:1985-1986`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5594-5597`),
