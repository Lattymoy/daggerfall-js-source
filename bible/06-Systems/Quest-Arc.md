...
and both hosts mint a fresh one at every click - worldModes.js:1201's
...
spawns and the NPC-guard conversion with it (world.js:3705-3797) — and
...
other two engine-owning hosts wire (`world.js:4080-4081`,
`dungeonContext.js:2232-2233`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8354-8357`),
