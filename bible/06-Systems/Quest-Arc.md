...
`dungeon.js:253`, the standalone host, has always had the right shape:
...
spawns and the NPC-guard conversion with it (world.js:2308-2390) — and
...
other two engine-owning hosts wire (`world.js:2556-2557`,
`dungeonContext.js:2003-2004`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5739-5742`),
