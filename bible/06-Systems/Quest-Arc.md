...
spawns and the NPC-guard conversion with it (world.js:2010-2094) — and
...
other two engine-owning hosts wire (`world.js:2260-2261`,
`dungeonContext.js:1835-1836`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5162-5165`),
