...
spawns and the NPC-guard conversion with it (world.js:2437-2526) — and
...
other two engine-owning hosts wire (`world.js:2714-2715`,
`dungeonContext.js:2074-2075`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6117-6120`),
