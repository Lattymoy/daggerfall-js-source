...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:519). activeFactionPersons walks NON-COMPLETE quests only -
...
already ships, at `worldModes.js:519`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2828-2917) — and
...
other two engine-owning hosts wire (`world.js:3133-3134`,
`dungeonContext.js:2113-2114`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7030-7033`),
