...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:563). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1186's
...
already ships, at `worldModes.js:563`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:3004-3095) — and
...
other two engine-owning hosts wire (`world.js:3358-3359`,
`dungeonContext.js:2220-2221`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7523-7526`),
