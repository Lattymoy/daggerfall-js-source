...
spawns and the NPC-guard conversion with it (world.js:3703-3795) — and
...
other two engine-owning hosts wire (`world.js:4078-4079`,
`dungeonContext.js:2230-2231`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8346-8349`),
