...
spawns and the NPC-guard conversion with it (world.js:2407-2496) — and
...
other two engine-owning hosts wire (`world.js:2684-2685`,
`dungeonContext.js:2063-2064`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6087-6090`),
