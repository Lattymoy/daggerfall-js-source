...
spawns and the NPC-guard conversion with it (world.js:2630-2719) — and
...
other two engine-owning hosts wire (`world.js:2936-2937`,
`dungeonContext.js:2074-2075`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6758-6761`),
