...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:483). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1070's
...
already ships, at `worldModes.js:483`. A pending marker over shipped
...
`dungeon.js:257`, the standalone host, has always had the right shape:
...
spawns and the NPC-guard conversion with it (world.js:2315-2397) — and
...
other two engine-owning hosts wire (`world.js:2563-2564`,
`dungeonContext.js:2004-2005`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5750-5753`),
