...
spawns and the NPC-guard conversion with it (world.js:2732-2821) — and
...
other two engine-owning hosts wire (`world.js:3031-3032`,
`dungeonContext.js:2090-2091`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6920-6923`),
