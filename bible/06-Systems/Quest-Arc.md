...
spawns and the NPC-guard conversion with it (world.js:2780-2869) — and
...
other two engine-owning hosts wire (`world.js:3085-3086`,
`dungeonContext.js:2090-2091`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6982-6985`),
