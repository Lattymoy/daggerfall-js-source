...
spawns and the NPC-guard conversion with it (world.js:4369-4462) — and
...
other two engine-owning hosts wire (`world.js:4754-4755`,
`dungeonContext.js:2293-2294`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:9321-9324`),
