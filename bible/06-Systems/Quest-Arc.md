...
spawns and the NPC-guard conversion with it (world.js:2690-2779) — and
...
other two engine-owning hosts wire (`world.js:2989-2990`,
`dungeonContext.js:2080-2081`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6857-6860`),
