...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:561). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1183's
...
already ships, at `worldModes.js:561`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2985-3076) — and
...
other two engine-owning hosts wire (`world.js:3339-3340`,
`dungeonContext.js:2204-2205`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7360-7363`),
