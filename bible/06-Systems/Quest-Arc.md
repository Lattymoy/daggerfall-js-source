...
spawns and the NPC-guard conversion with it (world.js:3024-3113) — and
...
other two engine-owning hosts wire (`world.js:3329-3330`,
`dungeonContext.js:2154-2155`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7323-7326`),
