...
spawns and the NPC-guard conversion with it (world.js:2295-2377) — and
...
other two engine-owning hosts wire (`world.js:2543-2544`,
`dungeonContext.js:2003-2004`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5668-5671`),
