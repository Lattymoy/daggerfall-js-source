...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:496). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1081's
...
already ships, at `worldModes.js:496`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2586-2675) — and
...
other two engine-owning hosts wire (`world.js:2892-2893`,
`dungeonContext.js:2074-2075`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6714-6717`),
