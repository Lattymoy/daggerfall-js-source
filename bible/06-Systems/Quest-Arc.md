...
spawns and the NPC-guard conversion with it (world.js:2302-2384) — and
...
other two engine-owning hosts wire (`world.js:2550-2551`,
`dungeonContext.js:2003-2004`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5675-5678`),
