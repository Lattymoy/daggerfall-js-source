...
spawns and the NPC-guard conversion with it (world.js:3748-3840) — and
...
other two engine-owning hosts wire (`world.js:4122-4123`,
`dungeonContext.js:2249-2250`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8518-8521`),
