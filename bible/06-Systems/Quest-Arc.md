...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:489). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1074's
...
already ships, at `worldModes.js:489`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2380-2469) — and
...
other two engine-owning hosts wire (`world.js:2657-2658`,
`dungeonContext.js:2063-2064`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6060-6063`),
