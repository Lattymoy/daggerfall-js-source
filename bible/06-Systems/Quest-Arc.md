...
`dungeon.js:251`, the standalone host, has always had the right shape:
...
spawns and the NPC-guard conversion with it (world.js:2256-2338) — and
...
other two engine-owning hosts wire (`world.js:2504-2505`,
`dungeonContext.js:1990-1991`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5597-5600`),
