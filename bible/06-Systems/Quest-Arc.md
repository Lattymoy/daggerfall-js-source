...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:557). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1172's
...
already ships, at `worldModes.js:557`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:3007-3096) — and
...
other two engine-owning hosts wire (`world.js:3312-3313`,
`dungeonContext.js:2151-2152`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7247-7250`),
