...
spawns and the NPC-guard conversion with it (world.js:2218-2300) — and
...
other two engine-owning hosts wire (`world.js:2466-2467`,
`dungeonContext.js:1997-1998`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5533-5536`),
