...
spawns and the NPC-guard conversion with it (world.js:3025-3114) — and
...
other two engine-owning hosts wire (`world.js:3330-3331`,
`dungeonContext.js:2155-2156`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7332-7335`),
