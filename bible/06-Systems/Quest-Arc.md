...
spawns and the NPC-guard conversion with it (world.js:2693-2782) — and
...
other two engine-owning hosts wire (`world.js:2992-2993`,
`dungeonContext.js:2080-2081`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6881-6884`),
