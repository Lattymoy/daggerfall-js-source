...
spawns and the NPC-guard conversion with it (world.js:3750-3842) — and
...
other two engine-owning hosts wire (`world.js:4124-4125`,
`dungeonContext.js:2252-2253`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8520-8523`),
