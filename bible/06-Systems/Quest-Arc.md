...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:562). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1184's
...
already ships, at `worldModes.js:562`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2998-3089) — and
...
other two engine-owning hosts wire (`world.js:3352-3353`,
`dungeonContext.js:2190-2191`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7451-7454`),
