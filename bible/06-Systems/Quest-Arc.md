...
spawns and the NPC-guard conversion with it (world.js:2880-2969) — and
...
other two engine-owning hosts wire (`world.js:3185-3186`,
`dungeonContext.js:2095-2096`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7082-7085`),
