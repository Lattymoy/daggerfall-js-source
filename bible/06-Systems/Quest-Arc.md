...
spawns and the NPC-guard conversion with it (world.js:3698-3790) — and
...
other two engine-owning hosts wire (`world.js:4073-4074`,
`dungeonContext.js:2230-2231`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8341-8344`),
