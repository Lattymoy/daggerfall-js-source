...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:514). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1129's
...
already ships, at `worldModes.js:514`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2788-2877) — and
...
other two engine-owning hosts wire (`world.js:3093-3094`,
`dungeonContext.js:2095-2096`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6990-6993`),
