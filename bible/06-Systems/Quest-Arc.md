...
spawns and the NPC-guard conversion with it (world.js:3831-3923) — and
...
other two engine-owning hosts wire (`world.js:4205-4206`,
`dungeonContext.js:2275-2276`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8605-8608`),
