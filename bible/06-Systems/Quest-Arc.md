...
spawns and the NPC-guard conversion with it (world.js:2587-2676) — and
...
other two engine-owning hosts wire (`world.js:2893-2894`,
`dungeonContext.js:2074-2075`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6715-6718`),
