...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:491). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1076's
...
already ships, at `worldModes.js:491`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2534-2623) — and
...
other two engine-owning hosts wire (`world.js:2840-2841`,
`dungeonContext.js:2074-2075`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6575-6578`),
