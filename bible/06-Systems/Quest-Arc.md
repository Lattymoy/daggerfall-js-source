...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:484). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1071's
...
already ships, at `worldModes.js:484`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2318-2400) — and
...
other two engine-owning hosts wire (`world.js:2566-2567`,
`dungeonContext.js:2004-2005`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5752-5755`),
