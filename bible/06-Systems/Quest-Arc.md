...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:512). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1124's
...
already ships, at `worldModes.js:512`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2781-2870) — and
...
other two engine-owning hosts wire (`world.js:3086-3087`,
`dungeonContext.js:2092-2093`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6983-6986`),
