...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:485). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1072's
...
already ships, at `worldModes.js:485`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2323-2405) — and
...
other two engine-owning hosts wire (`world.js:2571-2572`,
`dungeonContext.js:2028-2029`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5806-5809`),
