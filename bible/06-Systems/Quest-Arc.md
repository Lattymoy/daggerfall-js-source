...
spawns and the NPC-guard conversion with it (world.js:2338-2420) — and
...
other two engine-owning hosts wire (`world.js:2586-2587`,
`dungeonContext.js:2054-2055`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6071-6074`),
