...
spawns and the NPC-guard conversion with it (world.js:2219-2301) — and
...
other two engine-owning hosts wire (`world.js:2467-2468`,
`dungeonContext.js:1982-1983`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5536-5539`),
