...
spawns and the NPC-guard conversion with it (world.js:3201-3292) — and
...
other two engine-owning hosts wire (`world.js:3555-3556`,
`dungeonContext.js:2220-2221`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7728-7731`),
