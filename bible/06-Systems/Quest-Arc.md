...
spawns and the NPC-guard conversion with it (world.js:4001-4093) — and
...
other two engine-owning hosts wire (`world.js:4375-4376`,
`dungeonContext.js:2255-2256`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8755-8758`),
