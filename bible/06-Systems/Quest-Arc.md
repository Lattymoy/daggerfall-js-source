...
spawns and the NPC-guard conversion with it (world.js:2171-2255) — and
...
other two engine-owning hosts wire (`world.js:2421-2422`,
`dungeonContext.js:1950-1951`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5466-5469`),
