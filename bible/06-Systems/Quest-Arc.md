...
spawns and the NPC-guard conversion with it (world.js:1887-1971) — and
...
other two engine-owning hosts wire (`world.js:2113-2114`,
`dungeonContext.js:1789-1790`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:4839-4842`),
