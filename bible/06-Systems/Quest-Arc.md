...
spawns and the NPC-guard conversion with it (world.js:2003-2087) — and
...
other two engine-owning hosts wire (`world.js:2253-2254`,
`dungeonContext.js:1835-1836`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5155-5158`),
