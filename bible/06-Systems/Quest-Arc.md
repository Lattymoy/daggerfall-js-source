...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:558). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1180's
...
already ships, at `worldModes.js:558`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2978-3069) — and
