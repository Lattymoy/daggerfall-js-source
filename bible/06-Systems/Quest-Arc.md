...
spawns and the NPC-guard conversion with it (world.js:3102-3193) — and
...
other two engine-owning hosts wire (`world.js:3456-3457`,
`dungeonContext.js:2221-2222`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7646-7649`),
