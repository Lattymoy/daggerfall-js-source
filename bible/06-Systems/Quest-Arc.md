...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:529). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1144's
...
already ships, at `worldModes.js:529`. A pending marker over shipped
...
byte-folded `spellHasMatchForClassicEffect` (`world.js:7141-7144`),
