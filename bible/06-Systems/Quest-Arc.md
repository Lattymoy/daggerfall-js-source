...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:564). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1187's
...
already ships, at `worldModes.js:564`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:3007-3098) — and
...
other two engine-owning hosts wire (`world.js:3361-3362`,
`dungeonContext.js:2221-2222`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7539-7542`),
