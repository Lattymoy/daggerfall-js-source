...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:513). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1128's
...
already ships, at `worldModes.js:513`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2771-2860) — and
...
other two engine-owning hosts wire (`world.js:3076-3077`,
`dungeonContext.js:2093-2094`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6973-6976`),
