...
spawns and the NPC-guard conversion with it (world.js:2999-3090) — and
...
other two engine-owning hosts wire (`world.js:3353-3354`,
`dungeonContext.js:2198-2199`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7515-7518`),
