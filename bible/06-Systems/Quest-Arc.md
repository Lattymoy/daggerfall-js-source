...
spawns and the NPC-guard conversion with it (world.js:1883-1967) — and
...
other two engine-owning hosts wire (`world.js:2109-2110`,
`dungeonContext.js:1789-1790`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:4828-4831`),
