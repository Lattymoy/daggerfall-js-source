...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:537). activeFactionPersons walks NON-COMPLETE quests only -
...
already ships, at `worldModes.js:537`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2933-3022) — and
...
other two engine-owning hosts wire (`world.js:3238-3239`,
`dungeonContext.js:2150-2151`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7162-7165`),
