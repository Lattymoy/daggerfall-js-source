...
spawns and the NPC-guard conversion with it (world.js:2859-2948) — and
...
other two engine-owning hosts wire (`world.js:3163-3164`,
`dungeonContext.js:2209-2210`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7174-7177`),
