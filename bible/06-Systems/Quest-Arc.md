...
spawns and the NPC-guard conversion with it (world.js:1862-1946) — and
...
other two engine-owning hosts wire (`world.js:2079-2080`,
`dungeonContext.js:1789-1790`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:4798-4801`),
