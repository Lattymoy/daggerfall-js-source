...
spawns and the NPC-guard conversion with it (world.js:1867-1951) — and
...
other two engine-owning hosts wire (`world.js:2093-2094`,
`dungeonContext.js:1789-1790`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:4812-4815`),
