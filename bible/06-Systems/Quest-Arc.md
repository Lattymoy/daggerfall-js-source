...
spawns and the NPC-guard conversion with it (world.js:3603-3694) — and
...
other two engine-owning hosts wire (`world.js:3957-3958`,
`dungeonContext.js:2222-2223`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8192-8195`),
