...
spawns and the NPC-guard conversion with it (world.js:3768-3860) — and
...
other two engine-owning hosts wire (`world.js:4142-4143`,
`dungeonContext.js:2248-2249`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8493-8496`),
