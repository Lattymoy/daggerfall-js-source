...
spawns and the NPC-guard conversion with it (world.js:3741-3834) — and
...
`dungeonContext.js:2251-2252`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8470-8473`),
