...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:505). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1090's
...
already ships, at `worldModes.js:505`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2608-2697) — and
...
other two engine-owning hosts wire (`world.js:2905-2906`,
`dungeonContext.js:2080-2081`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6727-6730`),
