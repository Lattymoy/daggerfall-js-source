...
spawns and the NPC-guard conversion with it (world.js:2199-2283) — and
...
other two engine-owning hosts wire (`world.js:2449-2450`,
`dungeonContext.js:1986-1987`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5516-5519`),
