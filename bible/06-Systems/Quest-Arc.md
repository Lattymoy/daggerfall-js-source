...
spawns and the NPC-guard conversion with it (world.js:2692-2781) — and
...
other two engine-owning hosts wire (`world.js:2991-2992`,
`dungeonContext.js:2080-2081`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6880-6883`),
