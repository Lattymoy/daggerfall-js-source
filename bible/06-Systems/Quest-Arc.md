...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:522). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1137's
...
already ships, at `worldModes.js:522`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2856-2945) — and
...
other two engine-owning hosts wire (`world.js:3160-3161`,
`dungeonContext.js:2151-2152`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7105-7108`),
