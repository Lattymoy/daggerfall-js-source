...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:482). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1069's
...
already ships, at `worldModes.js:482`. A pending marker over shipped
...
`dungeon.js:255`, the standalone host, has always had the right shape:
...
spawns and the NPC-guard conversion with it (world.js:2307-2389) — and
...
other two engine-owning hosts wire (`world.js:2555-2556`,
`dungeonContext.js:2004-2005`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5722-5725`),
