...
spawns and the NPC-guard conversion with it (world.js:3830-3922) — and
...
other two engine-owning hosts wire (`world.js:4204-4205`,
`dungeonContext.js:2275-2276`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8583-8586`),
