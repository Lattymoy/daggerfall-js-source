...
spawns and the NPC-guard conversion with it (world.js:2248-2330) — and
...
other two engine-owning hosts wire (`world.js:2496-2497`,
`dungeonContext.js:1984-1985`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5568-5571`),
