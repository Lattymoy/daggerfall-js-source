...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:493). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1078's
...
already ships, at `worldModes.js:493`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2604-2693) — and
...
other two engine-owning hosts wire (`world.js:2910-2911`,
`dungeonContext.js:2074-2075`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6723-6726`),
