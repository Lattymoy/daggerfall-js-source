...
spawns and the NPC-guard conversion with it (world.js:2309-2391) — and
...
other two engine-owning hosts wire (`world.js:2557-2558`,
`dungeonContext.js:2003-2004`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5740-5743`),
