...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:528). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1143's
...
already ships, at `worldModes.js:528`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:2853-2942) — and
...
`dungeonContext.js:2206-2207`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7115-7118`),
