...
spawns and the NPC-guard conversion with it (world.js:3692-3783) — and
...
other two engine-owning hosts wire (`world.js:4066-4067`,
`dungeonContext.js:2222-2223`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8308-8311`),
