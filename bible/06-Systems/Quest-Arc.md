...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:601). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1277's
...
already ships, at `worldModes.js:601`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:4352-4445) — and
...
other two engine-owning hosts wire (`world.js:4737-4738`,
`dungeonContext.js:2289-2290`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:9264-9267`),
