...
spawns and the NPC-guard conversion with it (world.js:3003-3094) — and
...
other two engine-owning hosts wire (`world.js:3357-3358`,
`dungeonContext.js:2220-2221`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7526-7529`),
