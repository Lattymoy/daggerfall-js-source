...
spawns and the NPC-guard conversion with it (world.js:2234-2316) — and
...
other two engine-owning hosts wire (`world.js:2482-2483`,
`dungeonContext.js:1983-1984`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5549-5552`),
