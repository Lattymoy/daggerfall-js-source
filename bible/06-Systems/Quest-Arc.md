...
spawns and the NPC-guard conversion with it (world.js:3747-3839) — and
...
other two engine-owning hosts wire (`world.js:4121-4122`,
`dungeonContext.js:2249-2250`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8517-8520`),
