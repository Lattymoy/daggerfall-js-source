...
spawns and the NPC-guard conversion with it (world.js:2173-2257) — and
...
other two engine-owning hosts wire (`world.js:2423-2424`,
`dungeonContext.js:1950-1951`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5468-5471`),
