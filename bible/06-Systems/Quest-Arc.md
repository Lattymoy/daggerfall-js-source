...
spawns and the NPC-guard conversion with it (world.js:3010-3101) — and
...
other two engine-owning hosts wire (`world.js:3364-3365`,
`dungeonContext.js:2221-2222`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7549-7552`),
