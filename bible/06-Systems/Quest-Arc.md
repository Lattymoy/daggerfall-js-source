...
spawns and the NPC-guard conversion with it (world.js:3625-3716) — and
...
other two engine-owning hosts wire (`world.js:3979-3980`,
`dungeonContext.js:2223-2224`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8227-8230`),
