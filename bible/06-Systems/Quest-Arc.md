...
spawns and the NPC-guard conversion with it (world.js:2857-2946) — and
...
other two engine-owning hosts wire (`world.js:3161-3162`,
`dungeonContext.js:2151-2152`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7106-7109`),
