...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:565). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1188's
...
already ships, at `worldModes.js:565`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:3674-3765) — and
...
other two engine-owning hosts wire (`world.js:4028-4029`,
`dungeonContext.js:2224-2225`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8276-8279`),
