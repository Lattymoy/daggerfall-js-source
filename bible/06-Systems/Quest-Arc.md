...
`dungeon.js:241`, the standalone host, has always had the right shape:
...
spawns and the NPC-guard conversion with it (world.js:2149-2233) — and
...
other two engine-owning hosts wire (`world.js:2399-2400`,
`dungeonContext.js:1925-1926`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5416-5419`),
