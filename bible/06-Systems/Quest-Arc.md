...
spawns and the NPC-guard conversion with it (world.js:2564-2653) — and
...
other two engine-owning hosts wire (`world.js:2870-2871`,
`dungeonContext.js:2074-2075`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6605-6608`),
