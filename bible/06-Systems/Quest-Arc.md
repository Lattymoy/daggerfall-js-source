...
spawns and the NPC-guard conversion with it (world.js:4381-4474) — and
...
other two engine-owning hosts wire (`world.js:4766-4767`,
`dungeonContext.js:2293-2294`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:9339-9342`),
