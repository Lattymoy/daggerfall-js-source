...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:606). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1282's
...
already ships, at `worldModes.js:606`. A pending marker over shipped
...
spawns and the NPC-guard conversion with it (world.js:4374-4467) — and
...
other two engine-owning hosts wire (`world.js:4759-4760`,
`dungeonContext.js:2294-2295`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:9331-9334`),
