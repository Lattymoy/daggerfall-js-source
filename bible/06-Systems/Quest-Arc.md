...
- WHENNPCISAVAILABLE: the click PULSE - available when the player
  ...
  wired at src/scenes/worldModes.js:574). activeFactionPersons walks NON-COMPLETE quests only -
...
and both hosts mint a fresh one at every click - worldModes.js:1213's
...
already ships, at `worldModes.js:574`. A pending marker over shipped
...
`dungeon.js:268`, the standalone host, has always had the right shape:
...
spawns and the NPC-guard conversion with it (world.js:3879-3971) — and
...
other two engine-owning hosts wire (`world.js:4253-4254`,
`dungeonContext.js:2278-2279`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:8704-8707`),
