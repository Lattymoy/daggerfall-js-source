...
spawns and the NPC-guard conversion with it (world.js:3002-3093) — and
...
other two engine-owning hosts wire (`world.js:3356-3357`,
`dungeonContext.js:2220-2221`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7518-7521`),
