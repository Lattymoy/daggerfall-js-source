...
spawns and the NPC-guard conversion with it (world.js:2644-2733) — and
...
other two engine-owning hosts wire (`world.js:2941-2942`,
`dungeonContext.js:2080-2081`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:6780-6783`),
