...
spawns and the NPC-guard conversion with it (world.js:3279-3370) — and
...
other two engine-owning hosts wire (`world.js:3633-3634`,
`dungeonContext.js:2220-2221`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:7807-7810`),
