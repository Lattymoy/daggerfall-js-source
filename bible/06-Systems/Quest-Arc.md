...
spawns and the NPC-guard conversion with it (world.js:2205-2289) — and
...
other two engine-owning hosts wire (`world.js:2455-2456`,
`dungeonContext.js:1997-1998`) is wired here now, and with it
`CastSpellDo`'s two world reads — `getClassicSpellEffects` and the
byte-folded `spellHasMatchForClassicEffect` (`world.js:5527-5530`),
