...
`playerTicker.advance(60)` (`exterior.js:980`, `world.js:1122`), fired
...
`world.js:2095` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4940` in citedrift.test.js
