...
`playerTicker.advance(60)` (`exterior.js:991`, `world.js:1113`), fired
...
`world.js:2087` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5157` in citedrift.test.js
