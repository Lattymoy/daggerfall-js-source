...
`playerTicker.advance(60)` (`exterior.js:1065`, `world.js:1476`), fired
...
`world.js:2686` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5934` in citedrift.test.js
