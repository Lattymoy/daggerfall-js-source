...
`playerTicker.advance(60)` (`exterior.js:930`, `world.js:855`), fired
...
it (`renderer.js:2140`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2130`), and `BB_VS`
...
`world.js:1707` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:3954` in citedrift.test.js
