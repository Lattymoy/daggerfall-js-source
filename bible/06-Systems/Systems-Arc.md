...
`playerTicker.advance(60)` (`exterior.js:929`, `world.js:851`), fired
...
it (`renderer.js:2005`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:1995`), and `BB_VS`
...
`world.js:1703` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:3950` in citedrift.test.js
