...
`playerTicker.advance(60)` (`exterior.js:943`, `world.js:918`), fired
...
`world.js:1811` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4371` in citedrift.test.js
