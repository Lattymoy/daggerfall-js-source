...
`playerTicker.advance(60)` (`exterior.js:921`, `world.js:831`), fired
...
`world.js:1671` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:3865` in citedrift.test.js
