...
`playerTicker.advance(60)` (`exterior.js:994`, `world.js:1123`), fired
...
`world.js:2097` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5187` in citedrift.test.js
