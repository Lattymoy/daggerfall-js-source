...
`playerTicker.advance(60)` (`exterior.js:957`, `world.js:1000`), fired
...
it (`renderer.js:2486`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2476`), and `BB_VS`
...
`world.js:1963` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4599` in citedrift.test.js
