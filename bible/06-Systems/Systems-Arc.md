...
`playerTicker.advance(60)` (`exterior.js:982`, `world.js:1103`), fired
...
it (`renderer.js:2794`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2784`), and `BB_VS`
