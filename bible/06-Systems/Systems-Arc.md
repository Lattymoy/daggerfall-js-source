...
`playerTicker.advance(60)` (`exterior.js:1066`, `world.js:1529`), fired
...
`world.js:2836` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:6120` in citedrift.test.js
