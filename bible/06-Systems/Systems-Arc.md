...
`playerTicker.advance(60)` (`exterior.js:943`, `world.js:925`), fired
...
it (`renderer.js:2403`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2393`), and `BB_VS`
...
`world.js:1835` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4423` in citedrift.test.js
