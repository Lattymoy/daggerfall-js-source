...
`playerTicker.advance(60)` (`exterior.js:974`, `world.js:1072`), fired
...
`world.js:2043` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4777` in citedrift.test.js
