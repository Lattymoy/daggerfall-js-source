...
`playerTicker.advance(60)` (`exterior.js:983`, `world.js:1103`), fired
...
it (`renderer.js:2814`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2804`), and `BB_VS`
...
`world.js:2077` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5047` in citedrift.test.js
