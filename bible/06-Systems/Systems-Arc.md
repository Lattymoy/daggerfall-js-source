...
`playerTicker.advance(60)` (`exterior.js:1043`, `world.js:1394`), fired
...
`world.js:2597` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5705` in citedrift.test.js
