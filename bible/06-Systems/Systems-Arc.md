...
`playerTicker.advance(60)` (`exterior.js:980`, `world.js:1121`), fired
...
`world.js:2094` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4939` in citedrift.test.js
