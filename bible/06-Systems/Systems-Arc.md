...
`playerTicker.advance(60)` (`exterior.js:1042`, `world.js:1379`), fired
...
`world.js:2582` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5683` in citedrift.test.js
