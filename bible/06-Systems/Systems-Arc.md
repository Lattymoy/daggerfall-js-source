...
`playerTicker.advance(60)` (`exterior.js:970`, `world.js:1046`), fired
...
`world.js:2016` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4769` in citedrift.test.js
