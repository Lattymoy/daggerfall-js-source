...
`playerTicker.advance(60)` (`exterior.js:923`, `world.js:780`), fired
...
it (`renderer.js:1849`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:1839`), and `BB_VS`
...
`world.js:1637` said the dungeon-mode enchant ctx was "FLAGGED there
