...
`playerTicker.advance(60)` (`exterior.js:923`, `world.js:833`), fired
...
`world.js:1685` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:3907` in citedrift.test.js
