...
it (`renderer.js:3040`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:3030`), and `BB_VS`
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5904` in citedrift.test.js
