...
`playerTicker.advance(60)` (`exterior.js:973`, `world.js:1111`), fired
...
`world.js:2084` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4832` in citedrift.test.js
