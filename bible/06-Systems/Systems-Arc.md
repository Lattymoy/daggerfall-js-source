...
`playerTicker.advance(60)` (`exterior.js:980`, `world.js:1095`), fired
...
`world.js:2067` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4911` in citedrift.test.js
