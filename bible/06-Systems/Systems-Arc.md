...
`playerTicker.advance(60)` (`exterior.js:943`, `world.js:924`), fired
...
`world.js:1817` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4401` in citedrift.test.js
