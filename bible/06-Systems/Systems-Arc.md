...
`playerTicker.advance(60)` (`exterior.js:916`, `world.js:828`), fired
...
`world.js:1677` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:3827` in citedrift.test.js
