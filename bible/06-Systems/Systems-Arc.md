...
`playerTicker.advance(60)` (`exterior.js:922`, `world.js:832`), fired
...
`world.js:1684` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:3886` in citedrift.test.js
