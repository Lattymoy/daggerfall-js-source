...
`effects.js:262-268` recorded when S15 undid an earlier mis-mapping of
...
`playerTicker.advance(60)` (`exterior.js:1071`, `world.js:1959`), fired
...
`world.js:3283` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:6593` in citedrift.test.js
