...
`playerTicker.advance(60)` (`exterior.js:1066`, `world.js:1473`), fired
...
`world.js:2683` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5917` in citedrift.test.js
