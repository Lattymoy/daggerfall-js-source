...
`playerTicker.advance(60)` (`exterior.js:1031`, `world.js:1222`), fired
...
`world.js:2358` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5340` in citedrift.test.js
