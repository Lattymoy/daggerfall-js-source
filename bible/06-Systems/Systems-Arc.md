...
`playerTicker.advance(60)` (`exterior.js:1042`, `world.js:1426`), fired
...
`world.js:2632` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5752` in citedrift.test.js
