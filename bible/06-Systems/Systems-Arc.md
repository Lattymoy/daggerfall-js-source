...
`playerTicker.advance(60)` (`exterior.js:988`, `world.js:1109`), fired
...
`world.js:2083` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5064` in citedrift.test.js
