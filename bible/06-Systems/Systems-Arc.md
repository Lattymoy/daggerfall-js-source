...
it (`renderer.js:2482`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2472`), and `BB_VS`
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4607` in citedrift.test.js
