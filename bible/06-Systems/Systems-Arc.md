...
`playerTicker.advance(60)` (`exterior.js:1066`, `world.js:1493`), fired
...
`world.js:2792` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:6048` in citedrift.test.js
