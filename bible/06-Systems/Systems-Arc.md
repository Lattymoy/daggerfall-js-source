...
`playerTicker.advance(60)` (`exterior.js:957`, `world.js:968`), fired
...
it (`renderer.js:2466`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2456`), and `BB_VS`
...
`world.js:1931` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4561` in citedrift.test.js
