...
`playerTicker.advance(60)` (`exterior.js:979`, `world.js:1120`), fired
...
it (`renderer.js:2736`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2726`), and `BB_VS`
...
`world.js:2093` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4926` in citedrift.test.js
