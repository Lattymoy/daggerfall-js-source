...
`playerTicker.advance(60)` (`exterior.js:1071`, `world.js:1964`), fired
...
it (`renderer.js:3051`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:3041`), and `BB_VS`
...
`world.js:3288` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:6598` in citedrift.test.js
