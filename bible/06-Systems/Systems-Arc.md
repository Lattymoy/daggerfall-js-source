...
`playerTicker.advance(60)` (`exterior.js:1066`, `world.js:1464`), fired
...
`world.js:2763` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:6004` in citedrift.test.js
