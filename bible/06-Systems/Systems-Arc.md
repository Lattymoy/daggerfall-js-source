...
`playerTicker.advance(60)` (`exterior.js:966`, `world.js:1002`), fired
...
it (`renderer.js:2515`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2505`), and `BB_VS`
...
`world.js:1972` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4663` in citedrift.test.js
