...
`playerTicker.advance(60)` (`exterior.js:1071`, `world.js:1971`), fired
...
`world.js:3295` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:6605` in citedrift.test.js
