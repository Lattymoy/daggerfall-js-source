...
`playerTicker.advance(60)` (`exterior.js:1065`, `world.js:1486`), fired
...
`world.js:2696` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5944` in citedrift.test.js
