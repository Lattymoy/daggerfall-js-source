...
`playerTicker.advance(60)` (`exterior.js:1043`, `world.js:1433`), fired
...
`world.js:2639` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5747` in citedrift.test.js
