...
`playerTicker.advance(60)` (`exterior.js:1047`, `world.js:1430`), fired
...
it (`renderer.js:2834`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2824`), and `BB_VS`
...
`world.js:2636` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5744` in citedrift.test.js
