...
`playerTicker.advance(60)` (`exterior.js:1066`, `world.js:1468`), fired
...
`world.js:2678` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5910` in citedrift.test.js
