...
`playerTicker.advance(60)` (`exterior.js:980`, `world.js:1102`), fired
...
`world.js:2074` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5007` in citedrift.test.js
