...
`playerTicker.advance(60)` (`exterior.js:943`, `world.js:933`), fired
...
`world.js:1879` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4487` in citedrift.test.js
