...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5174` in citedrift.test.js
...
the classic game, though it keeps the camps and the rest's place, and a
new character still packs the survival kit - SURV-KIT),
