...
`playerTicker.advance(60)` (`exterior.js:968`, `world.js:1043`), fired
...
it (`renderer.js:2527`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2517`), and `BB_VS`
...
`world.js:2013` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4709` in citedrift.test.js
