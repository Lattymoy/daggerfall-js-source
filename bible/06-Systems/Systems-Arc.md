...
`playerTicker.advance(60)` (`exterior.js:1059`, `world.js:1442`), fired
...
`world.js:2649` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5789` in citedrift.test.js
