...
`playerTicker.advance(60)` (`exterior.js:1065`, `world.js:1458`), fired
...
`world.js:2665` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5840` in citedrift.test.js
