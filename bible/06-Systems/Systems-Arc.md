...
`playerTicker.advance(60)` (`exterior.js:982`, `world.js:1104`), fired
...
`world.js:2078` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5055` in citedrift.test.js
