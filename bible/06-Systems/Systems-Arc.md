...
`playerTicker.advance(60)` (`exterior.js:933`, `world.js:858`), fired
...
`world.js:1722` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4140` in citedrift.test.js
