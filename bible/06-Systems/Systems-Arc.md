...
`playerTicker.advance(60)` (`exterior.js:910`, `world.js:778`), fired
...
it (`renderer.js:1847`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:1837`), and `BB_VS`
...
`world.js:1624` said the dungeon-mode enchant ctx was "FLAGGED there
