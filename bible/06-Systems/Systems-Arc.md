...
`playerTicker.advance(60)` (`exterior.js:894`, `world.js:773`), fired
...
it (`renderer.js:1805`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:1795`), and `BB_VS`
...
`world.js:1593` said the dungeon-mode enchant ctx was "FLAGGED there
