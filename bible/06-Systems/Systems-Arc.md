...
`playerTicker.advance(60)` (`exterior.js:1069`, `world.js:1875`), fired
...
`world.js:3101` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:6357` in citedrift.test.js
