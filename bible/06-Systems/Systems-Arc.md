...
`playerTicker.advance(60)` (`exterior.js:956`, `world.js:939`), fired
...
`world.js:1885` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4510` in citedrift.test.js
