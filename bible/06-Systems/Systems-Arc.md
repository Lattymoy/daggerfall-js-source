...
`playerTicker.advance(60)` (`exterior.js:1041`, `world.js:1294`), fired
...
`world.js:2452` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5538` in citedrift.test.js
