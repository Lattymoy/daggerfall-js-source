...
`playerTicker.advance(60)` (`exterior.js:943`, `world.js:903`), fired
...
`world.js:1773` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4284` in citedrift.test.js
