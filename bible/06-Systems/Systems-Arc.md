...
`playerTicker.advance(60)` (`exterior.js:1055`, `world.js:1449`), fired
...
`world.js:2656` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5831` in citedrift.test.js
