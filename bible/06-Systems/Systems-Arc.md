...
`playerTicker.advance(60)` (`exterior.js:990`, `world.js:1112`), fired
...
it (`renderer.js:2797`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2787`), and `BB_VS`
...
`world.js:2086` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5141` in citedrift.test.js
