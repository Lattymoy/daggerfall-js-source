...
`playerTicker.advance(60)` (`exterior.js:970`, `world.js:1044`), fired
...
`world.js:2014` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4714` in citedrift.test.js
