...
`playerTicker.advance(60)` (`exterior.js:981`, `world.js:1055`), fired
...
`world.js:2026` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4754` in citedrift.test.js
