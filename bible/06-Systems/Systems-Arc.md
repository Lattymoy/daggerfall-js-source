...
`playerTicker.advance(60)` (`exterior.js:987`, `world.js:1107`), fired
...
it (`renderer.js:2715`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2705`), and `BB_VS`
...
`world.js:2081` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5051` in citedrift.test.js
