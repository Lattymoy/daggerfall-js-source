...
`playerTicker.advance(60)` (`exterior.js:982`, `world.js:1105`), fired
...
`world.js:2079` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5060` in citedrift.test.js
