...
`playerTicker.advance(60)` (`exterior.js:967`, `world.js:1003`), fired
...
`world.js:1973` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4653` in citedrift.test.js
