...
`playerTicker.advance(60)` (`exterior.js:1065`, `world.js:1464`), fired
...
`world.js:2674` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5919` in citedrift.test.js
