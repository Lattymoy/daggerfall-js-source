...
`playerTicker.advance(60)` (`exterior.js:905`, `world.js:778`), fired
...
it (`renderer.js:1846`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:1836`), and `BB_VS`
