...
`playerTicker.advance(60)` (`exterior.js:1031`, `world.js:1219`), fired
...
`world.js:2354` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5336` in citedrift.test.js
