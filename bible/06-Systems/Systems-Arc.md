...
`playerTicker.advance(60)` (`exterior.js:901`, `world.js:812`), fired
...
it (`renderer.js:1841`). `colors` was `undefined`, `asBytes` reads
...
`world.js:1658` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:3810` in citedrift.test.js
