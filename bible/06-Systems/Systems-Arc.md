...
`playerTicker.advance(60)` (`exterior.js:938`, `world.js:861`), fired
...
it (`renderer.js:2399`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2389`), and `BB_VS`
...
`world.js:1720` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4162` in citedrift.test.js
