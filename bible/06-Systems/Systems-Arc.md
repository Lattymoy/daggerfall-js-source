...
`playerTicker.advance(60)` (`exterior.js:927`, `world.js:845`), fired
...
`world.js:1697` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:3944` in citedrift.test.js
