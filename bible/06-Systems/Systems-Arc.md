...
`playerTicker.advance(60)` (`exterior.js:981`, `world.js:1103`), fired
...
`world.js:2075` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5044` in citedrift.test.js
