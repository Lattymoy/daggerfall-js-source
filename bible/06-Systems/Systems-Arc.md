...
`playerTicker.advance(60)` (`exterior.js:979`, `world.js:1093`), fired
...
`world.js:2065` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4909` in citedrift.test.js
