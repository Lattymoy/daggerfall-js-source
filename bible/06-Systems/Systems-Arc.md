...
`playerTicker.advance(60)` (`exterior.js:922`, `world.js:834`), fired
...
it (`renderer.js:1896`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:1886`), and `BB_VS`
...
`world.js:1686` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:3908` in citedrift.test.js
