...
`playerTicker.advance(60)` (`exterior.js:957`, `world.js:966`), fired
...
`world.js:1928` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4558` in citedrift.test.js
