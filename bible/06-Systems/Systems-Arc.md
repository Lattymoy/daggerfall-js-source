...
`playerTicker.advance(60)` (`exterior.js:1064`, `world.js:1459`), fired
...
`world.js:2666` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5888` in citedrift.test.js
