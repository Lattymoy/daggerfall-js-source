...
`playerTicker.advance(60)` (`exterior.js:983`, `world.js:1124`), fired
...
`world.js:2197` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5178` in citedrift.test.js
