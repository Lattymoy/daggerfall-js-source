...
`playerTicker.advance(60)` (`exterior.js:969`, `world.js:1005`), fired
...
`world.js:1975` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4741` in citedrift.test.js
