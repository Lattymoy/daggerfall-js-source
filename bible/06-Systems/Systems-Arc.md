...
it (`renderer.js:3049`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:3039`), and `BB_VS`
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:6592` in citedrift.test.js
