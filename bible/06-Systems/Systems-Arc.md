...
it (`renderer.js:2649`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2639`), and `BB_VS`
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4748` in citedrift.test.js
