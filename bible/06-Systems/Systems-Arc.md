...
`playerTicker.advance(60)` (`exterior.js:919`, `world.js:831`), fired
...
`world.js:1683` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:3861` in citedrift.test.js
