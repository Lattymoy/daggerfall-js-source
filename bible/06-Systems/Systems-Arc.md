...
`playerTicker.advance(60)` (`exterior.js:957`, `world.js:967`), fired
...
it (`renderer.js:2431`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2421`), and `BB_VS`
...
`world.js:1930` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4560` in citedrift.test.js
