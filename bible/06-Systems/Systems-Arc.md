...
`playerTicker.advance(60)` (`exterior.js:926`, `world.js:844`), fired
...
`world.js:1696` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:3939` in citedrift.test.js
