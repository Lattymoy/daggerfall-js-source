...
`playerTicker.advance(60)` (`exterior.js:1066`, `world.js:1472`), fired
...
`world.js:2798` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:6053` in citedrift.test.js
