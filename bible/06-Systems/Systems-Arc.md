...
`playerTicker.advance(60)` (`exterior.js:1069`, `world.js:1705`), fired
...
`world.js:2931` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:6182` in citedrift.test.js
