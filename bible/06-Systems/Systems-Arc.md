...
`playerTicker.advance(60)` (`exterior.js:1066`, `world.js:1494`), fired
...
it (`renderer.js:3037`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:3027`), and `BB_VS`
...
`world.js:2801` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:6071` in citedrift.test.js
