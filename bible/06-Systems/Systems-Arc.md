...
`playerTicker.advance(60)` (`exterior.js:1065`, `world.js:1484`), fired
...
`world.js:2694` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5942` in citedrift.test.js
