...
it (`renderer.js:2802`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2792`), and `BB_VS`
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5826` in citedrift.test.js
