...
`playerTicker.advance(60)` (`exterior.js:894`, `world.js:776`), fired
...
it (`renderer.js:1844`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:1834`), and `BB_VS`
...
`world.js:1610` said the dungeon-mode enchant ctx was "FLAGGED there
