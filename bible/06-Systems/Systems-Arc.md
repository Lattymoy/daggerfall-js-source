...
`playerTicker.advance(60)` (`exterior.js:915`, `world.js:827`), fired
...
it (`renderer.js:1867`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:1857`), and `BB_VS`
...
`world.js:1676` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:3826` in citedrift.test.js
