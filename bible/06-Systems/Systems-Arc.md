...
`playerTicker.advance(60)` (`exterior.js:983`, `world.js:1193`), fired
...
`world.js:2276` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5257` in citedrift.test.js
