...
`playerTicker.advance(60)` (`exterior.js:980`, `world.js:1094`), fired
...
`world.js:2066` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4910` in citedrift.test.js
