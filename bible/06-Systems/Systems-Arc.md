...
it (`renderer.js:2895`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2885`), and `BB_VS`
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5884` in citedrift.test.js
