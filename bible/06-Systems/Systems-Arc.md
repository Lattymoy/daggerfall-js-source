...
`playerTicker.advance(60)` (`exterior.js:1066`, `world.js:1462`), fired
...
it (`renderer.js:3045`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:3035`), and `BB_VS`
