...
`playerTicker.advance(60)` (`exterior.js:943`, `world.js:870`), fired
...
`world.js:1743` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4278` in citedrift.test.js
