...
`playerTicker.advance(60)` (`exterior.js:923`, `world.js:835`), fired
...
`world.js:1687` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:3909` in citedrift.test.js
