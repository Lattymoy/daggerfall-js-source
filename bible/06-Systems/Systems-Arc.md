...
`playerTicker.advance(60)` (`exterior.js:983`, `world.js:1108`), fired
...
`world.js:2082` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5068` in citedrift.test.js
