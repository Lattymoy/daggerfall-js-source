...
`playerTicker.advance(60)` (`exterior.js:957`, `world.js:939`), fired
...
`world.js:1900` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4530` in citedrift.test.js
