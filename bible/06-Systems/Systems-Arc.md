...
`playerTicker.advance(60)` (`exterior.js:968`, `world.js:1004`), fired
...
`world.js:1974` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4670` in citedrift.test.js
