...
`playerTicker.advance(60)` (`exterior.js:1054`, `world.js:1439`), fired
...
`world.js:2646` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5804` in citedrift.test.js
