...
`playerTicker.advance(60)` (`exterior.js:1065`, `world.js:1462`), fired
...
it (`renderer.js:2810`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2800`), and `BB_VS`
...
`world.js:2672` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5907` in citedrift.test.js
