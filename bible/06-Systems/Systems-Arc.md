...
`playerTicker.advance(60)` (`exterior.js:1042`, `world.js:1419`), fired
...
`world.js:2622` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5730` in citedrift.test.js
