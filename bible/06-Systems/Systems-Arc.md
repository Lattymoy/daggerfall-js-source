...
`playerTicker.advance(60)` (`exterior.js:931`, `world.js:867`), fired
...
`world.js:1719` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4039` in citedrift.test.js
