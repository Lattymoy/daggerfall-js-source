...
`playerTicker.advance(60)` (`exterior.js:1042`, `world.js:1387`), fired
...
it (`renderer.js:2830`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:2820`), and `BB_VS`
...
`world.js:2590` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5691` in citedrift.test.js
