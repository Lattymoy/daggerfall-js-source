...
`playerTicker.advance(60)` (`exterior.js:1042`, `world.js:1376`), fired
...
`world.js:2578` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5671` in citedrift.test.js
