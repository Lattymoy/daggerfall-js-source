...
`playerTicker.advance(60)` (`exterior.js:1069`, `world.js:1843`), fired
...
`world.js:3069` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:6324` in citedrift.test.js
