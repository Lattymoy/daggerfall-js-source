...
`playerTicker.advance(60)` (`exterior.js:927`, `world.js:848`), fired
...
`world.js:1700` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:3947` in citedrift.test.js
