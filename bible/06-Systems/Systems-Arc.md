...
`playerTicker.advance(60)` (`exterior.js:970`, `world.js:1066`), fired
...
`world.js:2036` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4749` in citedrift.test.js
