...
`playerTicker.advance(60)` (`exterior.js:1066`, `world.js:1474`), fired
...
`world.js:2684` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5918` in citedrift.test.js
