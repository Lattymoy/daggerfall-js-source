...
`playerTicker.advance(60)` (`exterior.js:974`, `world.js:1052`), fired
...
`world.js:2022` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4779` in citedrift.test.js
