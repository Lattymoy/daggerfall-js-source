...
`playerTicker.advance(60)` (`exterior.js:1066`, `world.js:1466`), fired
...
`world.js:2676` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:5909` in citedrift.test.js
