...
`playerTicker.advance(60)` (`exterior.js:925`, `world.js:837`), fired
...
it (`renderer.js:1897`). `colors` was `undefined`, `asBytes` reads
...
leaves `UNPACK_FLIP_Y_WEBGL` off (`renderer.js:1887`), and `BB_VS`
...
`world.js:1689` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:3926` in citedrift.test.js
