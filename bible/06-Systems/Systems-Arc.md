...
`playerTicker.advance(60)` (`exterior.js:957`, `world.js:965`), fired
...
`world.js:1926` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:4556` in citedrift.test.js
