...
`playerTicker.advance(60)` (`exterior.js:1066`, `world.js:1465`), fired
...
`world.js:2764` said the dungeon-mode enchant ctx was "FLAGGED there
...
LITERAL FOLLOWS THE ROW IT PINS: `world\.js:6006` in citedrift.test.js
