...
this player's own" (`dungeonContext.js:1194`, AUDIT WORLD B2): a quest
...
(`dungeonContext.js:4321`). With the property missing that call is a
...
- **A summon or ally cannot kill a peer's foe.** `fromPlayer === false`
  ...
  in it.
- **A foe's blast on a puppet is credited to ME.** `world.js:4373` and
