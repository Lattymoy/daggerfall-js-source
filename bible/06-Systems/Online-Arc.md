...
this player's own" (`dungeonContext.js:1055`, AUDIT WORLD B2): a quest
...
`src/scenes/worldModes.js:5121` read, on one physical line:
...
- **A summon or ally cannot kill a peer's foe.** `fromPlayer === false`
  ...
  in it.
- **A foe's blast on a puppet is credited to ME.** `world.js:3184` and
