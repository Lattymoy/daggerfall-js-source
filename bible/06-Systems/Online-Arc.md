...
this player's own" (`dungeonContext.js:1112`, AUDIT WORLD B2): a quest
...
(`dungeonContext.js:4133`). With the property missing that call is a
...
- **A summon or ally cannot kill a peer's foe.** `fromPlayer === false`
  ...
  in it.
- **A foe's blast on a puppet is credited to ME.** `world.js:3445` and
...
**Now (`src/net/wire.js:756`, `src/net/online.js:1230`):**
