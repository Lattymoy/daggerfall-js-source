...
this player's own" (`dungeonContext.js:1191`, AUDIT WORLD B2): a quest
...
(`dungeonContext.js:4318`). With the property missing that call is a
...
- **A summon or ally cannot kill a peer's foe.** `fromPlayer === false`
  ...
  in it.
- **A foe's blast on a puppet is credited to ME.** `world.js:4330` and
...
**Now (`src/net/wire.js:896`, `src/net/online.js:1710`):**
