...
- **CITE-SLASH.** RF3's grammar read a bare `/N` after a cite, anywhere up to the next cite, as that cite's line. So
  "8076/8077", a sentence after `world.js:4396`, was world.js:9043 to both tools, and it moved whenever that line did.
  A bare `/N` now continues only the chain it touches: `world.js:7461/7462`, `:13/15`. The colon forms keep RF3's
