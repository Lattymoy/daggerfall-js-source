...
| `worldModes.js:7166` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:7348` | the interior's flats and peers |
| `worldModes.js:7354-7412` | blood, torches, drops, foes, guards - **five separate uncut calls** |
| `exterior.js:5222`, `world.js:13626` | the spell missiles |
| `exterior.js:5300` | the fixed city's townspeople |
