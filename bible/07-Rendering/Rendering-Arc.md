...
| host | list |
|---|---|
| `dungeonContext.js:5081` | the mobiles, the drops, the spells |
| `worldModes.js:6147` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:6316` | the interior's flats and peers |
| `worldModes.js:6322-6356` | blood, torches, drops, foes, guards - **five separate uncut calls** |
| `exterior.js:4786`, `world.js:10719` | the spell missiles |
| `exterior.js:4848` | the fixed city's townspeople |
