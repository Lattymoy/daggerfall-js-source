...
| `worldModes.js:6940` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:7122` | the interior's flats and peers |
| `worldModes.js:7128-7186` | blood, torches, drops, foes, guards - **five separate uncut calls** |
