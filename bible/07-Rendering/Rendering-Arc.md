...
| host | list |
|---|---|
| `dungeonContext.js:5364` | the mobiles, the drops, the spells |
| `worldModes.js:7213` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:7395` | the interior's flats and peers |
| `worldModes.js:7401-7465` | blood, torches, drops, foes, guards - **five separate uncut calls** |
| `exterior.js:5259`, `world.js:14104` | the spell missiles |
| `exterior.js:5337` | the fixed city's townspeople |
