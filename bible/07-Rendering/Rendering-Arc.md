...
| `worldModes.js:6321` | the interior's flats and peers |
| `worldModes.js:6327-6361` | blood, torches, drops, foes, guards - **five separate uncut calls** |
| `exterior.js:4793`, `world.js:10710` | the spell missiles |
| `exterior.js:4855` | the fixed city's townspeople |
