...
| `worldModes.js:6239` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:6421` | the interior's flats and peers |
| `worldModes.js:6427-6462` | blood, torches, drops, foes, guards - **five separate uncut calls** |
