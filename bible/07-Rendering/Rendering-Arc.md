...
| `worldModes.js:6340` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:6522` | the interior's flats and peers |
| `worldModes.js:6528-6563` | blood, torches, drops, foes, guards - **five separate uncut calls** |
