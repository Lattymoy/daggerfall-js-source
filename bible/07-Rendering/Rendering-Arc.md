...
| `worldModes.js:7205` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:7387` | the interior's flats and peers |
| `worldModes.js:7393-7457` | blood, torches, drops, foes, guards - **five separate uncut calls** |
