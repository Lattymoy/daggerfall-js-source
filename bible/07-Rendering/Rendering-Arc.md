...
| `worldModes.js:7665` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:7854` | the interior's flats and peers |
| `worldModes.js:7860-7926` | blood, torches, drops, foes, guards - **five separate uncut calls** |
