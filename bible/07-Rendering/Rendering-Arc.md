...
| `worldModes.js:6832` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:7014` | the interior's flats and peers |
| `worldModes.js:7020-7078` | blood, torches, drops, foes, guards - **five separate uncut calls** |
| `exterior.js:4918`, `world.js:11153` | the spell missiles |
| `exterior.js:4980` | the fixed city's townspeople |
| `interior.js:360`, `dungeon.js:1021` | the flats, the camps, the torches |
