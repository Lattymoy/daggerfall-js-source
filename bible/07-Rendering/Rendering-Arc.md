...
| host | list |
|---|---|
| `dungeonContext.js:5378` | the mobiles, the drops, the spells |
| `worldModes.js:7214` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:7396` | the interior's flats and peers |
| `worldModes.js:7402-7467` | blood, torches, drops, foes, guards - **five separate uncut calls** |
| `exterior.js:5249`, `world.js:14065` | the spell missiles |
