...
| host | list |
|---|---|
| `dungeonContext.js:5454` | the mobiles, the drops, the spells |
| `worldModes.js:7601` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:7790` | the interior's flats and peers |
| `worldModes.js:7796-7862` | blood, torches, drops, foes, guards - **five separate uncut calls** |
| `exterior.js:5268`, `world.js:14670` | the spell missiles |
| `exterior.js:5344` | the fixed city's townspeople |
| `interior.js:374`, `dungeon.js:1069` | the flats, the camps, the torches |
