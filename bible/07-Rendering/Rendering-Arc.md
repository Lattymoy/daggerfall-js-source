...
| `worldModes.js:7115` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:7297` | the interior's flats and peers |
| `worldModes.js:7303-7361` | blood, torches, drops, foes, guards - **five separate uncut calls** |
| `exterior.js:5185`, `world.js:13580` | the spell missiles |
| `exterior.js:5263` | the fixed city's townspeople |
