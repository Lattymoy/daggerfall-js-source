...
| `worldModes.js:6141` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:6310` | the interior's flats and peers |
| `worldModes.js:6316-6350` | blood, torches, drops, foes, guards - **five separate uncut calls** |
