...
| host | list |
|---|---|
| `dungeonContext.js:5142` | the mobiles, the drops, the spells |
| `worldModes.js:6198` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:6382` | the interior's flats and peers |
| `worldModes.js:6388-6423` | blood, torches, drops, foes, guards - **five separate uncut calls** |
| `exterior.js:4811`, `world.js:10864` | the spell missiles |
| `exterior.js:4873` | the fixed city's townspeople |
| `interior.js:352`, `dungeon.js:1012` | the flats, the camps, the torches |
