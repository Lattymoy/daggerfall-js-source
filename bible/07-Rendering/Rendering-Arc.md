...
| host | list |
|---|---|
| `dungeonContext.js:5189` | the mobiles, the drops, the spells |
| `worldModes.js:6198` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:6380` | the interior's flats and peers |
| `worldModes.js:6386-6421` | blood, torches, drops, foes, guards - **five separate uncut calls** |
| `exterior.js:4823`, `world.js:10907` | the spell missiles |
