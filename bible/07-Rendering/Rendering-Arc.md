...
| `worldModes.js:7700` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:7891` | the interior's flats and peers |
| `worldModes.js:7897-7963` | blood, torches, drops, foes, guards - **five separate uncut calls** |
