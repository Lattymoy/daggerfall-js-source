...
| host | list |
|---|---|
| `dungeonContext.js:5168` | the mobiles, the drops, the spells |
| `worldModes.js:6201` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:6383` | the interior's flats and peers |
| `worldModes.js:6389-6424` | blood, torches, drops, foes, guards - **five separate uncut calls** |
