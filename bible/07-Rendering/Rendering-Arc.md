...
| host | list |
|---|---|
| `dungeonContext.js:5289` | the mobiles, the drops, the spells |
| `worldModes.js:6996` | the dungeon's flats, camps, torches and peers |
| `worldModes.js:7178` | the interior's flats and peers |
| `worldModes.js:7184-7242` | blood, torches, drops, foes, guards - **five separate uncut calls** |
| `exterior.js:4981`, `world.js:11762` | the spell missiles |
