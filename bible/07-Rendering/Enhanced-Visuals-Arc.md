...
frame per crossing (world.js:7051-7053).

frame per crossing (world.js:10472-10482).
...
per frame (renderer.js:2642 - thousands of strings/frame, the single
...
- `_clockLit` (renderer.js:730) is a regression latch: set once,
