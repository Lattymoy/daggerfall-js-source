...
frame per crossing (world.js:7158-7160).

frame per crossing (world.js:10624-10634).
...
per frame (renderer.js:2984 - thousands of strings/frame, the single
...
- `_clockLit` (renderer.js:881) is a regression latch: set once,
