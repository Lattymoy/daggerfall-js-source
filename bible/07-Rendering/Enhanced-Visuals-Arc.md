...
frame per crossing (world.js:9404-9406).

frame per crossing (world.js:15705-15728).
...
per frame (renderer.js:3392 - thousands of strings/frame, the single
...
- `_clockLit` (renderer.js:908) is a regression latch: set once,
