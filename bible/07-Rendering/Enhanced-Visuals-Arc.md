...
frame per crossing (world.js:8518-8520).

frame per crossing (world.js:13858-13874).
...
per frame (renderer.js:3283 - thousands of strings/frame, the single
...
- `_clockLit` (renderer.js:932) is a regression latch: set once,
