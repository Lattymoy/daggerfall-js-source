...
frame per crossing (world.js:4980-4982).

frame per crossing (world.js:7101-7103).
...
per frame (renderer.js:1824 - thousands of strings/frame, the single
...
- `_clockLit` (renderer.js:577) is a regression latch: set once,
