...
frame per crossing (world.js:7596-7598).

frame per crossing (world.js:12112-12122).
...
per frame (renderer.js:3043 - thousands of strings/frame, the single
...
- `_clockLit` (renderer.js:930) is a regression latch: set once,
