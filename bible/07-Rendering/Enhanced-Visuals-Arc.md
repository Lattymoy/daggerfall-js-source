...
frame per crossing (world.js:7146-7148).

frame per crossing (world.js:10606-10616).
...
per frame (renderer.js:2965 - thousands of strings/frame, the single
...
- `_clockLit` (renderer.js:874) is a regression latch: set once,
