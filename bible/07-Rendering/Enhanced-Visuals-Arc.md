...
frame per crossing (world.js:9633-9635).

frame per crossing (world.js:15963-15986).
...
per frame (renderer.js:3395 - thousands of strings/frame, the single
...
- `_clockLit` (renderer.js:906) is a regression latch: set once,
