...
frame per crossing (world.js:7061-7063).

frame per crossing (world.js:10482-10492).
...
per frame (renderer.js:2675 - thousands of strings/frame, the single
...
- `_clockLit` (renderer.js:755) is a regression latch: set once,
