...
frame per crossing (world.js:6936-6938).

frame per crossing (world.js:10351-10353).
...
per frame (renderer.js:2598 - thousands of strings/frame, the single
...
- `_clockLit` (renderer.js:710) is a regression latch: set once,
