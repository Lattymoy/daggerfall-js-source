...
frame per crossing (world.js:7395-7397).

frame per crossing (world.js:10891-10901).
...
per frame (renderer.js:3064 - thousands of strings/frame, the single
...
- `_clockLit` (renderer.js:951) is a regression latch: set once,
