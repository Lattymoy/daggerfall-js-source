...
frame per crossing (world.js:7292-7294).

frame per crossing (world.js:10787-10797).
...
per frame (renderer.js:3022 - thousands of strings/frame, the single
...
- `_clockLit` (renderer.js:909) is a regression latch: set once,
