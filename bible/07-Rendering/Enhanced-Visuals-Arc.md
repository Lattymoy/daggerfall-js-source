...
frame per crossing (world.js:5599-5601).

frame per crossing (world.js:8271-8273).
...
per frame (renderer.js:1942 - thousands of strings/frame, the single
...
- `_clockLit` (renderer.js:617) is a regression latch: set once,
