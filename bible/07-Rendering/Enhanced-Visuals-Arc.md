...
frame per crossing (world.js:8537-8539).

frame per crossing (world.js:14208-14224).
...
per frame (renderer.js:3284 - thousands of strings/frame, the single
...
- `_clockLit` (renderer.js:888) is a regression latch: set once,
