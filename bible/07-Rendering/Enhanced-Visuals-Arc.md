...
frame per crossing (world.js:5794-5796).

frame per crossing (world.js:8862-8864).
...
per frame (renderer.js:1972 - thousands of strings/frame, the single
...
- `_clockLit` (renderer.js:619) is a regression latch: set once,
