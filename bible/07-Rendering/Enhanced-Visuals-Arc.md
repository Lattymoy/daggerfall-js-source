...
frame per crossing (world.js:5903-5905).

frame per crossing (world.js:9036-9038).
...
per frame (renderer.js:2224 - thousands of strings/frame, the single
...
- `_clockLit` (renderer.js:634) is a regression latch: set once,
