...
frame per crossing (world.js:8536-8538).

frame per crossing (world.js:14270-14286).
...
per frame (renderer.js:3142 - thousands of strings/frame, the single
...
- `_clockLit` (renderer.js:887) is a regression latch: set once,
