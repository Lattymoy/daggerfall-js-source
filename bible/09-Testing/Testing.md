...
Node 22). Suite: 135 tests across 23 files.
...
| enterexit.test.js | 3 | verbatim landing offsets, door transforms, marker-snap/closest-door landings |
...
1. **Synthetic fixtures** - in-memory data built inside the test. Always run;
   CI stays green with no game data (86 pass, 49 skip).
