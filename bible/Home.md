...
- `04-Characters/Characters-Arc.md` - ACTIVE. C2 shipped: exterior NPCs (faction rule verbatim, 76-NPC corpus) + townsfolk name banks (NameHelper over DFRandom, NameGen data committed). Next: C3 dungeon enemy data.
