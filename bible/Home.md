...
## Open flags (regenerated 2026-08-18, AUDIT 17i)
...
- `src/scenes/dungeonContext.js:774` - FLAGGED: DFU recomputes per-effect via the cost tables (that
- `src/scenes/dungeonContext.js:776` - FLAGGED to the effect library (caster-only buffs, touch, areas).
- `src/scenes/dungeonContext.js:988` - 129; the inventory/equip UI pends - the INTERIM dagger note
- `src/scenes/dungeonContext.js:1726` - actions) is FLAGGED - the player snapshot only.
