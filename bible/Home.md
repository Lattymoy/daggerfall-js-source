...
- `src/scenes/world.js:1648` - *  through the `if`. This host's FLAGGED note (below, at the mode
- `src/scenes/world.js:2690` - landing stands in for it - FLAGGED for the first session with
- `src/scenes/world.js:4006` - slot. Dungeon-mode popups pend the dungeon overlay seam (FLAGGED:
- `src/scenes/world.js:5066` - ROAD-B CLOSED THE FLAG THAT STOOD HERE. It read: "FLAGGED: DFU's
- `src/scenes/world.js:6236` - building doors are the E-enter seam, not bashables - FLAGGED
