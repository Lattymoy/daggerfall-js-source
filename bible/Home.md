...
- `src/scenes/world.js:1022` - (FLAGGED); swallowing the browser reload is not optional.
- `src/scenes/world.js:1399` - exemption (PlayerTileMapIndex == 0) is FLAGGED: this host
- `src/scenes/world.js:1659` - doors are the E-enter seam, not bashables - FLAGGED with the
