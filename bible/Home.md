...
- `src/scenes/world.js:1002` - S3d: the INTERIM dagger seed is the FALLBACK only - a character
- `src/scenes/world.js:1008` - pre-chargen INTERIM entity (flat skills 30, maxHealth 50) for the
- `src/scenes/world.js:2221` - landing stands in for it - FLAGGED for the first session with
- `src/scenes/world.js:3237` - slot. Dungeon-mode popups pend the dungeon overlay seam (FLAGGED:
- `src/scenes/world.js:4032` - castle interior (FLAGGED with the palace blocks).
- `src/scenes/world.js:5074` - building doors are the E-enter seam, not bashables - FLAGGED
