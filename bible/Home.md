...
- `src/scenes/world.js:2953` - slot. Dungeon-mode popups pend the dungeon overlay seam (FLAGGED:
- `src/scenes/world.js:3733` - castle interior (FLAGGED with the palace blocks).
- `src/scenes/world.js:4662` - building doors are the E-enter seam, not bashables - FLAGGED
...
- `src/ui/enhancedMenu.js:1568` - FLAGGED: the rest of the keyboard. The wizard walks to `done` with
- `src/ui/enhancedMenu.js:1739` - if (action === 'delete') return;   // FLAGGED: no save manager yet
