...
## Open flags (regenerated 2026-08-17, E1)
...
- `src/scenes/exterior.js:282` - it). say -> console FLAGGED: this host has no HUD-text layer yet.
- `src/scenes/exterior.js:336` - day-skip is a no-op FLAGGED until the shared calendar lands).
- `src/scenes/exterior.js:459` - (FLAGGED: the climate People table pends; the test city is
- `src/scenes/exterior.js:528` - FLAGGED here exactly as in world.js - no tile lookup yet).
...
- `src/scenes/world.js:420` - it). say -> console FLAGGED: this host has no HUD-text layer yet.
- `src/scenes/world.js:424` - FLAGGED loud: the People faction rides the START location's
- `src/scenes/world.js:506` - day-skip is a no-op FLAGGED until the shared calendar lands).
- `src/scenes/world.js:747` - exemption (PlayerTileMapIndex == 0) is FLAGGED: this host
- `src/scenes/world.js:926` - doors are the E-enter seam, not bashables - FLAGGED with the
