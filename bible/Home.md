...
- `src/scenes/exterior.js:619` - (FLAGGED: the climate People table pends; the test city is
- `src/scenes/exterior.js:730` - FLAGGED here exactly as in world.js - no tile lookup yet).
...
- `src/scenes/world.js:945` - exemption (PlayerTileMapIndex == 0) is FLAGGED: this host
- `src/scenes/world.js:1154` - doors are the E-enter seam, not bashables - FLAGGED with the
