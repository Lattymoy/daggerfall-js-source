...
- `src/ui/nativeInventory.js:146` - *  is 0 until those effect channels exist (FLAGGED). Exported so the
- `src/ui/nativeInventory.js:277` - *  ClickAnywhereToClose message box. FLAGGED loud, exactly as the
