...
- `src/scenes/world.js:1313` - exemption (PlayerTileMapIndex == 0) is FLAGGED: this host
- `src/scenes/world.js:1549` - doors are the E-enter seam, not bashables - FLAGGED with the
