...
## Open flags (regenerated 2026-08-17, U8g)
...
- `src/scenes/exterior.js:311` - preloadPaperDollArt({ renderer, fetchBytes, palette, getTexture });   // U8f/U8g: SCBG/...
...
- `src/scenes/world.js:440` - preloadPaperDollArt({ renderer, fetchBytes, palette, getTexture });   // U8f/U8g: SCBG/...
...
- `src/ui/nativeInventory.js:134` - INTERIM info panel: name/weight/value (DFU's 1016 info text
- `src/ui/nativeInventory.js:162` - use: FLAGGED - the use arc pends
