...
## Open flags (regenerated 2026-08-17, T3d)
...
- `src/scenes/world.js:419` - it). say -> console FLAGGED: this host has no HUD-text layer yet.
- `src/scenes/world.js:423` - FLAGGED loud: the People faction rides the START location's
- `src/scenes/world.js:505` - day-skip is a no-op FLAGGED until the shared calendar lands).
- `src/scenes/world.js:744` - exemption (PlayerTileMapIndex == 0) is FLAGGED: this host
- `src/scenes/world.js:920` - doors are the E-enter seam, not bashables - FLAGGED with the
