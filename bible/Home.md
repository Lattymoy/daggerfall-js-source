...
## Open flags (regenerated 2026-08-16d, the P15 slice)
...
- `src/scenes/exterior.js:373` - FLAGGED here exactly as in world.js - no tile lookup yet).
- `src/scenes/world.js:460` - exemption (PlayerTileMapIndex == 0) is FLAGGED: this host
