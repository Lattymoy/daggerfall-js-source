...
- `src/ui/enhancedMenu.js:857` - FLAGGED: the rest of the keyboard. The wizard walks to `done` with
- `src/ui/enhancedMenu.js:1007` - if (action === 'delete') return;   // FLAGGED: no save manager yet
