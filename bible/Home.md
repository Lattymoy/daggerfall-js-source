...
## Open flags (regenerated 2026-08-18, U14 backdrop + pointer)
...
- `src/ui/chargenArt.js:55` - U14 FLAGGED: the random-name button is drawn by the art but
- `src/ui/chargenArt.js:400` - AUDIT 17g FLAGGED: the scrollbar THUMB does not draw. Its geometry
