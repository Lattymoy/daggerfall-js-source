...
## Open flags (regenerated 2026-08-17, the G2 slice)
...
- `src/scenes/exterior.js:323` - day-skip is a no-op FLAGGED until the shared calendar lands).
- `src/scenes/exterior.js:444` - (FLAGGED: the climate People table pends; the test city is
- `src/scenes/exterior.js:513` - FLAGGED here exactly as in world.js - no tile lookup yet).
