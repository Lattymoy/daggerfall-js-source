...
- `src/scenes/exterior.js:617` - S3d: the INTERIM dagger seed is the FALLBACK only - a character
- `src/scenes/exterior.js:623` - pre-chargen INTERIM entity (flat skills 30, maxHealth 50) for the
- `src/scenes/exterior.js:861` - onTeleport: () => townTalk.say('(Recall pends here - the anchor machinery lives in the streaming ?world host)'),   // TP-slice INTERIM
- `src/scenes/exterior.js:1099` - PX3 FLAGGED: questMessages - this test host mounts no quest
- `src/scenes/exterior.js:1442` - (FLAGGED: the climate People table pends; the test city is
