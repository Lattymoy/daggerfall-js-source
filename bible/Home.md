...
- `src/scenes/world.js:4079` - castle interior (FLAGGED with the palace blocks).
- `src/scenes/world.js:5153` - building doors are the E-enter seam, not bashables - FLAGGED
