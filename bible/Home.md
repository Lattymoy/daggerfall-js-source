...
- `src/ui/enhancedMenu.js:1889` - FLAGGED: the rest of the keyboard. The wizard walks to `done` with
...
`dungeonContext.js:1655` before the fix): bare hands are a NULL weapon
