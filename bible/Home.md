...
- `03-World/Player-Arc.md` - ACTIVE. P3 shipped: walk into building interiors and back in ?world (verbatim landings 0.75/1.05). P5 shipped: world <-> dungeon transitions (enter at start marker, exit at the lowest entrance + 0.45). Next: ladders.
