...
- `src/scenes/world.js:3143` - exemption (PlayerTileMapIndex == 0) is FLAGGED: this host
- `src/scenes/world.js:3463` - doors are the E-enter seam, not bashables - FLAGGED with the
- `src/scenes/world.js:3536` - (FLAGGED: exterior corpse containers are the loot arc's), so
