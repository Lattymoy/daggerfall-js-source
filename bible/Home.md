...
- `src/scenes/dungeonContext.js:1096` - REPORTS ARE THIS ONE LINE, and it is FLAGGED rather than fixed because the fix is a slice,
...
- `src/ui/enhancedMenu.js:2810` - FLAGGED: the rest of the keyboard. The wizard walks to `done` with
