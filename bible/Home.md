...
- `src/scenes/world.js:599` - FLAGGED loud: the People faction rides the START location's
- `src/scenes/world.js:629` - S3d: the INTERIM dagger seed is the FALLBACK only - a character
- `src/scenes/world.js:635` - pre-chargen INTERIM entity (flat skills 30, maxHealth 50) for the
- `src/scenes/world.js:1146` - (FLAGGED); swallowing the browser reload is not optional.
- `src/scenes/world.js:1360` - slot. Dungeon-mode popups pend the dungeon overlay seam (FLAGGED:
