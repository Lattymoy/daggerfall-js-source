...
- `src/scenes/world.js:3392` - FLAGGED: the QuestComplete loot window pends the UI arc - the
- `src/scenes/world.js:3419` - castle interior (FLAGGED with the palace blocks).
- `src/scenes/world.js:3927` - exemption (PlayerTileMapIndex == 0) is FLAGGED: this host
- `src/scenes/world.js:4301` - doors are the E-enter seam, not bashables - FLAGGED with the
