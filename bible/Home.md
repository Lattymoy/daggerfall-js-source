...
- `src/ui/enhancedMenu.js:2198` - FLAGGED: the rest of the keyboard. The wizard walks to `done` with
...
`dungeonContext.js:1680` before the fix): bare hands are a NULL weapon
