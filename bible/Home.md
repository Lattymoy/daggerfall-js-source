...
- `src/scenes/exterior.js:793` - (FLAGGED: the climate People table pends; the test city is
- `src/scenes/exterior.js:928` - FLAGGED here exactly as in world.js - no tile lookup yet).
...
- `src/scenes/world.js:1012` - (FLAGGED); swallowing the browser reload is not optional.
- `src/scenes/world.js:1370` - exemption (PlayerTileMapIndex == 0) is FLAGGED: this host
- `src/scenes/world.js:1629` - doors are the E-enter seam, not bashables - FLAGGED with the
