...
## Open flags (regenerated 2026-08-17, the G1 slice)
...
- `src/scenes/exterior.js:280` - it). say -> console FLAGGED: this host has no HUD-text layer yet.
- `src/scenes/exterior.js:435` - (FLAGGED: the climate People table pends; the test city is
- `src/scenes/exterior.js:504` - FLAGGED here exactly as in world.js - no tile lookup yet).
- `src/scenes/townTalk.js:16` - FLAGGED loud: Info mode opens the same talk window (DFU routes
- `src/scenes/world.js:406` - it). say -> console FLAGGED: this host has no HUD-text layer yet.
- `src/scenes/world.js:410` - FLAGGED loud: the People faction rides the START location's
- `src/scenes/world.js:683` - exemption (PlayerTileMapIndex == 0) is FLAGGED: this host
- `src/scenes/world.js:858` - doors are the E-enter seam, not bashables - FLAGGED with the
