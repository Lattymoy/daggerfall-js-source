...
- `src/scenes/exterior.js:726` - FLAGGED here exactly as in world.js - no tile lookup yet).
...
- `src/scenes/world.js:941` - exemption (PlayerTileMapIndex == 0) is FLAGGED: this host
- `src/scenes/world.js:1150` - doors are the E-enter seam, not bashables - FLAGGED with the
