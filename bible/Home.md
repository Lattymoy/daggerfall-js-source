...
- `src/scenes/world.js:556` - FLAGGED loud: the People faction rides the START location's
- `src/scenes/world.js:577` - S3d: the INTERIM dagger seed is the FALLBACK only - a character
- `src/scenes/world.js:583` - pre-chargen INTERIM entity (flat skills 30, maxHealth 50) for the
- `src/scenes/world.js:866` - (FLAGGED); swallowing the browser reload is not optional.
- `src/scenes/world.js:1191` - exemption (PlayerTileMapIndex == 0) is FLAGGED: this host
- `src/scenes/world.js:1406` - doors are the E-enter seam, not bashables - FLAGGED with the
