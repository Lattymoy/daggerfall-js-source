...
- `src/ui/enhancedMenu.js:2323` - FLAGGED: the rest of the keyboard. The wizard walks to `done` with
...
`dungeonContext.js:1715` before the fix): bare hands are a NULL weapon
