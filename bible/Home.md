...
## Open flags (regenerated 2026-08-18, AUDIT 17g)

Regenerated at the AUDIT 17g close: no flag RETIRED this pass - the
audit shipped fixes, not slices - and one was ADDED, the class
picker's scrollbar thumb (geometry verbatim, art unidentified). Line numbers refreshed. Every row below is a live
...
- `src/ui/chargenArt.js:281` - AUDIT 17g FLAGGED: the scrollbar THUMB does not draw. Its geometry
