...
- `10-UI/UI-Arc.md` - ACTIVE. U1 HUD, U2a text, U2b chargen, U3 level-up + sheet, U4 inventory/spellbook/death, U5 POPUP MESSAGES (pickup/skill/level/heal/equip/ready feedback) SHIPPED. Queue: input map, window art, TEXT.RSC.
