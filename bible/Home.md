...
- `src/ui/enhancedMenu.js:1573` - FLAGGED: the rest of the keyboard. The wizard walks to `done` with
- `src/ui/enhancedMenu.js:1744` - if (action === 'delete') return;   // FLAGGED: no save manager yet
