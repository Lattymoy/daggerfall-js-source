...
## Open flags (regenerated 2026-08-17, U8a)
...
- `src/scenes/townTalk.js:313` - .replaceAll('%hnr', 'Sir').replaceAll('%ra', 'Breton');   // honorific/race macros FLAG...
...
- `src/scenes/worldModes.js:67` - say -> console FLAGGED: the interior HUD-text layer pends its arc.
- `src/scenes/worldModes.js:98` - if (!isShop(b.buildingType)) return;   // Library/Guild/Temple bookshelves + owned-hous...
