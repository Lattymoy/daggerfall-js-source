...
## Open flags (regenerated 2026-08-17, T3e)
...
- `src/scenes/townTalk.js:268` - .replaceAll('%hnr', 'Sir').replaceAll('%ra', 'Breton');   // honorific/race macros FLAG...
