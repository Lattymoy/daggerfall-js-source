...
- `src/scenes/world.js:1371` - exemption (PlayerTileMapIndex == 0) is FLAGGED: this host
- `src/scenes/world.js:1631` - doors are the E-enter seam, not bashables - FLAGGED with the
