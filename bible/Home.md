...
- `06-Systems/Systems-Arc.md` - ACTIVE. S1-S10 + S11 SAVE/LOAD (the DFU-shape player snapshot, F9/F12, quickload piercing the death screen; world state flagged) SHIPPED. Next: economy/shops, quests, or the world snapshot.
