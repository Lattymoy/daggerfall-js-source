...
- `src/scenes/world.js:3865` - doors are the E-enter seam, not bashables - FLAGGED with the
- `src/scenes/world.js:3938` - (FLAGGED: exterior corpse containers are the loot arc's), so
