...
- `src/characters/enemyMotor.js:382` - FLAGGED, until target prediction ships). At zero the foe stops.
...
- `src/scenes/world.js:562` - FLAGGED loud: the People faction rides the START location's
