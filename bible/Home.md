...
- `06-Systems/Systems-Arc.md` - ACTIVE. S1-S14 + S15 THE DRAIN/TRANSFER/HEAL-ATTRIBUTE + FATIGUE + REGENERATE FAMILIES (2026-08-16: the fatigue stat x64, the (10,9)=HealFatigue parity fix retiring the wrong HealSpellPoints key, the GetMagnitude CasterOnly save gate + verbatim roll order) SHIPPED. Next: enemy spellcasting (F15), cures (with disease/poison), or economy.
