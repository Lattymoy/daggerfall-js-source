...
- `src/ui/nativeInventory.js:144` - *  is 0 until those effect channels exist (FLAGGED). Exported so the
- `src/ui/nativeInventory.js:280` - *  ClickAnywhereToClose message box. FLAGGED loud, exactly as the
