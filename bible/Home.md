...
- `src/ui/nativeTalk.js:218` - lands with the Tell-me-about slice (FLAGGED).
- `src/ui/nativeTalk.js:236` - B5-6: the four pages that were INTERIM no-ops. Each falls back
