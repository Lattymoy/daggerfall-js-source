...
## Open flags (regenerated 2026-08-18, U17)

Regenerated at the U17 close: ONE flag RETIRED and its sentence
DELETED, per the rule - chargenArt's "DFU's rollout carries THREE
LeftRightSpinners ... the port collapses that to one cursor" is gone,
because all three now draw. Line numbers refreshed.
...
- `src/ui/chargenArt.js:492` - AUDIT 17g FLAGGED: the scrollbar THUMB does not draw. Its geometry
