...
- `src/scenes/exterior.js:1077` - onTeleport: () => townTalk.say('(Recall pends here - the anchor machinery lives in the streaming ?world host)'),   // TP-slice INTERIM
- `src/scenes/exterior.js:1332` - PX3 FLAGGED: questMessages - this test host mounts no quest
...
- `src/ui/enhancedMenu.js:1788` - FLAGGED: the rest of the keyboard. The wizard walks to `done` with
