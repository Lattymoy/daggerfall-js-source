...
## Open flags (regenerated 2026-08-17, the C17 slice)
...
- `src/scenes/exterior.js:267` - it). say -> console FLAGGED: this host has no HUD-text layer yet.
- `src/scenes/exterior.js:407` - FLAGGED here exactly as in world.js - no tile lookup yet).
