...
- `src/ui/enhancedMenu.js:1223` - FLAGGED: the rest of the keyboard. The wizard walks to `done` with
- `src/ui/enhancedMenu.js:1377` - if (action === 'delete') return;   // FLAGGED: no save manager yet
