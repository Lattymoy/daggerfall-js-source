...
- `src/scenes/world.js:2207` - landing stands in for it - FLAGGED for the first session with
- `src/scenes/world.js:3223` - slot. Dungeon-mode popups pend the dungeon overlay seam (FLAGGED:
- `src/scenes/world.js:4018` - castle interior (FLAGGED with the palace blocks).
- `src/scenes/world.js:5060` - building doors are the E-enter seam, not bashables - FLAGGED
