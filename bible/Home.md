...
- `src/scenes/world.js:2950` - slot. Dungeon-mode popups pend the dungeon overlay seam (FLAGGED:
- `src/scenes/world.js:3730` - castle interior (FLAGGED with the palace blocks).
- `src/scenes/world.js:4659` - building doors are the E-enter seam, not bashables - FLAGGED
