...
- `src/scenes/world.js:559` - FLAGGED loud: the People faction rides the START location's
- `src/scenes/world.js:580` - S3d: the INTERIM dagger seed is the FALLBACK only - a character
- `src/scenes/world.js:586` - pre-chargen INTERIM entity (flat skills 30, maxHealth 50) for the
- `src/scenes/world.js:917` - (FLAGGED); swallowing the browser reload is not optional.
- `src/scenes/world.js:1247` - exemption (PlayerTileMapIndex == 0) is FLAGGED: this host
- `src/scenes/world.js:1483` - doors are the E-enter seam, not bashables - FLAGGED with the
