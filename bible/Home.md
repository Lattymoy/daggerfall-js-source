...
- `src/scenes/exterior.js:944` - FLAGGED here exactly as in world.js - no tile lookup yet).
...
- `src/scenes/world.js:1468` - exemption (PlayerTileMapIndex == 0) is FLAGGED: this host
- `src/scenes/world.js:1729` - doors are the E-enter seam, not bashables - FLAGGED with the
