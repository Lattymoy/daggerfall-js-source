...
and both of whose WINDOW-level handlers (`world.js:7189-7190`,
`exterior.js:3048-3049`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:13169` already did at its
