...
and both of whose WINDOW-level handlers (`world.js:5279-5280`,
`exterior.js:2542-2543`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:8816` already did at its
