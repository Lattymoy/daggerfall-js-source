...
and both of whose WINDOW-level handlers (`world.js:7947-7948`,
`exterior.js:3218-3219`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:14112` already did at its
