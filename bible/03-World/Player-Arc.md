...
- **systems/breath.js**: PlayerEntity.FixedUpdate's breath clause
  ...
  (worldModes.js:821). exterior.js and world.js have no submersion
...
and both of whose WINDOW-level handlers (`world.js:8092-8093`,
`exterior.js:3258-3259`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:15064` already did at its
