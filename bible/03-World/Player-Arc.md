...
and both of whose WINDOW-level handlers (`world.js:7171-7172`,
`exterior.js:3047-3048`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:12920` already did at its
