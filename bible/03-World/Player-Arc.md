...
and both of whose WINDOW-level handlers (`world.js:6415-6416`,
`exterior.js:2873-2874`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:10733` already did at its
