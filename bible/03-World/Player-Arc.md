...
and both of whose WINDOW-level handlers (`world.js:5765-5766`,
`exterior.js:2789-2790`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:9815` already did at its
