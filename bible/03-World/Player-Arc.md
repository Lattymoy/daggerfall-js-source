...
and both of whose WINDOW-level handlers (`world.js:5456-5457`,
`exterior.js:2640-2641`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:9390` already did at its
