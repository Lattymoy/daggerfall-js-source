...
and both of whose WINDOW-level handlers (`world.js:6720-6721`,
`exterior.js:2945-2946`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:11319` already did at its
