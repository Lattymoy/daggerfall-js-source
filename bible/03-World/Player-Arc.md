...
and both of whose WINDOW-level handlers (`world.js:6402-6403`,
`exterior.js:2861-2862`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:10696` already did at its
