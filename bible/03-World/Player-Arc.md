...
and both of whose WINDOW-level handlers (`world.js:8146-8147`,
`exterior.js:3255-3256`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:15128` already did at its
