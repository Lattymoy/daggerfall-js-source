...
- **systems/breath.js**: PlayerEntity.FixedUpdate's breath clause
  ...
  (worldModes.js:691). exterior.js and world.js have no submersion
...
and both of whose WINDOW-level handlers (`world.js:5780-5781`,
...
motor's own mirror of that getter (`world.js:9839` already did at its
