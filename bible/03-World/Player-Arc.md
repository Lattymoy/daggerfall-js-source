...
and both of whose WINDOW-level handlers (`world.js:6251-6252`,
`exterior.js:2826-2827`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:10426` already did at its
