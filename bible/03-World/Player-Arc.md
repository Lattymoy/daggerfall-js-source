...
and both of whose WINDOW-level handlers (`world.js:5562-5563`,
`exterior.js:2704-2705`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:9549` already did at its
