...
and both of whose WINDOW-level handlers (`world.js:5190-5191`,
`exterior.js:2528-2529`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:8390` already did at its
