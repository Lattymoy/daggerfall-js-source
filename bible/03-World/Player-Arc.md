...
and both of whose WINDOW-level handlers (`world.js:6963-6964`,
`exterior.js:3012-3013`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:11664` already did at its
