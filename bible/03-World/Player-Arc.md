...
and both of whose WINDOW-level handlers (`world.js:8199-8200`,
`exterior.js:3257-3258`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:15188` already did at its
