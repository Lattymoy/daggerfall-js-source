...
and both of whose WINDOW-level handlers (`world.js:6951-6952`,
`exterior.js:3000-3001`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:11651` already did at its
