...
and both of whose WINDOW-level handlers (`world.js:8010-8011`,
`exterior.js:3238-3239`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:14486` already did at its
