...
and both of whose WINDOW-level handlers (`world.js:5854-5855`,
`exterior.js:2820-2821`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:9917` already did at its
