...
and both of whose WINDOW-level handlers (`world.js:5782-5783`,
`exterior.js:2779-2780`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:9824` already did at its
