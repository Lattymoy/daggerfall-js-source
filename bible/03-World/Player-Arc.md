...
and both of whose WINDOW-level handlers (`world.js:8555-8556`,
`exterior.js:3261-3262`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:15713` already did at its
