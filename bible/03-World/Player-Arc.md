...
and both of whose WINDOW-level handlers (`world.js:5713-5714`,
`exterior.js:2770-2771`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:9746` already did at its
