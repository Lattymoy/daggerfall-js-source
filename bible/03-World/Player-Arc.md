...
and both of whose WINDOW-level handlers (`world.js:6860-6861`,
`exterior.js:2976-2977`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:11560` already did at its
