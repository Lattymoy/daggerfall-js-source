...
and both of whose WINDOW-level handlers (`world.js:8112-8113`,
`exterior.js:3275-3276`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:15094` already did at its
