...
and both of whose WINDOW-level handlers (`world.js:7819-7820`,
`exterior.js:3184-3185`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:13914` already did at its
