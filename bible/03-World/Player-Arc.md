...
and both of whose WINDOW-level handlers (`world.js:7169-7170`,
`exterior.js:3044-3045`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:12910` already did at its
