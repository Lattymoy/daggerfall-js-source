...
and both of whose WINDOW-level handlers (`world.js:8324-8325`,
`exterior.js:3260-3261`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:15422` already did at its
