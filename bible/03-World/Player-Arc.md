...
and both of whose WINDOW-level handlers (`world.js:8341-8342`,
`exterior.js:3278-3279`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:15455` already did at its
