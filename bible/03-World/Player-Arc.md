...
and both of whose WINDOW-level handlers (`world.js:5305-5306`,
`exterior.js:2544-2545`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:8875` already did at its
