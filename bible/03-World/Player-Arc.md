...
and both of whose WINDOW-level handlers (`world.js:5381-5382`,
`exterior.js:2623-2624`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:9037` already did at its
