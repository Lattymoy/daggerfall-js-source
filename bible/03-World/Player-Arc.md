...
and both of whose WINDOW-level handlers (`world.js:6524-6525`,
`exterior.js:2892-2893`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:10987` already did at its
