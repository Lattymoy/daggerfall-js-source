...
and both of whose WINDOW-level handlers (`world.js:6717-6718`,
`exterior.js:2944-2945`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:11315` already did at its
