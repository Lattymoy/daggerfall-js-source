...
and both of whose WINDOW-level handlers (`world.js:7000-7001`,
`exterior.js:3038-3039`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:11791` already did at its
