...
- **systems/breath.js**: PlayerEntity.FixedUpdate's breath clause
  ...
  (worldModes.js:802). exterior.js and world.js have no submersion
...
`host` (`worldModes.js:398`), and its only two callers are `world.js`
(`:6147`) and `exterior.js` (`:2769`), both of which pass their own Set
and both of whose WINDOW-level handlers (`world.js:7097-7098`,
...
maps button 2 to `Mouse2` (`input.js:442`), which is the shipped
...
motor's own mirror of that getter (`world.js:12282` already did at its
