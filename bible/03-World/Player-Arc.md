...
and both of whose WINDOW-level handlers (`world.js:6390-6391`,
`exterior.js:2842-2843`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:10680` already did at its
