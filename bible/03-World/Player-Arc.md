...
- **systems/breath.js**: PlayerEntity.FixedUpdate's breath clause
  ...
  (worldModes.js:879). exterior.js and world.js have no submersion
...
`host` (`worldModes.js:435`), and its only two callers are `world.js`
(`:6147`) and `exterior.js` (`:2769`), both of which pass their own Set
and both of whose WINDOW-level handlers (`world.js:8392-8393`,
...
motor's own mirror of that getter (`world.js:15676` already did at its
