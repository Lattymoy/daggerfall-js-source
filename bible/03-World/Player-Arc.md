...
and both of whose WINDOW-level handlers (`world.js:6468-6469`,
`exterior.js:2890-2891`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:10802` already did at its
