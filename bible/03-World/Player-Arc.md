...
and both of whose WINDOW-level handlers (`world.js:7318-7319`,
`exterior.js:3133-3134`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:13407` already did at its
