...
and both of whose WINDOW-level handlers (`world.js:7374-7375`,
`exterior.js:3043-3044`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:13308` already did at its
