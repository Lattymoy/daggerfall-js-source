...
and both of whose WINDOW-level handlers (`world.js:7297-7298`,
`exterior.js:3125-3126`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:13310` already did at its
