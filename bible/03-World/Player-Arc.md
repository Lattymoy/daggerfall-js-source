...
- **systems/breath.js**: PlayerEntity.FixedUpdate's breath clause
  ...
  (worldModes.js:663). exterior.js and world.js have no submersion
...
and both of whose WINDOW-level handlers (`world.js:5240-5241`,
...
motor's own mirror of that getter (`world.js:8710` already did at its
