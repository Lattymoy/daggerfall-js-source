...
and both of whose WINDOW-level handlers (`world.js:7992-7993`,
`exterior.js:3234-3235`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:14199` already did at its
