...
and both of whose WINDOW-level handlers (`world.js:5147-5148`,
`exterior.js:2511-2512`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:8313` already did at its
