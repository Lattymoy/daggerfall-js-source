...
and both of whose WINDOW-level handlers (`world.js:5185-5186`,
`exterior.js:2523-2524`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:8385` already did at its
