...
- **systems/breath.js**: PlayerEntity.FixedUpdate's breath clause
  ...
  (worldModes.js:868). exterior.js and world.js have no submersion
...
`host` (`worldModes.js:428`), and its only two callers are `world.js`
...
motor's own mirror of that getter (`world.js:15215` already did at its
