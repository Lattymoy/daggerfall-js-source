...
- **systems/breath.js**: PlayerEntity.FixedUpdate's breath clause
  ...
  (worldModes.js:844). exterior.js and world.js have no submersion
...
`host` (`worldModes.js:421`), and its only two callers are `world.js`
...
motor's own mirror of that getter (`world.js:15214` already did at its
