...
and both of whose WINDOW-level handlers (`world.js:7292-7293`,
`exterior.js:3124-3125`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:13191` already did at its
