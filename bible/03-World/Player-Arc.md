...
and both of whose WINDOW-level handlers (`world.js:5522-5523`,
`exterior.js:2686-2687`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:9511` already did at its
