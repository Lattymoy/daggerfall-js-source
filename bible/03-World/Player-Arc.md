...
and both of whose WINDOW-level handlers (`world.js:5274-5275`,
`exterior.js:2543-2544`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:8844` already did at its
