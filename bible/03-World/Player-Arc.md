...
- **systems/breath.js**: PlayerEntity.FixedUpdate's breath clause
  ...
  (worldModes.js:886). exterior.js and world.js have no submersion
...
`host` (`worldModes.js:442`), and its only two callers are `world.js`
(`:6147`) and `exterior.js` (`:2769`), both of which pass their own Set
and both of whose WINDOW-level handlers (`world.js:8916-8917`,
...
motor's own mirror of that getter (`world.js:16809` already did at its
