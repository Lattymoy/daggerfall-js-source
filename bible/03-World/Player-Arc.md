...
and both of whose WINDOW-level handlers (`world.js:6394-6395`,
`exterior.js:2858-2859`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:10712` already did at its
