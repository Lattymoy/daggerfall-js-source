...
- **systems/breath.js**: PlayerEntity.FixedUpdate's breath clause
  ...
  (worldModes.js:816). exterior.js and world.js have no submersion
...
and both of whose WINDOW-level handlers (`world.js:8000-8001`,
`exterior.js:3229-3230`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:14481` already did at its
