...
and both of whose WINDOW-level handlers (`world.js:5346-5347`,
`exterior.js:2615-2616`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:8960` already did at its
