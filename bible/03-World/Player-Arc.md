...
and both of whose WINDOW-level handlers (`world.js:5282-5283`,
`exterior.js:2570-2571`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:8885` already did at its
