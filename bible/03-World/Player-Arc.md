...
and both of whose WINDOW-level handlers (`world.js:6761-6762`,
`exterior.js:2917-2918`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:11409` already did at its
