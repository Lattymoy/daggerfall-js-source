...
and both of whose WINDOW-level handlers (`world.js:5248-5249`,
`exterior.js:2521-2522`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:8763` already did at its
