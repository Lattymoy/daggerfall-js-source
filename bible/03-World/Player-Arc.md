...
and both of whose WINDOW-level handlers (`world.js:5413-5414`,
`exterior.js:2638-2639`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:9104` already did at its
