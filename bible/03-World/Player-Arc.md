...
and both of whose WINDOW-level handlers (`world.js:6728-6729`,
`exterior.js:2973-2974`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:11347` already did at its
