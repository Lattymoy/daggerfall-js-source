...
and both of whose WINDOW-level handlers (`world.js:5266-5267`,
`exterior.js:2532-2533`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:8792` already did at its
