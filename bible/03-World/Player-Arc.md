...
- **systems/breath.js**: PlayerEntity.FixedUpdate's breath clause
  ...
  (worldModes.js:746). exterior.js and world.js have no submersion
...
`host` (`worldModes.js:375`), and its only two callers are `world.js`
(`:6147`) and `exterior.js` (`:2769`), both of which pass their own Set
and both of whose WINDOW-level handlers (`world.js:6619-6620`,
`exterior.js:2908-2909`) call `mouseCode(e.button)` and add/delete
