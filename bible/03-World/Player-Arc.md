...
and both of whose WINDOW-level handlers (`world.js:5380-5381`,
`exterior.js:2624-2625`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:8994` already did at its
