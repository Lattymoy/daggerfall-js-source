...
and both of whose WINDOW-level handlers (`world.js:5763-5764`,
`exterior.js:2787-2788`) call `mouseCode(e.button)` and add/delete
...
motor's own mirror of that getter (`world.js:9813` already did at its
