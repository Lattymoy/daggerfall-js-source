...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        worldModes.js:2082 (the factory) and :1904 (a
                        HAND-ROLLED second one, 342 lines below it in
                        the same file),
                        dungeonContext.js:1015, world.js:2053,
    ...
    / NOTEBOOK          world.js:6176, dungeonContext.js:6449. A seam
...
worldModes.js:2899 as a second book built by hand 342 lines below the
...
`worldModes.js:5852` and `dungeonContext.js:1562` answer the same
...
that is 8907. `world.js:4431-4463` and `dungeonContext.js:1387` were
