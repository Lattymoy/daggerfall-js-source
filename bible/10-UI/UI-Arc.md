...
does the pack's USE arm.
    ...
    / NOTEBOOK          world.js:6069, dungeonContext.js:6145. A seam
...
the other half went stale unnoticed. (The rest cite named `world.js:6401`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:6407` now.)
...
read: `world.js:4598` named a line that is 8950, `:748` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:4334-4366` and `dungeonContext.js:1327` were
