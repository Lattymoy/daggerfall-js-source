...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:916, world.js:1628,
    ...
    / NOTEBOOK          world.js:1667, dungeonContext.js:3341. A seam
...
questJournal.js from charSheetNav:53, world.js:1930 and
...
the other half went stale unnoticed. (The rest cite named `world.js:5024`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5030` now.)
