...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        worldModes.js:1912 (the factory) and :1904 (a
                        HAND-ROLLED second one, 342 lines below it in
                        the same file),
                        dungeonContext.js:980, world.js:1989,
                        exterior.js:2330. It is the only window TWO
                        enhanced screens already push - the sheet's
                        button and the pack's USE hand-off, whose
                        close-then-hand-over ordering U55 got
                        backwards. No law needs extracting first.
    THE LOGBOOK         THREE sites: charSheetNav.js:53,
    / NOTEBOOK          world.js:6177, dungeonContext.js:6212. A seam
...
career is spread as plain CFG data, save.js:248,529 - worth checking
...
worldModes.js:2729 as a second book built by hand 342 lines below the
...
questJournal.js from charSheetNav:53, world.js:2404 and
...
`worldModes.js:5659` and `dungeonContext.js:1484` answer the same
...
the other half went stale unnoticed. (The rest cite named `world.js:6509`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:6515` now.)
...
read: `world.js:4706` named a line that is 8950, `:751` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:4442-4474` and `dungeonContext.js:1332` were
...
second pass moved them a second time - `dungeonContext.js:2236` became
