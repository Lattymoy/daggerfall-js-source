...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:955, world.js:1673,
                        exterior.js:1978. It is the only window TWO
                        enhanced screens already push - the sheet's
                        button and the pack's USE hand-off, whose
                        close-then-hand-over ordering U55 got
                        backwards. No law needs extracting first.
    THE LOGBOOK         THREE sites: charSheetNav.js:53,
    / NOTEBOOK          world.js:1712, dungeonContext.js:3854. A seam
...
`worldModes.js:5436` and `dungeonContext.js:1403` answer the same
...
| DaggerfallTransportWindow | 264 | OPEN, and it is a SYSTEM gap wearing a UI hat: `motor.js:591` reads `riding: false` with "the transport arc pends". The window is the last tenth of that arc, not a slice on its own |
...
is trivial, `TransportManager` is not - `motor.js:591` reads
...
the other half went stale unnoticed. (The rest cite named `world.js:5089`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5095` now.)
