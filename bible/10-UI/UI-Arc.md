...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        worldModes.js:1923 (the factory) and :1904 (a
                        HAND-ROLLED second one, 342 lines below it in
                        the same file),
                        dungeonContext.js:998, world.js:2029,
    ...
    / NOTEBOOK          world.js:6125, dungeonContext.js:6235. A seam
...
worldModes.js:2740 as a second book built by hand 342 lines below the
...
questJournal.js from charSheetNav:53, world.js:2444 and
...
`worldModes.js:5688` and `dungeonContext.js:1502` answer the same
...
the other half went stale unnoticed. (The rest cite named `world.js:6457`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:6463` now.)
...
read: `world.js:4654` named a line that is 8950, `:791` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:4390-4422` and `dungeonContext.js:1350` were
...
second pass moved them a second time - `dungeonContext.js:2254` became
