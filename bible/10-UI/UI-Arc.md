...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:917, world.js:1634,
    ...
    / NOTEBOOK          world.js:1673, dungeonContext.js:3349. A seam
...
questJournal.js from charSheetNav:53, world.js:1936 and
...
the other half went stale unnoticed. (The rest cite named `world.js:5051`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5057` now.)
