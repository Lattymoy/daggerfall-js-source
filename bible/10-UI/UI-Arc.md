...
does the pack's USE arm.
    ...
    / NOTEBOOK          world.js:1643, dungeonContext.js:3328. A seam
...
`worldModes.js:5315` and `dungeonContext.js:1347` answer the same
...
the other half went stale unnoticed. (The rest cite named `world.js:4991`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:4997` now.)
