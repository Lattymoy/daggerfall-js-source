...
does the pack's USE arm.
    ...
    / NOTEBOOK          world.js:6022, dungeonContext.js:6131. A seam
...
the other half went stale unnoticed. (The rest cite named `world.js:6354`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:6360` now.)
...
read: `world.js:4551` named a line that is 8950, `:747` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:4287-4319` and `dungeonContext.js:1317` were
