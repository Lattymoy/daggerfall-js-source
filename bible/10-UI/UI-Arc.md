...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:926, world.js:1635,
    ...
    / NOTEBOOK          world.js:1674, dungeonContext.js:3495. A seam
...
questJournal.js from charSheetNav:53, world.js:1937 and
...
`worldModes.js:5327` and `dungeonContext.js:1371` answer the same
...
the other half went stale unnoticed. (The rest cite named `world.js:5052`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5058` now.)
