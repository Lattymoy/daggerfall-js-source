...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:965, world.js:1832,
    ...
    / NOTEBOOK          world.js:5804, dungeonContext.js:6081. A seam
...
questJournal.js from charSheetNav:53, world.js:2232 and
...
the other half went stale unnoticed. (The rest cite named `world.js:6090`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:6096` now.)
...
read: `world.js:4345` named a line that is 8950, `:672` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:4081-4113` and `dungeonContext.js:1316` were
