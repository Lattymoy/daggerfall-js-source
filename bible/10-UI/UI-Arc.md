...
does the pack's USE arm.
    ...
    / NOTEBOOK          world.js:6125, dungeonContext.js:6255. A seam
...
`worldModes.js:5688` and `dungeonContext.js:1522` answer the same
...
that is 8907. `world.js:4390-4422` and `dungeonContext.js:1370` were
...
second pass moved them a second time - `dungeonContext.js:2274` became
