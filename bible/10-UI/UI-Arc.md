...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:948, world.js:1698,
    ...
    / NOTEBOOK          world.js:4899, dungeonContext.js:5863. A seam
...
questJournal.js from charSheetNav:53, world.js:2000 and
...
the other half went stale unnoticed. (The rest cite named `world.js:5151`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5157` now.)
