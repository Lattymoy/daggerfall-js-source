...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:952, world.js:1659,
    ...
    / NOTEBOOK          world.js:1698, dungeonContext.js:3827. A seam
...
questJournal.js from charSheetNav:53, world.js:1961 and
...
`worldModes.js:5347` and `dungeonContext.js:1399` answer the same
...
the other half went stale unnoticed. (The rest cite named `world.js:5077`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5083` now.)
