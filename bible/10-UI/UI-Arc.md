...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:953, world.js:1673,
    ...
    / NOTEBOOK          world.js:1712, dungeonContext.js:3833. A seam
...
`worldModes.js:5435` and `dungeonContext.js:1400` answer the same
...
the other half went stale unnoticed. (The rest cite named `world.js:5088`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5094` now.)
