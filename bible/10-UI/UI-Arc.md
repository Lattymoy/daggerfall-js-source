...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        worldModes.js:2365 (the factory) and :1904 (a
                        HAND-ROLLED second one, 342 lines below it in
                        the same file),
                        dungeonContext.js:1020, world.js:2080,
    ...
    / NOTEBOOK          world.js:6406, dungeonContext.js:6607. A seam
...
- `townTalk.frame` ticks and draws the HUD TEXT LAYER as well as the
  overlay (`townTalk.js:632, :664`), and both exterior hosts called it
...
worldModes.js:3184 as a second book built by hand 342 lines below the
...
questJournal.js from charSheetNav:53, world.js:2497 and
...
`worldModes.js:7035` and `dungeonContext.js:1569` answer the same
...
the other half went stale unnoticed. (The rest cite named `world.js:6739`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:6745` now.)
...
read: `world.js:4853` named a line that is 8950, `:805` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:4588-4620` and `dungeonContext.js:1414` were
...
second pass moved them a second time - `dungeonContext.js:2356` became
