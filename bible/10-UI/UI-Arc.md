...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:954, world.js:1713,
    ...
    / NOTEBOOK          world.js:5006, dungeonContext.js:5948. A seam
...
questJournal.js from charSheetNav:53, world.js:2051 and
...
the other half went stale unnoticed. (The rest cite named `world.js:5250`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5256` now.)
