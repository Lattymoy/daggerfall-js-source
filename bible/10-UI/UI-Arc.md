...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:998, world.js:2050,
    ...
    / NOTEBOOK          world.js:6163, dungeonContext.js:6261. A seam
...
questJournal.js from charSheetNav:53, world.js:2465 and
...
the other half went stale unnoticed. (The rest cite named `world.js:6495`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:6501` now.)
