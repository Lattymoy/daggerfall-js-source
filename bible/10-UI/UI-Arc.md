...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:955, world.js:1712,
    ...
    / NOTEBOOK          world.js:5013, dungeonContext.js:5937. A seam
...
worldModes.js:2670 as a second book built by hand 342 lines below the
...
the other half went stale unnoticed. (The rest cite named `world.js:5257`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5263` now.)
