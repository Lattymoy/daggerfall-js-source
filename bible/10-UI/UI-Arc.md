...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:952, world.js:1652,
    ...
    / NOTEBOOK          world.js:1691, dungeonContext.js:3827. A seam
...
questJournal.js from charSheetNav:53, world.js:1954 and
...
the other half went stale unnoticed. (The rest cite named `world.js:5069`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5075` now.)
