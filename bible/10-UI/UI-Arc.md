...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:916, world.js:1620,
    ...
    / NOTEBOOK          world.js:1659, dungeonContext.js:3315. A seam
...
questJournal.js from charSheetNav:53, world.js:1922 and
...
`worldModes.js:5261` and `dungeonContext.js:1360` answer the same
...
| DaggerfallTransportWindow | 264 | OPEN, and it is a SYSTEM gap wearing a UI hat: `motor.js:556` reads `riding: false` with "the transport arc pends". The window is the last tenth of that arc, not a slice on its own |
...
is trivial, `TransportManager` is not - `motor.js:556` reads
...
the other half went stale unnoticed. (The rest cite named `world.js:4990`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:4996` now.)
