...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:956, world.js:1748,
    ...
    / NOTEBOOK          world.js:5391, dungeonContext.js:6013. A seam
...
questJournal.js from charSheetNav:53, world.js:2091 and
...
the other half went stale unnoticed. (The rest cite named `world.js:5666`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5672` now.)
...
read: `world.js:4018` named a line that is 8950, `:658` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:3769-3788` and `dungeonContext.js:1307` were
