...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:955, world.js:1718,
                        exterior.js:2031. It is the only window TWO
                        enhanced screens already push - the sheet's
                        button and the pack's USE hand-off, whose
                        close-then-hand-over ordering U55 got
                        backwards. No law needs extracting first.
    THE LOGBOOK         THREE sites: charSheetNav.js:53,
    / NOTEBOOK          world.js:5019, dungeonContext.js:5937. A seam
...
questJournal.js from charSheetNav:53, world.js:2056 and
...
`worldModes.js:5501` and `dungeonContext.js:1407` answer the same
...
the other half went stale unnoticed. (The rest cite named `world.js:5263`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5269` now.)
