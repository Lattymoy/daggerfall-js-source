...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:1016, world.js:2057,
    ...
    / NOTEBOOK          world.js:6200, dungeonContext.js:6338. A seam
...
questJournal.js from charSheetNav:53, world.js:2473 and
...
the other half went stale unnoticed. (The rest cite named `world.js:6533`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:6539` now.)
...
read: `world.js:4700` named a line that is 8950, `:797` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:4435-4467` and `dungeonContext.js:1388` were
