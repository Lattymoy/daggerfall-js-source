...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:951, world.js:1654,
    ...
    / NOTEBOOK          world.js:1693, dungeonContext.js:3695. A seam
...
questJournal.js from charSheetNav:53, world.js:1956 and
...
the other half went stale unnoticed. (The rest cite named `world.js:5071`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5077` now.)
