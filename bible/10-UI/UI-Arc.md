...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:965, world.js:1894,
    ...
    / NOTEBOOK          world.js:5912, dungeonContext.js:6095. A seam
...
questJournal.js from charSheetNav:53, world.js:2298 and
...
the other half went stale unnoticed. (The rest cite named `world.js:6206`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:6212` now.)
...
read: `world.js:4431` named a line that is 8950, `:681` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:4167-4199` and `dungeonContext.js:1316` were
