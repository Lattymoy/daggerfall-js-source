...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:916, world.js:1624,
    ...
    / NOTEBOOK          world.js:1663, dungeonContext.js:3315. A seam
...
questJournal.js from charSheetNav:53, world.js:1926 and
...
the other half went stale unnoticed. (The rest cite named `world.js:4994`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5000` now.)
