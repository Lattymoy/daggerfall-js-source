...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:954, world.js:1699,
    ...
    / NOTEBOOK          world.js:4964, dungeonContext.js:5935. A seam
...
questJournal.js from charSheetNav:53, world.js:2037 and
...
the other half went stale unnoticed. (The rest cite named `world.js:5194`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5200` now.)
