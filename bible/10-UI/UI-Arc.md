...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:975, world.js:1954,
    ...
    / NOTEBOOK          world.js:6015, dungeonContext.js:6142. A seam
...
questJournal.js from charSheetNav:53, world.js:2369 and
...
`worldModes.js:5648` and `dungeonContext.js:1479` answer the same
...
the other half went stale unnoticed. (The rest cite named `world.js:6347`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:6353` now.)
...
read: `world.js:4544` named a line that is 8950, `:716` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:4280-4312` and `dungeonContext.js:1327` were
