...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:903, world.js:1603,
    ...
    / NOTEBOOK          world.js:1642, dungeonContext.js:3302. A seam
...
questJournal.js from charSheetNav:53, world.js:1905 and
...
the other half went stale unnoticed. (The rest cite named `world.js:4968`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:4974` now.)
