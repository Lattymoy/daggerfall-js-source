...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        worldModes.js:2133 (the factory) and :1904 (a
                        HAND-ROLLED second one, 342 lines below it in
                        the same file),
                        dungeonContext.js:1019, world.js:2109,
                        exterior.js:2360. It is the only window TWO
                        enhanced screens already push - the sheet's
                        button and the pack's USE hand-off, whose
                        close-then-hand-over ordering U55 got
                        backwards. No law needs extracting first.
    THE LOGBOOK         THREE sites: charSheetNav.js:53,
    / NOTEBOOK          world.js:6400, dungeonContext.js:6554. A seam
...
worldModes.js:2950 as a second book built by hand 342 lines below the
...
`worldModes.js:6344` and `dungeonContext.js:1566` answer the same
...
the other half went stale unnoticed. (The rest cite named `world.js:6732`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:6738` now.)
...
read: `world.js:4870` named a line that is 8950, `:803` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:4606-4638` and `dungeonContext.js:1391` were
