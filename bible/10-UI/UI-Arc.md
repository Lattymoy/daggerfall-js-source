...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:965, world.js:1900,
    ...
    / NOTEBOOK          world.js:5917, dungeonContext.js:6114. A seam
...
questJournal.js from charSheetNav:53, world.js:2312 and
...
the other half went stale unnoticed. (The rest cite named `world.js:6232`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:6238` now.)
...
read: `world.js:4454` named a line that is 8950, `:686` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:4190-4222` and `dungeonContext.js:1317` were
