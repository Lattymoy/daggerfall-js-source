...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:964, world.js:1744,
    ...
    / NOTEBOOK          world.js:5350, dungeonContext.js:6073. A seam
...
questJournal.js from charSheetNav:53, world.js:2115 and
...
`worldModes.js:5518` and `dungeonContext.js:1467` answer the same
...
the other half went stale unnoticed. (The rest cite named `world.js:5624`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5630` now.)
...
read: `world.js:4163` named a line that is 8950, `:659` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:3912-3931` and `dungeonContext.js:1315` were
