...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:965, world.js:1788,
    ...
    / NOTEBOOK          world.js:5687, dungeonContext.js:6081. A seam
...
worldModes.js:2676 as a second book built by hand 342 lines below the
...
questJournal.js from charSheetNav:53, world.js:2118 and
...
`worldModes.js:5543` and `dungeonContext.js:1468` answer the same
...
the other half went stale unnoticed. (The rest cite named `world.js:5973`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5979` now.)
...
read: `world.js:4228` named a line that is 8950, `:671` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:3964-3996` and `dungeonContext.js:1316` were
