...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        exterior.js:1989. It is the only window TWO
...
the other half went stale unnoticed. (The rest cite named `world.js:5035`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5041` now.)
