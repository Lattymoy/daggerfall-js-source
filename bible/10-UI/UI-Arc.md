...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:937, world.js:1644,
    ...
    / NOTEBOOK          world.js:1683, dungeonContext.js:3639. A seam
...
worldModes.js:2596 as a second book built by hand 342 lines below the
...
questJournal.js from charSheetNav:53, world.js:1946 and
...
`worldModes.js:5346` and `dungeonContext.js:1382` answer the same
...
the other half went stale unnoticed. (The rest cite named `world.js:5061`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5067` now.)
