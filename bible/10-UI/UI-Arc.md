...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        worldModes.js:1907 (the factory) and :1904 (a
                        HAND-ROLLED second one, 342 lines below it in
                        the same file),
                        dungeonContext.js:977, world.js:1987,
                        exterior.js:2259. It is the only window TWO
                        enhanced screens already push - the sheet's
                        button and the pack's USE hand-off, whose
                        close-then-hand-over ordering U55 got
                        backwards. No law needs extracting first.
    THE LOGBOOK         THREE sites: charSheetNav.js:53,
    / NOTEBOOK          world.js:6078, dungeonContext.js:6179. A seam
...
worldModes.js:2724 as a second book built by hand 342 lines below the
...
questJournal.js from charSheetNav:53, world.js:2402 and
...
`worldModes.js:5653` and `dungeonContext.js:1481` answer the same
...
the other half went stale unnoticed. (The rest cite named `world.js:6410`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:6416` now.)
...
read: `world.js:4607` named a line that is 8950, `:749` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:4343-4375` and `dungeonContext.js:1329` were
...
second pass moved them a second time - `dungeonContext.js:2233` became
