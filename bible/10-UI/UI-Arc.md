...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:961, world.js:1741,
    ...
    / NOTEBOOK          world.js:5322, dungeonContext.js:6053. A seam
...
questJournal.js from charSheetNav:53, world.js:2087 and
...
the other half went stale unnoticed. (The rest cite named `world.js:5596`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5602` now.)
...
read: `world.js:4135` named a line that is 8950, `:656` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:3884-3903` and `dungeonContext.js:1312` were
