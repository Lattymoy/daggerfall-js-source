...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        worldModes.js:1917 (the factory) and :1904 (a
                        HAND-ROLLED second one, 342 lines below it in
                        the same file),
                        dungeonContext.js:997, world.js:2031,
    ...
    / NOTEBOOK          world.js:6184, dungeonContext.js:6234. A seam
...
worldModes.js:2734 as a second book built by hand 342 lines below the
...
questJournal.js from charSheetNav:53, world.js:2453 and
...
`worldModes.js:5689` and `dungeonContext.js:1501` answer the same
...
the other half went stale unnoticed. (The rest cite named `world.js:6516`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:6522` now.)
...
read: `world.js:4713` named a line that is 8950, `:793` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:4449-4481` and `dungeonContext.js:1349` were
