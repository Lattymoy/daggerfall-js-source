...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:916, world.js:1626,
    ...
    / NOTEBOOK          world.js:1665, dungeonContext.js:3341. A seam
...
worldModes.js:2583 as a second book built by hand 342 lines below the
...
questJournal.js from charSheetNav:53, world.js:1928 and
...
`worldModes.js:5317` and `dungeonContext.js:1360` answer the same
...
the other half went stale unnoticed. (The rest cite named `world.js:5022`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5028` now.)
