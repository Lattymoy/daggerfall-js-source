...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        worldModes.js:1852 (the factory) and :1904 (a
                        HAND-ROLLED second one, 342 lines below it in
                        the same file),
                        dungeonContext.js:955, world.js:1711,
                        exterior.js:2028. It is the only window TWO
                        enhanced screens already push - the sheet's
                        button and the pack's USE hand-off, whose
                        close-then-hand-over ordering U55 got
                        backwards. No law needs extracting first.
    THE LOGBOOK         THREE sites: charSheetNav.js:53,
    / NOTEBOOK          world.js:5004, dungeonContext.js:5936. A seam
...
worldModes.js:2669 as a second book built by hand 342 lines below the
...
questJournal.js from charSheetNav:53, world.js:2049 and
...
`worldModes.js:5495` and `dungeonContext.js:1407` answer the same
...
the other half went stale unnoticed. (The rest cite named `world.js:5248`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5254` now.)
