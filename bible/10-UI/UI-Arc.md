...
questJournal.js from charSheetNav:53, world.js:1964 and
...
the other half went stale unnoticed. (The rest cite named `world.js:5084`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:5090` now.)
