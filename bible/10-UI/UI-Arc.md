...
does the pack's USE arm.
    ...
    THE SPELLBOOK       FIVE construction sites across FOUR hosts:
                        ...
                        the same file),
                        dungeonContext.js:1017, world.js:2060,
    ...
    / NOTEBOOK          world.js:6270, dungeonContext.js:6409. A seam
...
questJournal.js from charSheetNav:53, world.js:2477 and
...
the other half went stale unnoticed. (The rest cite named `world.js:6603`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:6609` now.)
...
read: `world.js:4723` named a line that is 8950, `:800` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:4458-4490` and `dungeonContext.js:1411` were
