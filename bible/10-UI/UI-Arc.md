...
does the pack's USE arm.
    ...
    / NOTEBOOK          world.js:5826, dungeonContext.js:6081. A seam
...
the other half went stale unnoticed. (The rest cite named `world.js:6112`,
the first of the host's TWO identical `act === 'Rest'` arms; ROAD-H H5
deleted the second and the cite is `world.js:6118` now.)
...
read: `world.js:4367` named a line that is 8950, `:673` one that is
1215, `:1094` one that is 2194, `:3903` one that is 3066, `:3920` one
that is 8907. `world.js:4103-4135` and `dungeonContext.js:1316` were
