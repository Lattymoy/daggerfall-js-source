...
| `ensureAudio(fetch)` is exported from `src/scenes/shared.js:482`, is safe un‑awaited, and `audio.ensure` attaches its own gesture‑resume (`src/systems/audio.js:71‑87`) | — |
