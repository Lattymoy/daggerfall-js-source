...
| `ensureAudio(fetch)` is exported from `src/scenes/shared.js:453`, is safe un‑awaited, and `audio.ensure` attaches its own gesture‑resume (`src/systems/audio.js:69‑87`) | — |
