...
(interiorContext.js:206 -> collectInteriorPeople), which is what made the
...
(`arrowFlight.js:304`) precisely because that is where :630 lives. All
...
encounter pool has always exported its own at `exteriorFoes.js:1773`)
