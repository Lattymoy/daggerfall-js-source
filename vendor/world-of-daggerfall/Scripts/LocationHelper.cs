...
namespace DaggerfallWorkshop.Loc
{
    public static class LocationHelper
    {
        ...
        //Added
        public const string locationInstanceFolder_Daggerfall = "/StreamingAssets/Locations/WOD_Daggerfall";
        public const string locationInstanceFolder_Betony = "/StreamingAssets/Locations/WA_Betony";
        public const string locationInstanceFolder_Tulune = "/StreamingAssets/Locations/WA_Tulune";
        public const string locationInstanceFolder_Glenpoint = "/StreamingAssets/Locations/WA_Glenpoint";
        public const string locationInstanceFolder_Shalgora = "/StreamingAssets/Locations/WA_Shalgora";
        public const string locationInstanceFolder_HessanHills = "/StreamingAssets/Locations/WA_HessanHills";
        ...
        public static Dictionary<string, string> models = new Dictionary<string, string>()
        {
            ...
            {"60113", "Cave End" },
                ...
                {"322", "Small House"},
                {"123", "Big House"},
                {"329", "Stonewall House"}, //{"210", "Small House"},
                ...
                {"910", "Ship" },
                {"41502", "Small Boat"},
                {"41504", "Small Boat 2"}, //{"41505", "Small Boat 3"},{"41501", "Small Boat 4"},
				//{"41500", "Small Boat 5"},
                ...
                */
                ...
                if (go == null)
                {
                    ...
                    if (go != null)
                    {
                        ...
                        //My Additions
                        if (arg[0] == "479")
                            AddBanditSpawn(int.Parse(arg[1]), go);

                        if (arg[0] == "483")
                            AddGoodBanditSpawn(int.Parse(arg[1]), go);

                        if (arg[0] == "457")
                            AddBearSpawn(int.Parse(arg[1]), go);

                        if (arg[0] == "216")
                            AddLootSpawn(go);

                       if (arg[0] == "357" && arg[1] == "6")
                            AddKidnapSpawn(go);

                        if (arg[0] == "478")
                            AddWarriorSpawn(int.Parse(arg[1]), go);
                    }
                }
            }
        ...
        /// <summary>
        /// Adds events to Locations
        /// </summary>
        /// <param name="id"></param>
        /// <param name="go"></param>
        /// 

        public static void AddLootSpawn(GameObject go)
        {

                    go.AddComponent<LocationEnemySpawner>();
                    LocationEnemySpawner SpawnType = go.GetComponent<LocationEnemySpawner>();
                     go.GetComponentInChildren<MeshRenderer>().material.color = new Color(1, 1, 1, 0.1f);

            if (SpawnType != null)
                    {
                        SpawnType.SpawnType = 3;
                    }
            
        }

        public static void AddKidnapSpawn(GameObject go)
        {
        ...
        public static void AddBanditSpawn(int textureRecord, GameObject go)
        {
            ...
            if (SpawnType != null)
                    {
                        SpawnType.SpawnType = 2;
                        SpawnType.enemyID = 1;
                    }
            
        }

        public static void AddGoodBanditSpawn(int textureRecord, GameObject go)
        {
            ...
            if (SpawnType != null)
            {
                SpawnType.SpawnType = 4;
                SpawnType.enemyID = 1;
            }

        }

        public static void AddBearSpawn(int textureRecord, GameObject go)
        {
        ...
        public static void AddWarriorSpawn(int textureRecord, GameObject go)
        {
