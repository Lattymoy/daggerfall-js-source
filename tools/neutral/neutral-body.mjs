...
const RAMPS = {"skin":[[61,54,38],[66,54,41],[69,63,42],[79,63,43],[83,71,44],[96,76,51],[109,85,54],[123,92,60],[134,103,65],[151,110,69],[160,118,74],[173,127,78],[193,133,100],[207,152,118]],"boot":[[46,44,46],[50,45,34],[61,54,38],[66,54,41],[69,63,42],[79,63,43],[91,67,38],[83,71,44],[96,76,51],[109,85,54],[123,92,60],[134,103,65],[151,110,69],[160,118,74],[173,127,78],[193,133,100]]};
...
writeFileSync(process.argv[2] || 'neutral-payload.json', JSON.stringify({ n: faces.length, cy: (minY + maxY) / 2, h: maxY - minY, P, N, C }));
console.log('neutral faces', faces.length, 'h', (maxY - minY).toFixed(3));
