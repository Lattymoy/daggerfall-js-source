 ...
 *  (0,0,0,0) before the arm draws (renderer.js:2875), so alpha != 0 IS the
...
async function shoot(t) {
  return page.evaluate((time) => {
    ...
    // (renderer.js:2863 then :2642), so coverage measured over the whole
...
// The ground truth is the port's own motor law (motor.js:696: the
