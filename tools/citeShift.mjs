...
// (test/citedrift.test.js's law): `src/scenes/world.js:1264`, the
// basename form `world.js:1264`, a range `:1234-1240`, the tests' own
// regex spelling `world\.js:1264`, and - THE LEDGER ARM - the four
...
//   - BARE CONTINUATIONS. "`world.js:1893`, `:1667`" - the second number
